        ...
        <form id="formCategory" enctype="multipart/form-data" role="form" onSubmit="return false">
          ...
          <div class="card-body">
            ...
            <p class="card-subtitle mb-3 mt-3">
              Modifica los campos necesarios para actualizar la categoría del centro de ayuda.
            </p>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text">
                      <i id="icon-preview" class="{{ $category->icon ?: 'fa-duotone fa-icons' }}"></i>
                    </span>
                    <input type="text" class="form-control" id="icon" name="icon"
                           placeholder="Ej: fa-duotone fa-question-circle" value="{{ $category->icon }}">
                  </div>
    ...
    $(document).ready(function () {
      ...
      $("#formCategory").validate({
        ...
        submitHandler: function (form, event) {
          ...
          $.ajax({
            type: 'POST',
            url: "{{ route('manager.helpdesk.helpcenter.categories.update') }}",
            data: $(form).serialize(),
            dataType: 'json',
