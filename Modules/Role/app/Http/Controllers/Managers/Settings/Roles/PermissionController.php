...
class PermissionController extends BaseManagerController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('managers.views.settings.roles.permissions.index', compact('permissions', 'search'));
    }
    ...
    {
        return view('managers.views.settings.roles.permissions.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('managers.views.settings.roles.permissions.edit', compact('permission'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('manager.permissions.edit', $permission->id)
