...
class InternationalApi extends AbstractApi
{
    ...
    public function getTranslations()
    {
        return [
            ...
            'label_total_domain' => $this->translator->trans('%nb_langs% expressions', [], 'Admin.International.Feature'),
            /* nb_langs can be 0 or 1 */
            ...
            'link_langs' => $this->translator->trans('Translations', [], 'Admin.Navigation.Menu'),
