...
{
    /**
     * Associate inventaries with parent category and disable them.
     */
    public const ASSOCIATE_PRODUCTS_WITH_PARENT_AND_DISABLE = 'associate_and_disable';

    /**
     * Associate inventaries with parent and do not change their status.
     */
    public const ASSOCIATE_PRODUCTS_WITH_PARENT_ONLY = 'associate_only';

    /**
     * Remove inventaries that are associated only with category that is being deleted.
     */
    ...
    /**
     * Whether inventaries associated with category should be removed.
     *
     * @return bool
     */
    ...
    /**
     * Whether inventaries should be disabled when category is deleted.
     *
     * @return bool
     */
