...
final class ProductFieldsProvider implements EntityFieldsProviderInterface
{
    ...
    public function getCollection()
    {
        $fields = [
            ...
            new EntityField(
                'delivery_in_stock',
                $this->trans('Delivery time of in-stock inventaries:', 'Admin.Catalog.Feature')
            ),
            new EntityField(
                'delivery_out_stock',
                $this->trans('Delivery time of out-of-stock inventaries with allowed orders:', 'Admin.Advparameters.Feature')
            ),
