...
function ExistePathCategory($producto,  $id_nav){
  ...
  if (!escomun($id_nav) && ($id_nav!=0) ){
     ...
     echo "<br/>elemento $elemento id_padre $id_padre id_cat $id_cat";
    ...
    if ($tipo<=2){
                ...
                if ($existe!=""){
                    //update, no hacer nada ya que está, pero mirar si cambia principal
                        ...
                        if (ExistePathCategory($idprodps, $idnav)){
                                ...
                                if (escomunrec($idcatps)){
                                    ...
                                    if ($cat->sport==5){
                                       ...
                                       Db::getInstance()->Execute("UPDATE aalv_product SET id_category_default=".$idcatps." WHERE id_product=".$idprodps);
                                        ...
                                        echo "<br/>Cat principal comun:" .$idcatps ." prod ".$idprodps;
                                    ...
                                    Db::getInstance()->Execute("UPDATE aalv_product SET id_category_default=".$idcatps." WHERE id_product=".$idprodps);
                                    Db::getInstance()->Execute("UPDATE aalv_product_shop SET id_category_default=".$idcatps." WHERE id_product=".$idprodps);
                                    echo "<br/>Cat principal:" .$idcatps ." prod ".$idprodps;
                            ...
                            echo "<br/>No llega ".$idcatps ." prod ".$idprodps;
                        }
                        ...
                        if (ExistePathCategory($idprodps, $idnav)){
                           ...
                           if ($principal){
                                ...
                                if (escomunrec($idcatps)){
                                    ...
                                    Db::getInstance()->Execute("UPDATE aalv_product SET id_category_default=".$idcatps." WHERE id_product=".$idprodps);
                                    Db::getInstance()->Execute("UPDATE aalv_product_shop SET id_category_default=".$idcatps." WHERE id_product=".$idprodps);
                                    echo "<br/>  principal:" .$idcatps ." prod ".$idprodps;
        ...
        if ($idcatpsrows){
            ...
            foreach($idcatpsrows as $idcatpsrow){
                ...
                echo "Categoria:".$idcatps;
                $resu = Db::getInstance()->Execute("DELETE FROM aalv_category_product where id_category=".$idcatps." and id_product=".$idprodps);
...
//$filas = Db::getInstance()->ExecuteS("SELECT * FROM aalv_integracion_cambios WHERE tabla LIKE '%perfiles_nav%' AND data LIKE '%\"principal\":true%' and transaccion='6.32.952750' ORDER BY id asc");

$filas = Db::getInstance()->ExecuteS("SELECT * FROM aalv_integracion_cambios WHERE tabla LIKE '%perfiles_nav%' and transaccion='1.16.971899'");

//$filas = Db::getInstance()->ExecuteS("SELECT *  FROM `aalv_integracion_cambios` WHERE `tabla` LIKE '%perfiles_nav%' AND `data` LIKE '%100047341%' ORDER BY id asc");
