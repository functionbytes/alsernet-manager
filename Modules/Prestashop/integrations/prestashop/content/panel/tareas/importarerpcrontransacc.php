...
try{
    ...
    $contentitem = peticionget("http://127.0.0.1:59000/integracion/TransaccionPendiente/?destino=2&transaccion=6.25.963246&limit=5000");
    ...
    foreach($objitem["results"] as $valoresitem){
        ...
        echo "Procesando... ".$valoresitem["tabla"]." ".$valoresitem["fila"]." ".$valoresitem["tipo"]."<br/>";
        ...
        try{
            ...
            echo "error ".$e->getMessage(). "<br/>integracion ".$valoresitem["tabla"]." ".$valoresitem["fila"]." ".$valoresitem["tipo"]." ".$transaccion;
