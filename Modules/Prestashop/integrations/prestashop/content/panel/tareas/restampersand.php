...
function CrearProducto($datos,$dbh){
        ...
        try{       
            ...
            if ($nombreen=="") $nombreen=getfieldvalue($dbh,"SELECT nombre FROM modelo_traduccion_auto where id_modelo=".$datos['id']." and idioma='en'");
            if ($nombrede=="") $nombrede=getfieldvalue($dbh,"SELECT nombre FROM modelo_traduccion_auto where id_modelo=".$datos['id']." and idioma='de'");
            if ($nombrefr=="") $nombrefr=getfieldvalue($dbh,"SELECT nombre FROM modelo_traduccion_auto where id_modelo=".$datos['id']." and idioma='fr'");
            if ($nombrept=="") $nombrept=getfieldvalue($dbh,"SELECT nombre FROM modelo_traduccion_auto where id_modelo=".$datos['id']." and idioma='pt'");
