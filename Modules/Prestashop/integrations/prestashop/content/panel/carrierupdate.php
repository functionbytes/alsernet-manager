...
function moveMail($rInBox, $idMsg, $sFolder){
    if (empty($idMsg)) { return false; }
    if (empty($sFolder)) { return false; }
    if (empty($rInBox)) { return false; }
...
function getStateFromCorreosExpress($state){
    ...
    switch ($state) {
        case "9937": $return = ENTREGADO; break;
        case "9936": $return = DEVUELTO; break;
        default: $return = EN_CURSO; break;
    }
...
function getStateFromEnvialia($state) {
        ...
        switch ($state) {
            case "4": $return = ENTREGADO; break;
            case "5": $return = DEVUELTO; break;
            case "13": $return = DEVUELTO; break;
            default: $return = EN_CURSO; break;
        }
