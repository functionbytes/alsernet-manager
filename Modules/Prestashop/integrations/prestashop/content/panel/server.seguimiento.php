...
class WebAlvarez {
	...
	static function insertDatos($parameters) {
		...
		switch ($args["Estado"]){
			...
			break;
			case "8":
				$tipos_incidencias_contemplados = array("1", "2", "3", "4");
			...
			case "3":
					...
					$formas_pago_no_validas = array("5", "7", "10", "11", "12", "16", "21", "24", "25");
					$formas_pago_tarjeta = array("2","8","9","13","14","15","17");
