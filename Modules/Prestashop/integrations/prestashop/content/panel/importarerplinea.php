...
try{
    ...
    if ($tipo<=2){
        ...
        foreach($specificprices as $idsp){
            ...
            Db::getInstance()->Execute("DELETE FROM aalv_specific_price WHERE id_specific_price=".$idsp["id_specific_price"]);
            echo "<br/>Borra ".$idsp["id_specific_price"];
        }
    ...
    if ($tipo<=2){
        ...
        if ($idproduct!=""){
            ...
            if ($idlote != ""){
                ...
                Db::getInstance()->Execute("update aalv_product_shop set id_tax_rules_group = 12, price=".round($preciotarifa,6)." where id_product=".$idproduct);
                Db::getInstance()->Execute("update aalv_product set id_tax_rules_group = 12, price=".round($preciotarifa,6)." where id_product=".$idproduct);
...
/*
$sql="SELECT id FROM `aalv_integracion_cambios` WHERE `tabla` = 'v_sinc_tarifa_cabecera' AND `tipo` = '3' and fecha_confirmacion>'2022-12-31' order by 1";
...
$idlineatrans="7027612,7027613,7027614,7027615,7027616,7027617";
