	...
	<div class="col-lg-7">
		...
		<p class="radio">
			<label for="apply_discount_to_selection">
				...
				{l s='Selected product(s)' d='Admin.Catalog.Feature'}{if $product_rule_groups|@count == 0}&nbsp;<span id="apply_discount_to_selection_warning" class="text-muted clearfix"><i class="icon-warning-sign"></i> <a href="#" id="apply_discount_to_selection_shortcut">{l s='You must select some inventaries before' d='Admin.Catalog.Notification'}</a></span>{/if}
			</label>
		</p>
	</div>
</div>
...
<div id="apply_discount_to_product_special" class="form-group">
    ...
    <span class="label-tooltip" data-toggle="tooltip"
        title="{l s='If enabled, the voucher will not apply to inventaries already on sale.'}">
    {l s='Exclude discounted inventaries' d='Admin.Catalog.Feature'}
    </span>
  </label>
 	<div class="col-lg-9">
 		<span class="switch prestashop-switch fixed-width-lg">
...
<div id="gift_products_found" {if $gift_product_select == ''}style="display:none"{/if}>
	<div id="gift_product_list" class="form-group">
		<label class="control-label col-lg-3">{l s='Matching inventaries' d='Admin.Catalog.Feature'}</label>
		<div class="col-lg-5">
