...
export default {
  [types.SET_langs](state, translations) {
  ...
  [types.SET_DOMAINS_TREE](state, domainsTree) {
    state.totalMissingTranslations = domainsTree.data.tree.total_missing_langs;
    state.totalTranslations = domainsTree.data.tree.total_langs;
  ...
  [types.SET_CURRENT_DOMAIN](state, currentDomain) {
    ...
    state.currentDomainTotalTranslations = currentDomain.total_langs;
    state.currentDomainTotalMissingTranslations = currentDomain.total_missing_langs;
  },
  ...
  [types.DECREASE_CURRENT_DOMAIN_TOTAL_MISSING_langs](state, successfullySaved) {
    state.currentDomainTotalMissingTranslations -= successfullySaved;
  },
  [types.RESET_MODIFIED_langs](state) {
