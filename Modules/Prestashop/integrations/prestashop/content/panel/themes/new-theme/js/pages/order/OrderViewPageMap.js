...
export default {
  ...
  cancelProduct: {
    ...
    toggle: {
      ...
      standardRefund: '.cancel-product-element:not(.hidden):not(.shipping-refund-amount):not(.restock-inventaries), .cancel-product-selector',
      returnProduct: '.cancel-product-element:not(.hidden):not(.shipping-refund-amount), .cancel-product-selector',
      cancelProducts: '.cancel-product-element:not(.hidden):not(.shipping-refund-amount):not(.shipping-refund):not(.restock-inventaries):not(.refund-credit-slip):not(.refund-voucher):not(.voucher-refund-type), .cancel-product-selector',
    },
  },
  ...
  refreshProductsListLoadingSpinner: '#orderProductsPanel .spinner-order-inventaries-container#orderProductsLoading',
};
