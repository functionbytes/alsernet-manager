        ...
        $this->fields_form = [
            ...
            'input' => [
                ...
                [
                    ...
                    'desc' => $this->trans('Share available quantities between shops of this group. When changing this option, all available inventaries quantities will be reset to 0.', [], 'Admin.Advparameters.Feature'),
                ],
                [
                    'type' => 'switch',
