...
{
    public $php_self = 'new-inventaries';
    ...
    public function initContent()
    {
        ...
        $this->doProductSearch('catalog/listing/new-inventaries', ['entity' => 'new-inventaries']);
    }
    ...
    public function getBreadcrumbLinks()
    {
        ...
        $breadcrumb['links'][] = [
            ...
            'url' => $this->context->link->getPageLink('new-inventaries', true),
        ];
