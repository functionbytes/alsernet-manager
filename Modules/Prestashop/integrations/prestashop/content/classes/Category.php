...
class CategoryCore extends ObjectModel
{
    ...
    protected $webserviceParameters = [
        ...
        'associations' => [
            ...
            'inventaries' => ['getter' => 'getProductsWs', 'resource' => 'product'],
        ],
    ];
     ...
     * @param  int  $productPerPage  Number of inventaries per page
     ...
     * @param  bool  $active  If set to true, finds only active inventaries
     * @param  bool  $random  If true, sets a random filter for returned inventaries
     * @param  int  $randomNumberProducts  Number of inventaries to return if random is activated
     * @param  bool  $checkAccess  If set to `true`, check if the current customer
     *                             can see the inventaries from this category
     * @param  Context|null  $context  Instance of Context
     * @return array|int|false Products, number of inventaries or false (no access)
     *
     * @throws PrestaShopDatabaseException
     */
    ...
    /**
     * Copy inventaries from a category to another.
     *
