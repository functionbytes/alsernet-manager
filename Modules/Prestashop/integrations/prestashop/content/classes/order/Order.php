...
class OrderCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields' => [
            ...
            'document_number' => ['type' => self::TYPE_STRING],
            'document_type' => ['type' => self::TYPE_HTML],
        ],
    ];
    ...
    protected $webserviceParameters = [
        ...
        'associations' => [
            'order_rows' => ['resource' => 'order_row', 'setter' => false, 'virtual_entity' => true,
                'fields' => [
                    'id' => [],
                    'product_id' => ['required' => true, 'xlink_resource' => 'inventaries'],
    ...
    /**
     * This function return inventaries of the orders
    ...
    /**
     * Count virtual inventaries in order.
     *
     * @return int number of virtual inventaries
     */
    ...
    /**
     * Check if order contains (only) virtual inventaries.
     *
    ...
    /**
     * Has inventaries returned by the merchant or by the customer?
     */
    ...
    public static function getCustomerOrders($id_customer, $show_hidden_status = false, ?Context $context = null)
    {
        ...
        foreach ($res as $key => $val) {
            ...
            $res[$key]['order_state'] = (isset($orderState) && ! empty($orderState['name'])) ? $orderState['name'] : null;
            $res[$key]['invoice'] = (isset($orderState) && ! empty($orderState['invoice'])) ? $orderState['invoice'] : null;
            $res[$key]['order_state_color'] = (isset($orderState) && ! empty($orderState['color'])) ? $orderState['color'] : null;
        }
     ...
     * is equal to the difference between inventaries with tax and
     * inventaries without tax.
     */
