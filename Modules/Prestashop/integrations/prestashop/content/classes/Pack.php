...
class PackCore extends Product
{
    ...
    /**
     * Only decrement pack inventaries quantities.
     *
     * @var string
     */
    ...
    /**
     * Decrement pack quantity and pack inventaries quantities.
     *
     * @var string
     */
    ...
    /**
     * Indicates if a pack and its associated inventaries are available for orders in the desired quantity.
     *
    ...
    public static function getQuantity(
        ...
        // Initialize with pack quantity if not only inventaries
        ...
        if (in_array($packStockType, [self::STOCK_TYPE_PACK_BOTH, self::STOCK_TYPE_PRODUCTS_ONLY])) {
            ...
            foreach ($items as $index => $item) {
                ...
                // if pack decrement stock type is inventaries only
                if ($index === 0
    ...
    /**
     * For a given pack, tells if all inventaries using the advanced stock management.
     *
     * @param  int  $id_product  id_pack
     * @return bool
     */
