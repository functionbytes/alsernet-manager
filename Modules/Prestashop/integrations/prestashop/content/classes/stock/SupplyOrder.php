...
class SupplyOrderCore extends ObjectModel
{
    ...
    /**
     * @var int Warehouse where inventaries will be delivered
     */
    public $id_warehouse;
    ...
    /**
     * Checks all inventaries in this order and calculate prices
    ...
    /**
     * Retrieves the details entries (i.e. inventaries) collection for the current order.
     *
    ...
    /**
     * Checks if the current state allows to add inventaries in stock.
     *
     * @return bool
     */
    ...
    /**
     * Removes all inventaries from the order.
     */
