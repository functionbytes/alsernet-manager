...
class WarehouseCore extends ObjectModel
{
    ...
    {
        // if it's a pack, returns warehouses if and only if some inventaries use the advanced stock management
        $share_stock = false;
        if ($id_shop === null) {
    ...
    /**
     * Gets the number of inventaries in the current warehouse.
     *
    ...
    /**
     * Gets the number of quantities - for all inventaries - in the current warehouse.
     *
    ...
    public static function getPackWarehouses($id_product, $id_shop = null)
    {
        ...
        // for each inventaries in the pack
