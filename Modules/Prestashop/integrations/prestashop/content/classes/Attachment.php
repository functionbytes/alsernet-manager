...
class AttachmentCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'associations' => [
            'inventaries' => ['type' => self::HAS_MANY, 'field' => 'id_product', 'object' => 'Product', 'association' => 'product_attachment'],
        ],
    ];
    ...
    /**
     * Unassociate all inventaries from the current object
     *
    ...
    /**
     * Get attachment inventaries ids of current attachment for association.
     *
    ...
    /**
     * Set inventaries ids of current attachment for association.
     *
