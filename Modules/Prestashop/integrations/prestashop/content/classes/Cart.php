...
class CartCore extends ObjectModel
{
    ...
    /** @var bool Allow to seperate order in multiple package in order to recieve as soon as possible the available inventaries */
    ...
    protected $webserviceParameters = [
        ...
        'associations' => [
            'cart_rows' => [
                ...
                'virtual_entity' => true,
                'fields' => [
                    'id_product' => ['required' => true, 'xlink_resource' => 'inventaries'],
        ...
        if ($fullInfos) {
            ...
            foreach ($result as &$row) {
                ...
                if (! $row['is_gift'] || (int) $row['cart_quantity'] === $givenAwayQuantity) {
                    ...
                    // Separate inventaries given away from those manually added to cart
    ...
    private function getOrderPrices(
        ...
        if (array_search(null, $orderPrices) !== false) {
    ...
    /**
     * Return cart inventaries quantity.
     *
    ...
    /**
     * Get number of inventaries in cart
     * This is the total amount of inventaries, not just the types.
     *
    ...
    public function getOrderTotal(
        ...
        // no shipping cost if is a cart with only virtuals inventaries
     ...
     *
     * @param  array  $products  list of inventaries to calculate on
    ...
    /**
     * Get inventaries grouped by package and by addresses to be sent individualy (one package = one shipping cost).
     *
     * @return array array(
     ...
     * @param  array  $products  The list of inventaries
    ...
    public function getRawSummaryDetails(int $id_lang, bool $refresh = false): array
    {
        ...
        $summary = [
            ...
            'inventaries' => array_values($products),
     ...
     * @return bool|array If all inventaries are in stock: true; if not: either false or an array
    ...
    /**
     * Check if cart contains only virtual inventaries.
     *
    ...
    public function duplicate()
    {
        ...
        // Customized inventaries: duplicate customizations before inventaries so that we get new id_customizations
    ...
    public function setProductAddressDelivery($id_product, $id_product_attribute, $old_id_address_delivery, $new_id_address_delivery)
    {
        ...
        // Checking if there is no others similar inventaries with this new address delivery
        $sql = new DbQuery;
        ...
        // Removing similar inventaries with this new address delivery
    ...
    /**
     * Update inventaries cart address delivery with the address delivery of the cart.
     */
    ...
    /**
     * Set an address to all inventaries on the cart without address delivery.
     */
    ...
    /**
     * Are all inventaries of the Cart still available in the current state ? They might have been converted to another
     * type of product since then
     *
     * @return bool False if one of the inventaries from the cart has been changed into a new type of product
     */
    ...
    /**
     * Are all inventaries of the Cart in stock?
     *
     * @param  bool  $ignore_virtual  Ignore virtual inventaries
     * @param  bool  $exclusive  (DEPRECATED) If true, the validation is exclusive : it must be present product in stock and out of stock
     *
     * @since 1.5.0
     *
     * @return bool False if not all inventaries in the cart are in stock
     */
    ...
    /**
     * Checks that all inventaries in cart have minimal required quantities
     *
     * @return bool
     */
    ...
    /**
     * Set flag to split lines of inventaries given away and also manually added to cart.
     */
    ...
    /**
     * Set flag to merge lines of inventaries given away and also manually added to cart.
     */
    ...
    /**
     * Get inventaries with gifts and manually added occurrences separated.
     *
     * @return array|null
     */
