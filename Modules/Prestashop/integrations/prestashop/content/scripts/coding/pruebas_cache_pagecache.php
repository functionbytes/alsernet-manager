...
@file_put_contents($tmpFile, 'inicio => clearSmartyCache ('.date('d/m/Y H:i:s').' '.$tiempo_final_total.')'.PHP_EOL, FILE_APPEND);
$tiempo_inicial_total = microtime(true);
...
*/
@file_put_contents($tmpFile, 'inicio => clearPageCache ('.date('d/m/Y H:i:s').' '.$tiempo_final_total.')'.PHP_EOL, FILE_APPEND);
$tiempo_inicial_total = microtime(true);
Media::clearCache();
$tiempo_final_total = microtime(true);
$tiempo_final_total = round($tiempo_final_total - $tiempo_inicial_total, 8);
@file_put_contents($tmpFile, 'fin => clearPageCache ('.date('d/m/Y H:i:s').' '.$tiempo_final_total.')'.PHP_EOL.PHP_EOL, FILE_APPEND);
