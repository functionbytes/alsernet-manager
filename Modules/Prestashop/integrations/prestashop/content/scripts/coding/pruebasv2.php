...
where id_articulo not in (100218271) and estado_gestion != 0
...
// select 0 as producto, id_articulo, unidades_oferta, etiqueta, estado_gestion,activo, es_segunda_mano, externo_disponibilidad, codigo_proveedor, precio_costo_proveedor, tarifa_proveedor, es_arma, es_arma_fogueo, es_cartucho, categoria, familia, subfamilia, grupo  from aalv_combinaciones_import aci where estado_gestion = 0
