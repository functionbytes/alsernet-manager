...
<form class="form"  method="post" id="alsernet-fitting" enctype="multipart/form-data" autocomplete="false" onsubmit="return false" novalidate="novalidate">
    ...
    <input type="hidden" name="_alsernetforms_link" value="/modules/alsernetforms/controllers/routes.php?type=demondayvalidation">
    ...
    <div class="mb-3">
        <label for="email" class="form-label">{l s='Email alert demoday' mod='alsernetforms'} </label>
        <input type="text" class="form-control" id="email" name="email" placeholder="" autocomplete="new-email">
    </div>
    <div class="mb-3">
        <label for="phone" class="form-label">{l s='Phone alert demoday' mod='alsernetforms'}</label>
