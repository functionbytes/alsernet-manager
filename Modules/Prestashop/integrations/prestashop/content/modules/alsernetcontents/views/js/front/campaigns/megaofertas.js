$(document).ready(function() {
    ...
    var imageElement = $('.megaofertas-img'); // Selecciona el elemento de la imagen por su ID
    ...
    if (isIphone || isAndroid || isIpad) {
        imageElement.attr('src', '/themes/alvarez/assets/img/theme/cms/111/'+language+'/megaofertas-mobile.jpg');
    } else if (isWeb) {
            imageElement.attr('src', '/themes/alvarez/assets/img/theme/cms/111/'+language+'/megaofertas-desktop.jpg');
    }
});