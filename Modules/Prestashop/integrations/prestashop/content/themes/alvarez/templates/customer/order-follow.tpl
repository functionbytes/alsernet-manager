...
{block name='page_title'}
  {l s='Merchandise returns' d='Shop.Customer.Orders'}
{/block}
...
{block name='page_content'}
  ...
  {if $ordersReturn && count($ordersReturn)}
    ...
    <h6>{l s='Here is a list of pending merchandise returns' d='Shop.Customer.Orders'}</h6>
      ...
      {foreach from=$ordersReturn item=return}
        <div class="order-return">
          <ul>
            ...
            <li>
              <strong>{l s='Return' d='Shop.Customer.Orders'}</strong>
              <a href="{$return.return_url}">{$return.return_number}</a>
            </li>
            <li>
              <strong>{l s='Package status' d='Shop.Customer.Orders'}</strong>
              {$return.state_name}
            </li>
            <li>
