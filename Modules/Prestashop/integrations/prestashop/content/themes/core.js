    ...
    var e = {
            ...
            999: (e, t, n) => {
                ...
                function a(e) {
                    ...
                    o.default.on("updateCart", (function(e) {
                        ...
                        if (t) {
                            ...
                            e && e.reason && (n = {
                                ...
                                (0, r.default)(o.default.selectors.cart.detailedTotals).replaceWith(e.cart_detailed_totals), (0, r.default)(o.default.selectors.cart.summaryItemsSubtotal).replaceWith(e.cart_summary_items_subtotal), (0, r.default)(o.default.selectors.cart.summarySubTotalsContainer).replaceWith(e.cart_summary_subtotals_container), (0, r.default)(o.default.selectors.cart.summaryProducts).replaceWith(e.cart_summary_products), (0, r.default)(o.default.selectors.cart.summaryTotals).replaceWith(e.cart_summary_totals), (0, r.default)(o.default.selectors.cart.detailedActions).replaceWith(e.cart_detailed_actions), (0, r.default)(o.default.selectors.cart.voucher).replaceWith(e.cart_voucher), (0, r.default)(o.default.selectors.cart.overview).replaceWith(e.cart_detailed), (0, r.default)(o.default.selectors.cart.summaryTop).replaceWith(e.cart_summary_top), (0, r.default)(o.default.selectors.cart.related).replaceWith(e.cart_related), (0, r.default)(o.default.selectors.cart.productCustomizationId).val(0), (0, r.default)(o.default.selectors.cart.lineProductQuantity).each((function(e, t) {
                                    var n = (0, r.default)(t);
                                    n.attr("value", n.val())
                    ...
                    e.on("click", '[data-button-action="add-to-cart"]', (function(e) {
                        ...
                        if((0, r.default)('#tipo_lote_aux').val() == 1){

                            if ((0, r.default)('.select-lote .wk-select-sub-product').length) {
                                //if ((0, r.default)('.wk-select-sub-product.btn-secondary').length || (0, r.default)('.wk-select-sub-product.btn-primary').length == 0) {
                                if((0, r.default)('.select-lote .wk-select-sub-product').click()){
                            ...
                            s = !0, c.each((function(e, t) {
                                ...
                                /*Control de errores tarjeta regalo - Addis*/
                                //console.log(e);
                                //console.log(e.errors);
                                if(e.errors){
                                    (e.errors).forEach(control_errores);
                                }else{
                                    o.default.emit("updateCart", {
                                        reason: {
                                            idProduct: e.id_product,
                                ...
                                function control_errores(item, index) {
                                    //console.log(item);
                                    if(item == 'nombre_incorrecto'){
                                        $('#field-textField9').css('border-color','#ed7e60');
                                    }else{
                                        if ($('#field-textField9').val() != '') {
                                            $('#field-textField9').css('border-color','#CCCCCC');
                                        }
                                    }
                                    if(item == 'apellidos_incorrecto'){
                                        $('#field-textField10').css('border-color','#ed7e60');
                                    }else{
                                        if ($('#field-textField10').val() != '') {
                                            $('#field-textField10').css('border-color','#CCCCCC');
                                        }
                                    }
                                    if(item == 'importe_incorrecto'){
                                        $('#field-textField11').css('border-color','#ed7e60');
                                    }else{
                                        if ($('#field-textField11').val() != '') {
                                            $('#field-textField11').css('border-color','#CCCCCC');
                                        }
                                    }
                                    if(item == 'email_incorrecto'){
                                        $('#field-textField12').css('border-color','#ed7e60');
                                        $('#msg_error_textField12').css('display','block');
                                    }else{
                                        if ($('#field-textField12').val() != '') {
                                            $('#field-textField12').css('border-color','#CCCCCC');
                                            $('#msg_error_textField12').css('display','none');
                                        }
                                    }
                                    if(item == 'msg_incorrecto'){
                                        $('#field-textField13').css('border-color','#ed7e60');
                                    }else{
                                        if ($('#field-textField13').val() != '') {
                                            $('#field-textField13').css('border-color','#CCCCCC');
                                        }
                                    }
                                    if(item == 'precio_0'){
                                        $('.p-cartwapper').append('<div class="alert alert-danger ajax-error" role="alert">' + e.errors[index + 1] + '</div>');
                                    }
                                }
                                /*HASTA AQUI*/
                            })).fail((function(e) {
            ...
            226: (e, t, n) => {
                ...
                function v(e) {
                    ...
                    /*Control de ficha de producto - Addis*/
                    var ficha = "";
                    if($('.product-variants').length || $('.tarjeta_regalo').length){
                        var ficha = "".concat(o.default.selectors.product.variants, " *[name]");
                    }
                    if($('.product-variants-fitting').length){
                        var ficha = "".concat(o.default.selectors.product.variants_fitting, " *[name]");
                    }
                    if($('.product-variants-demoday').length){
                        var ficha = "".concat(o.default.selectors.product.variants_demoday, " *[name]");
                    }
                    /*Hasta aquí*/
                                            ...
                                            "" !== d && (c = r.default.ajax({
                                                ...
                                                success: function(e) {
                                                   ...
                                                   if(e.view === "fitting"){
                                                    ...
                                                    (0, r.default)(o.default.selectors.product.addToCart).first().replaceWith(e.product_add_to_cart);
                                                   }else if(e.view === "demoday"){
                                                    (0, r.default)(o.default.selectors.product.variantsUpdate).first().replaceWith(e.product_variants),
                                                    (0, r.default)(o.default.selectors.product.addToCart).first().replaceWith(e.product_add_to_cart);
                                                   }else{
                                                    ...
                                                    ////        })), null === t && h();
                                                            ...
                                                            //        v({
                                                            //            $aproduct-add-to-cartddToCartSnippet: t,
                                                            //            $targetParent: n,
                                                    //           targetSelector: ".add"
                                                            //       }), v({
                                                            //           $addToCartSnippet: t,
                                                    ...
                                                    const spanElement = document.querySelector(".product-reference span");
                                                    spanElement ? spanElement.innerHTML = e.reference : null;

                                                    document.querySelector("#id_product_attribute").value = e.id_product_attribute;
            ...
            965: (e, t, n) => {
                ...
                r.default.selectors = {
                    ...
                    cart: {
                        ...
                        summaryProducts: ".cart-summary-inventaries, .js-cart-summary-inventaries",
