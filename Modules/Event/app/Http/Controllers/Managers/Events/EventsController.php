...
class EventsController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('event::managers.events.index')->with([
            'events' => $events,
            'available' => $available,
            'searchKey' => $searchKey,
        ]);
    ...
    public function create(): View
    {
        ...
        return view('event::managers.events.create')->with($options);
    }
    ...
    public function edit(string $uid): View
    {
        ...
        return view('event::managers.events.edit')->with([
            'event' => $event,
            ...$options,
        ]);
    }
    ...
    public function view(string $uid): View
    {
        ...
        return view('event::managers.events.show')->with([
            'event' => $event,
        ]);
    }
