...
class ReturnService
{
     ...
     */
    public function processPayment(ReturnRequest $return, array $paymentData): \Modules\Returns\Models\ReturnPayment
    {
        return DB::transaction(function () use ($return, $paymentData) {
            $payment = \Modules\Returns\Models\ReturnPayment::create([
