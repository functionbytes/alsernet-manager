...
class DocumentConfigurationController extends Controller
{
    ...
    {
        return view('documents::managers.settings.index');
    }
    ...
    public function storageSettings()
    {
        ...
        return view('documents::managers.settings.configurations.storage', [
    ...
    public function globalSettings()
    {
        ...
        return view('documents::managers.settings.configurations.index', [
