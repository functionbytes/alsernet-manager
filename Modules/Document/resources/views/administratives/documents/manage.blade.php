...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            @include('managers.components.email-actions-card', [
                'document' => $document,
        ...
        <div class="col-lg-8">
            ...
            @include('managers.components.document-management-card', [
                'document' => $document,
                'statuses' => $statuses,
    ...
    @include('administratives.views.documents.modals.confirm-missing-documents')
    @include('administratives.views.documents.modals.confirm-delete-document')
