        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex align-items-center gap-3 p-3 bg-light rounded mb-3">
                    ...
                    <div>
                        <p class="mb-0 fw-semibold">Etapa {{ $document->current_stage }}
                            de {{ $document->total_stages }}</p>
                        <small
                            class="text-muted">Grupo: {{ ucfirst($document->current_validator_group ?? 'Sin asignar') }}</small>
                    </div>
                </div>
                    ...
                    <div class="alert bg-primary-subtle border-0 mb-3">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <small class="text-dark">{{ ucfirst($nextGroup) }} - Se notificará al grupo o usuario
                                    asignado</small>
                            </div>
                        </div>
                    </div>
                    ...
                    @if($nextGroupUsers->isNotEmpty())
                        <div class="mb-3">
                            ...
                            <small class="text-muted">
                                <i class="fas fa-info-circle me-1"></i>Opcional: asigna a una persona o deja que todo el
                                grupo lo vea
                            </small>
                        </div>
                    @endif
