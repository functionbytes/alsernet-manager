...
@section('content')
    ...
    @include('theme.components.card', ['title' => 'Grupos de Validación'])
                                    ...
                                    <td>
                                        @php
                                            $modeLabels = [
                                                ...
                                                'round_robin' => ['label' => 'R. Robin', 'color' => 'light'],
                                                'load_balanced' => ['label' => 'Balance', 'color' => 'light']
                                            ];
                                            $mode = $modeLabels[$group->assignment_mode] ?? ['label' => 'Manual', 'color' => 'black'];
                                        @endphp
