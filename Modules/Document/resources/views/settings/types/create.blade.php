                ...
                <form id="formDocumentType" action="{{ route('settings.documents.types.store') }}" method="POST">
                    ...
                    <div class="card-header border-bottom p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="mb-1 fw-bold">Crear tipo de documento</h5>
                                <p class="mb-0 text-muted small">Complete la información para registrar un nuevo tipo de documento.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                              ...
                                              placeholder="Descripción del tipo de documento">{{ old('description') }}</textarea>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <small class="form-text text-muted">Vista previa: <i id="iconPreview" class="{{ old('icon', 'fa fa-file') }} ms-1"></i></small>
                                    @error('icon')
                                        <span class="field-validation-error"><i class="fas fa-circle-exclamation"></i> {{ $message }}</span>
                                    @enderror
                                </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div id="validationStagesContainer" class="mb-3">
                                                ...
                                                @else
                                                    ...
                                                    <div id="noStagesMessage" class="text-center py-5">
...
$(document).ready(function() {
    ...
    var availableStages = @json($validatorGroups->map(function($group) {
        return [
            'key' => $group->key,
            'name' => $group->name,
    ...
    $('#addStageBtn').on('click', function() {
        ...
        // Create modal HTML
        var selectHtml = '<select id="stageSelector" class="form-select select2 select2">' + options + '</select>';
    ...
    $('#addRequirement').on('click', function() {
        ...
        const html = `
            <div class="card mb-3 requirement-item" data-index="${index}">
                <div class="card-header border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="fw-semibold">Requisito #${index + 1}</span>
        ...
        // Attach remove handler with confirmation modal
