 ...
 * @property-read \Modules\Mail\Models\MailLayout|null $layout
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Modules\Mail\Models\MailTemplateLang> $translations
...
class MailTemplate extends Model
{
    ...
    {
        return $this->belongsTo('Modules\Mail\Models\MailLayout', 'layout_id', 'id');
    }
