...
namespace Modules\Mail\Http\Controllers\Managers\Settings\Mails;
...
class MailTemplateController extends Controller
{
    ...
    public function preview(Request $request, $uid)
    {
        ...
        $html = \Modules\Mail\Services\MailTemplateRendererService::renderEmailTemplate($template, $variables, $langId);
    ...
    private function getPreviewVariables(MailTemplate $template, ?int $langId = null): array
    {
        ...
        $realValues = \Modules\Mail\Services\MailVariableValueService::getTranslatedValues($langId, $template->module);
...
PREHEADER;
    ...
    public function variables($uid)
    {
        try {
            ...
            $dbVariables = \Modules\Mail\Models\MailVariable::query()
                ->where('is_enabled', true)
