            ...
            <div class="card w-100">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <form id="importForm"
                              action="{{ route('manager.subscribers.import.dispatch', ['import_uid' => $import->uid]) }}"
                    ...
                    <div class="form-group processing hide">
                        <h4 style="margin-bottom: 20px" id="notice">La importación se está ejecutando en segundo plano,
                            espere... <br>Puede navegar o incluso cerrar esta página y volver más tarde para comprobar
                            el progreso.</h4>
                    ...
                    <div class="form-group finish hide">
                        <div class="text-left">
                            ...
                            <a href="{{ route('manager.subscribers.create') }}"
                               class="btn btn-info px-4 waves-effect waves-light mt-2 w-100 ">
