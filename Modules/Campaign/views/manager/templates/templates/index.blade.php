@extends('manager.layouts.managers')

@section('content')

    @include('managers.components.card', ['title' => 'Plantillas campañas'])
                            ...
                            <div class="col-sm-3 col-xxl-3">
                                <div class="card ">
                                    <div class="position-relative">
                                        <a>
                                            <img src="{{ $template->getThumbUrl() }} " class="card-img-top"
                                                 alt="modernize-img">
                                        </a>
                                        ...
                                        <div class="template-options bg-primary text-bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3 ql-color-white">
                                            <button type="button" class="p-1 border-0 bg-transparent"
                                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                                    style="display: flex; align-items: center;">
                                                <i class="fa-duotone fa-solid fa-gear"></i>
                                            </button>
                                            <ul class="dropdown-menu  rubberBand" data-bs-popper="static"
                                                style="z-index: 1050;">
                                                <li>
                                                    <a class="dropdown-item change-template-name"
                                                       href="{{ route('manager.templates.changemame', ['uid' => $template->uid]) }}">
                                                        Cambiar nombre
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item upload-thumb-button"
                                                       href="{{ route('manager.templates.update.thumb', $template->uid) }}">
                                                        Cambiar imagen
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item template-categories"
                                                       href="{{ route('manager.templates.categories', ['uid' => $template->uid]) }}">
                                                        Categorias
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('manager.templates.export', $template->uid) }}"
                                                       role="button" class="dropdown-item" link-method="POST">
                                                        Exportar
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('manager.templates.copy', $template->uid) }}"
                                                ...
                                                <li>
                                                    <a class="dropdown-item list-action-single"
                                                       link-confirm="Estás a punto de eliminar :plantilla(s) de números."
                                                       href="{{ route('manager.templates.delete', ["uids" => $template->uid]) }}">
                                                        Eliminar
                                                    </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="#preview"
                                                       onclick="popupwindow('{{ route('manager.templates.preview', $template->uid) }}', `{{ $template->title }}`, 800)">
                                                        Previsualizar
                                                    </a>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="card-body pt-3 p-4">
                                        ...
                                        <div class="pb-2 pt-3">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <a href="{{ route('manager.templates.categories', ['uid' => $template->uid,]) }}"
                                        ...
                                        <div class="mb-0 border-top mt-2 pt-3">
                                            <div>
                                                <a class="btn btn-primary btn-icon template-compose d-block mb-2  w-100"
                                                   href="#preview"
                                                   onclick="popupwindow('{{ route('manager.templates.preview', $template->uid) }}', `{{ $template->title }}`, 800)">
                                                    Previsulizar
                                                </a>
                                            ...
                                            <div>
                                                <a href="{{ route('manager.templates.builder.edit', $template->uid) }}"
                                                   class="btn btn-primary mb-2 w-100">
                                                    Avanzado
                                                </a>
                                            </div>
                                            <div>
                                                <a href="{{ route('manager.templates.edit', $template->uid) }}"
