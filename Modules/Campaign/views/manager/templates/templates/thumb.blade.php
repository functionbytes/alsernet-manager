@extends('manager.layouts.popup.small')
    ...
    <div class="row">
        <div class="col-md-3">
            <div class=" wizard ">
                <ul class="steps nav nav-tabs mc-nav campaign-template-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link thumb-url-tab"
                           href="{{ route('manager.templates.update.thumburl', $template->uid) }}">
                            Url
                        </a>
                    </li>
                </ul>
        ...
        <div class="col-md-9">
            <div class="wizard-body">
                ...
                <p>Subir imagen para la miniatura de la plantilla cuando se muestra en la lista o representa el uso de
                    la plantilla</p>

                <form enctype="multipart/form-data"
                      action="{{ route('manager.templates.update.thumb', $template->uid) }}" method="POST"
                      class="template_upload_form form-validate-jquery">
