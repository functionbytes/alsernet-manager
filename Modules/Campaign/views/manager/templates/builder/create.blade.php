...
@section('content')
    ...
    @include('managers.components.card', ['title' => 'Nueva plantilla'])

    <div class="widget-content searchable-container list">
        <div class="card">

            <div class="card-body border-bottom">
                <form action="{{ route('manager.templates.builder.create') }}" method="POST"
                    ...
                    <div class="mb-4">
                        <input type="text" class="form-control" id="name" name="title" value="{{$template->title}}"
                                ...
                                <div class="row">
                                    @foreach ($templates as $key => $template)
                                        <div class="col-sm-3 col-xxl-3">
                                            <div href="javascript:;" class="card  select-template-layout"
                                                 data-template="{{ $template->uid }}">
