...
@section('content')
    ...
    @include('managers.components.card', ['title' => 'Importar suscripciones - '. $list->title])
            ...
            <div class="card w-100">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <form id="importForm"
                              action="{{ route('manager.campaigns.maillists.subscribers.import.dispatch', ['list_uid' => $list->uid]) }}"
                            ...
                            <div class="form-group finish hide">
                                <div class="text-left">
                                    <a id="downloadLog" target="_blank" href="#" role="button"
                                       class="btn btn-info px-4 waves-effect waves-light mt-2 w-100">
                                        Descargar log
                                    </a>
                                    <a href="#retry"
                                       class="btn btn-info px-4 waves-effect waves-light mt-2 w-100 retry">
                                        Importar otro
                                    </a>
                                </div>
                            </div>
