                ...
                <table class="table search-table align-middle text-nowrap">
                    ...
                    @foreach ($subscribers as $key => $subscriber)
                        <tr class="search-items">
                            ...
                            <td>
                                <span class="badge {{ $subscriber->available == 1 ? 'bg-light-secondary  text-primary' : 'bg-light-secondary  text-primary' }}  rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                                           {{ $subscriber->available == 1 ? 'Publico' : 'Oculto' }}
                                </span>
                            </td>
                            ...
                            <td class="text-left">
                                <div class="dropdown dropstart">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.subscribers.lists', $subscriber->uid) }}">
                                                Listado
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.subscribers.logs', $subscriber->uid) }}">
                                                Logs
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.subscribers.edit', $subscriber->uid) }}">
                                                Editar
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3 confirm-delete" data-href="{{ route('manager.subscribers.destroy', $subscriber->uid) }}">Eliminar</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
