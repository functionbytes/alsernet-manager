...
@section('content')
    ...
    @include('managers.components.card', ['title' => 'Plantillas correos'])
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                                <span class="usr-ph-no"
                                      data-phone="{{ date('Y-m-d', strtotime($layout->updated_at)) }}">{{ date('Y-m-d', strtotime($layout->updated_at)) }}</span>
                            </td>
                            <td class="text-left">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                               href="{{ route('manager.layouts.edit', $layout->uid) }}">
                                                Editar
                                            </a>
                                        </li>
                                    </ul>
