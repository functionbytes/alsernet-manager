 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignSegment whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignSegment whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignSegment whereMaillistId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignSegment whereMatching($value)
...
class CampaignSegment extends Model
{
    ...
    {
        return $this->belongsTo(CampaignMaillist::class);
    }
