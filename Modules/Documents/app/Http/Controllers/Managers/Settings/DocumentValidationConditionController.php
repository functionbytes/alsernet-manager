...
class DocumentValidationConditionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('documents::managers.settings.conditions.index', [
    ...
    public function create()
    {
        ...
        return view('documents::managers.settings.conditions.create', [
    ...
    public function edit(string $condition)
    {
        ...
        return view('documents::managers.settings.conditions.edit', [
