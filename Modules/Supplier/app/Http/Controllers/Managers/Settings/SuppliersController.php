...
class SuppliersController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('managers.views.settings.suppliers.index', compact('suppliers', 'searchKey', 'is_active', 'pageTitle', 'breadcrumb'));
    }
    ...
    public function create(): View
    {
        ...
        return view('managers.views.settings.suppliers.create', compact('pageTitle', 'breadcrumb'));
    }
    ...
    public function edit(string $uid): View
    {
        ...
        return view('managers.views.settings.suppliers.edit', compact('supplier', 'pageTitle', 'breadcrumb'));
    }
