...
@section('content')
    ...
    <div class="card w-100">
        ...
        <form id="formSource" method="POST" action="{{ route('manager.settings.suppliers.sources.update', [$supplier->uid, $source->uid]) }}">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('manager.settings.suppliers.sources.index', $supplier->uid) }}" class="btn btn-light">
            ...
            <div class="card-footer">
                        ...
                        <a href="{{ route('manager.settings.suppliers.sources.index', $supplier->uid) }}" class="btn btn-light w-100">
                            Cancelar
                        </a>
            </div>
...
$(document).ready(function() {
    ...
    $('#testConnectionBtn').on('click', function() {
        ...
        $.ajax({
            url: '{{ route("manager.settings.suppliers.sources.test", [$supplier->uid, $source->uid]) }}',
            method: 'POST',
            data: {
                _token: '{{ csrf_token() }}'
            },
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    setTimeout(function() {
                        window.location.href = '{{ route("manager.settings.suppliers.sources.index", $supplier->uid) }}';
                    }, 1000);
                } else {
