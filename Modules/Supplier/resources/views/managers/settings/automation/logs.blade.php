            ...
            <div class="card-header p-4 border-bottom border-light text-light">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('manager.settings.suppliers.automation.index') }}" class="btn btn-secondary">
...
$(document).ready(function() {
    ...
    $('#downloadLogsBtn').on('click', function() {
        const downloadUrl = '{{ route("manager.settings.suppliers.automation.logs.download") }}?type=' + currentLogType;
    ...
    function loadLogs(type = 'error') {
        ...
        $.ajax({
            url: '{{ route("manager.settings.suppliers.automation.logs.data") }}',
            method: 'GET',
            data: { type: type },
