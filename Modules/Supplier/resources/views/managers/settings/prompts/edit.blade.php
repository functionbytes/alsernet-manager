    ...
    <div class="row">
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                <form action="{{ route('manager.settings.suppliers.prompts.update', $prompt->uid) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-footer border-top">
                                ...
                                <a href="{{ route('manager.settings.suppliers.prompts.index') }}" class="btn btn-secondary w-100">
                                    Cancelar
                                </a>
                    </div>
                </form>
