...
use Modules\Supplier\Http\Controllers\Managers\Settings\PromptTemplatesController;
use Modules\Supplier\Http\Controllers\Managers\Settings\SupplierAutomationController;
use Modules\Supplier\Http\Controllers\Managers\Settings\SupplierCategoriesController;
use Modules\Supplier\Http\Controllers\Managers\Settings\SupplierContentController;
use Modules\Supplier\Http\Controllers\Managers\Settings\SupplierPromptsController;
use Modules\Supplier\Http\Controllers\Managers\Settings\SuppliersController;
use Modules\Supplier\Http\Controllers\Managers\Settings\SupplierSourcesController;
...
Route::group(['prefix' => 'suppliers'], function () {
    ...
    Route::get('/data', [SuppliersController::class, 'getData'])->name('suppliers.data');
    ...
    Route::post('/test-all', [SuppliersController::class, 'testAll'])->name('suppliers.test-all');

    // Specific resource routes (before parametrized routes to avoid route collision)
    // Prompts
    Route::prefix('prompts')->name('suppliers.prompts.')->group(function () {
    ...
    // Templates
    Route::prefix('templates')->name('suppliers.templates.')->group(function () {
    ...
    // Automation
    Route::prefix('automation')->name('suppliers.automation.')->group(function () {
    ...
    // Content
    Route::prefix('content')->name('suppliers.content.')->group(function () {
    ...
    Route::get('/show/{uid}', [SuppliersController::class, 'show'])->name('suppliers.show');
    Route::get('/edit/{uid}', [SuppliersController::class, 'edit'])->name('suppliers.edit');
    Route::put('/{uid}', [SuppliersController::class, 'update'])->name('suppliers.update');
    Route::delete('/{uid}', [SuppliersController::class, 'destroy'])->name('suppliers.destroy');
    Route::post('/{uid}/toggle', [SuppliersController::class, 'toggle'])->name('suppliers.toggle');

    // Sources
    Route::prefix('{supplierUid}/sources')->name('suppliers.sources.')->group(function () {
    ...
    // Categories
    Route::prefix('{supplierUid}/categories')->name('suppliers.categories.')->group(function () {
