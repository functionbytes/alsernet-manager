                                ...
                                <div class="">
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div
                                                class="bg-light-secondary rounded-1 p-6 d-flex align-items-center justify-content-center">
                                                <i class="fa fa-newspaper text-dark d-block fs-7" width="22"
                                                    height="22"></i>
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div
                                                class="bg-light-secondary rounded-1 p-6 d-flex align-items-center justify-content-center">
                                                <i class="fa fa-square-check text-dark d-block fs-7" width="22"
                                                    height="22"></i>
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div
                                                class="bg-light-secondary rounded-1 p-6 d-flex align-items-center justify-content-center">
                                                <i class="fa fa-clock text-dark d-block fs-7" width="22"
                                                    height="22"></i>
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div
                                                class="bg-light-secondary rounded-1 p-6 d-flex align-items-center justify-content-center">
                                                <i class="fa fa-truck text-dark d-block fs-7" width="22"
                                                    height="22"></i>
                                            </div>
                                            <div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-7">
                                    <div class="d-flex align-items-center gap-3">
                                        <div
                                            class="bg-light-secondary rounded-1 p-6 d-flex align-items-center justify-content-center">
                                            <i class="fa fa-pause text-dark d-block fs-7" width="22"
                                                height="22"></i>
                                        </div>
                                        <div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-7">
                                    <div class="d-flex align-items-center gap-3">
                                        <div
                                            class="bg-light-secondary rounded-1 p-6 d-flex align-items-center justify-content-center">
                                            <i class="fa fa-credit-card text-dark d-block fs-7" width="22"
                                                height="22"></i>
                                        </div>
                                        <div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body p-4">
                                <div
                                    class="bg-light-secondary rounded-1 p-6 d-inline-flex align-items-center justify-content-center mb-3">
                                ...
                                <div class="d-flex align-items-center justify-content-between py-3 border-bottom">
                                    <div class="d-flex align-items-center gap-3">
                                        <i class="fa fa-mobile text-dark d-block fs-7" width="26"
                                            height="26"></i>
                                        <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between py-3">
                                    <div class="d-flex align-items-center gap-3">
                                        <i class="fa fa-laptop text-dark d-block fs-7" width="26"
                                            height="26"></i>
                                        <div>
