...
<!-- Theme & App Scripts -->
<script src="{{ url('managers/js/theme/app.min.js') }}"></script>
<script src="{{ url('managers/js/theme/sidebarmenu.js') }}"></script>
<script src="{{ url('managers/js/theme/theme.js') }}"></script>

<!-- Form Initializers -->
<script src="{{ url('managers/js/forms/select2.init.js') }}"></script>
<script src="{{ url('managers/js/forms/form-wizard.js') }}"></script>
<script src="{{ url('managers/js/forms/quill-init.js') }}"></script>
<script src="{{ url('managers/js/forms/repeater-init.js') }}"></script>
