...
class WarehouseInventorySlot extends Model
{
    ...
    {
        return $this->belongsTo(WarehouseLocationSection::class, 'section_id', 'id');
    }
    ...
    public function location(): \Illuminate\Database\Eloquent\Relations\HasOneThrough
    {
        return $this->hasOneThrough(
            ...
            WarehouseLocationSection::class,
    ...
    {
        return $this->belongsTo(WarehouseLocationSection::class, 'last_section_id', 'id');
    }
    ...
    public function addQuantity(int $amount, ?string $reason = null, ?int $userId = null): bool
    {
        ...
        if (class_exists('Modules\Warehouse\Entities\WarehouseInventoryMovement')) {
