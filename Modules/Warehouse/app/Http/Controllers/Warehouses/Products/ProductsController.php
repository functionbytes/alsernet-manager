...
class ProductsController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('warehouse::inventaries.inventaries.index')->with([
    ...
    public function create()
    {
        ...
        return view('warehouse::inventaries.inventaries.create')->with([
    ...
    public function edit($uid)
    {
        ...
        return view('warehouse::inventaries.inventaries.edit')->with([
            'product' => $product,
            'availables' => $availables,
        ]);
