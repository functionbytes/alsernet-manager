...
class WarehouseLocationSectionsController extends Controller
{
    ...
    public function index($warehouse_uid, $floor_uid, $location_uid)
    {
        ...
        return view('warehouse::managers.sections.index', [
            'warehouse' => $warehouse,
            'floor' => $floor,
            'location' => $location,
            'sections' => $sections,
    ...
    public function create($warehouse_uid, $floor_uid, $location_uid)
    {
        ...
        return view('warehouse::managers.sections.create', [
            'warehouse' => $warehouse,
            'floor' => $floor,
            'location' => $location,
    ...
    public function view($warehouse_uid, $floor_uid, $location_uid, $section_uid)
    {
        ...
        return view('warehouse::managers.sections.view', [
            'warehouse' => $warehouse,
            'floor' => $floor,
            'location' => $location,
            'section' => $section,
    ...
    public function edit($warehouse_uid, $floor_uid, $location_uid, $section_uid)
    {
        ...
        return view('warehouse::managers.sections.edit', [
            'warehouse' => $warehouse,
            'floor' => $floor,
            'location' => $location,
            'section' => $section,
