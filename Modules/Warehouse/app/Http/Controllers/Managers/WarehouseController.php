...
class WarehouseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('warehouse::managers.warehouses.index')->with([
    ...
    public function create()
    {
        ...
        return view('warehouse::managers.warehouses.create')->with([
        ]);
    }
    ...
    public function edit($uid)
    {
        ...
        return view('warehouse::managers.warehouses.edit')->with([
            'warehouse' => $warehouse,
        ]);
    }
    ...
    public function view($uid)
    {
        ...
        return view('warehouse::managers.warehouses.view')->with([
            'warehouse' => $warehouse,
            'summary' => $summary,
        ]);
    }
