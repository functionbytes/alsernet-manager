...
class WarehouseLocationStylesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('warehouse::managers.styles.index', [
            'styles' => $styles,
        ]);
    }
    ...
    public function create()
    {
        ...
        return view('warehouse::managers.styles.create', [
            'faces' => $faces,
            'types' => $types,
        ]);
    }
    ...
    public function view($style_uid)
    {
        ...
        return view('warehouse::managers.styles.view', [
            'style' => $style,
            'summary' => $summary,
        ]);
    }
    ...
    public function edit($style_uid)
    {
        ...
        return view('warehouse::managers.styles.edit', [
            'style' => $style,
            'faces' => $faces,
            'types' => $types,
        ]);
