...
class WarehouseHistoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('warehouse::managers.history.index')->with([
            'movements' => $movements,
            'searchKey' => $searchKey,
        ]);
    }
    ...
    public function view($uid)
    {
        ...
        return view('warehouse::managers.history.view')->with([
            'movement' => $movement,
        ]);
    }
    ...
    public function edit($uid)
    {
        ...
        return view('warehouse::managers.history.edit')->with([
            'movement' => $movement,
    ...
    {
        $warehouse = \Modules\Warehouse\Entities\Warehouse::uid($warehouseUid)->firstOrFail();
