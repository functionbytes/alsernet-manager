...
class WarehouseFloorsController extends Controller
{
    ...
    public function index($warehouse_uid = null)
    {
        ...
        return view('warehouse::managers.floors.index', [
            'floors' => $floors,
    ...
    public function create($warehouse_uid)
    {
        ...
        return view('warehouse::managers.floors.create')->with([
            'warehouse' => $warehouse,
            'warehouse_uid' => $warehouse_uid,
        ]);
    }
    ...
    public function view($warehouse_uid, $floor_uid)
    {
        ...
        return view('warehouse::managers.floors.view', [
            'warehouse' => $warehouse,
            'floor' => $floor,
        ]);
    }
    ...
    public function edit($warehouse_uid, $floor_uid)
    {
        ...
        return view('warehouse::managers.floors.edit', [
            'warehouse' => $warehouse,
            'floor' => $floor,
        ]);
    }
