...
class WarehouseLocationsController extends Controller
{
    ...
    public function index(Request $request, $warehouse_uid, $floor_uid)
    {
        ...
        return view('warehouse::managers.locations.index')->with([
            'warehouse' => $warehouse,
            'floor' => $floor,
            'locations' => $locations,
            'searchKey' => $searchKey,
    ...
    public function view($warehouse_uid, $floor_uid, $location_uid)
    {
        ...
        return view('warehouse::managers.locations.view')->with([
            'warehouse' => $warehouse,
            'floor' => $floor,
            'location' => $location,
            'slots' => $slots,
    ...
    public function create($warehouse_uid, $floor_uid)
    {
        ...
        return view('warehouse::managers.locations.create')->with([
            'warehouse' => $warehouse,
            'floor' => $floor,
            'styles' => $styles,
        ]);
    ...
    public function edit($warehouse_uid, $floor_uid, $location_uid)
    {
        ...
        return view('warehouse::managers.locations.edit')->with([
            'warehouse' => $warehouse,
            'floor' => $floor,
            'location' => $location,
            'styles' => $styles,
    ...
    public function printBarcodes($warehouse_uid, $floor_uid, $location_uid)
    {
        ...
        return view('warehouse::managers.locations.print-barcodes')->with([
            'warehouse' => $warehouse,
            'floor' => $floor,
            'location' => $location,
            'sections' => $sections,
    ...
    public function printAllBarcodes($warehouse_uid, $floor_uid)
    {
        ...
        return view('warehouse::managers.locations.print-all-barcodes')->with([
            'warehouse' => $warehouse,
            'floor' => $floor,
            'locations' => $locations,
        ]);
    ...
    public function transfer($warehouse_uid, $floor_uid, $location_uid)
    {
        ...
        return view('warehouse::managers.locations.transfer')->with([
            'warehouse' => $warehouse,
            'floor' => $floor,
            'location' => $location,
    ...
    public function transferBulkForm($warehouse_uid, $floor_uid)
    {
        ...
        return view('warehouse::managers.locations.transfer-bulk')->with([
            'warehouse' => $warehouse,
            'floor' => $floor,
            'availableFloors' => $availableFloors,
        ]);
