...
class WarehouseInventorySlotsController extends Controller
{
    ...
    public function index(Request $request, $warehouse_uid, $floor_uid, $location_uid, $section_uid)
    {
        ...
        return view('warehouse::managers.inventory-slots.index', [
            'warehouse' => $warehouse,
            'floor' => $floor,
            'location' => $location,
            'section' => $section,
    ...
    public function create($warehouse_uid, $floor_uid, $location_uid, $section_uid)
    {
        ...
        return view('warehouse::managers.inventory-slots.create', [
            'warehouse' => $warehouse,
            'floor' => $floor,
            'location' => $location,
            'section' => $section,
    ...
    public function view($warehouse_uid, $floor_uid, $location_uid, $section_uid, $slot_uid)
    {
        ...
        return view('warehouse::managers.inventory-slots.view', [
            'warehouse' => $warehouse,
            'floor' => $floor,
            'location' => $location,
            'section' => $section,
    ...
    public function edit($warehouse_uid, $floor_uid, $location_uid, $section_uid, $slot_uid)
    {
        ...
        return view('warehouse::managers.inventory-slots.edit', [
            'warehouse' => $warehouse,
            'floor' => $floor,
            'location' => $location,
            'section' => $section,
