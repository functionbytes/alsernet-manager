...
class WarehouseDashboardController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        return view('warehouse::managers.dashboard')->with([
    ...
    public function resume(Request $request)
    {
        ...
        return view('warehouse::managers.resume.index')->with([
            'warehouses' => $warehouses,
            'filters' => $filters,
        ]);
    }
    ...
    public function generate(Request $request)
    {
        ...
        return view('warehouse::managers.resume.resume')->with([
            'slots' => $slots,
            'summary' => $summary,
            'filters' => $filters,
        ]);
    ...
    public function getFloors(Request $request)
    {
        ...
        $floors = \Modules\Warehouse\Entities\WarehouseFloor::where('warehouse_id', $warehouseId)
            ->available()
            ->get()
            ->map(function ($floor) {
                return [
