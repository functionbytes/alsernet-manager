                ...
                <table class="table search-table align-middle text-nowrap">
                    ...
                    @foreach ($subscribers as $key => $subscriber)
                        <tr class="search-items">
                            ...
                            <td>
                                <span class="badge {{ $subscriber->lopd == 1 ? 'bg-light-secondary  text-primary' : 'bg-light-secondary  text-primary' }}  rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
