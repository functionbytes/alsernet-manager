    ...
    $('[data-btn-action="addTask"]')
      ...
      .on("click", function (event) {
        ...
        item_html =
          ...
          '<a class="dropdown-item kanban-item-edit cursor-pointer d-flex align-items-center gap-1" href="javascript:void(0);"><i class="fa fa-pencilfs-5"></i>Edit</a>' +
          '<a class="dropdown-item kanban-item-delete cursor-pointer d-flex align-items-center gap-1" href="javascript:void(0);"><i class="fa fa-trash fs-5"></i>Delete</a>' +
          "</div>" +
          "</div>" +
          "</div>" +
          "</div>" +
