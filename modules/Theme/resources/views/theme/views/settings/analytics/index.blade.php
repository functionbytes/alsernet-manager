...
@section('content')
    ...
    <script src="{{ asset('/theme/assets/plugins/jquery/jquery-3.2.1.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/theme/assets/plugins/chart.min.js') }}" type="text/javascript"></script>
