...
class WarehouseControllerTest extends TestCase
{
    ...
    public function testIndexReturnsWarehousesWithSearchAndFilter(): void
    {
        ...
        // $response->assertViewIs('warehouse::theme.warehouses.index');
    ...
    public function testCreateShowsForm(): void
    {
        ...
        $response->assertStatus(200);
        $response->assertViewIs('warehouse::theme.warehouses.create');
    }
    ...
    public function testEditShowsFormWithWarehouseData(): void
    {
        ...
        // $response->assertStatus(200);
        // $response->assertViewIs('warehouse::theme.warehouses.edit');
