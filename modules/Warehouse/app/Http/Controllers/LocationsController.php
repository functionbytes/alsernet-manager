...
class LocationsController extends Controller
{
    ...
    public function modalitie($warehouse, $location, $section)
    {
        ...
        //            return view('warehouse::warehouses.warehouses.complete')->with([
        //                'location' => $location,
        //                'warehouse' => $warehouse,
        //                'section' => $section,
        ...
        return view('warehouse::warehouses.warehouses.modalities.modalitie')->with([
            'warehouse' => $warehouse,
            'location' => $location,
            'section' => $section,
        ]);
    ...
    public function automatic($warehouse, $location, $section)
    {
        ...
        return view('warehouse::warehouses.warehouses.modalities.automatic')->with([
            'warehouse' => $warehouse,
            'location' => $location,
            'section' => $section,
            // 'operation' => $operation,
    ...
    public function manual($warehouse, $location, $section)
    {
        ...
        return view('warehouse::warehouses.warehouses.modalities.manual')->with([
            'warehouse' => $warehouse,
            'location' => $location,
            'section' => $section,
            'operation' => $operation,
