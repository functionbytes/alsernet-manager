...
class LocationsController extends Controller
{
    public function index(Request $request, $uid)
    {
        ...
        return view('theme.views.shops.locations.locations.index')->with([
            'shop' => $shop,
            'locations' => $locations,
            'available' => $available,
            'searchKey' => $searchKey,
    ...
    public function create($uid, $lang = 'es')
    {
        ...
        return view('theme.views.shops.locations.locations.create')->with([
    ...
    public function exists($uid)
    {
        ...
        return view('theme.views.shops.locations.locations.exists')->with([
            'shop' => $shop,
        ]);
    ...
    public function edit($uid)
    {
        ...
        return view('theme.views.shops.locations.locations.edit')->with([
            'location' => $location,
            'availables' => $availables,
            'shop' => $location->shop,
            'shops' => $shops,
    ...
    public function history(Request $request, $uid)
    {
        ...
        return view('theme.views.warehouses.historys.index')->with([
            'items' => $items,
            'searchKey' => $searchKey,
        ]);
