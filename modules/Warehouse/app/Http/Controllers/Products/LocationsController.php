...
class LocationsController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('warehouse::plans.index')->with([
            'plans' => $plans,
            'available' => $available,
            'website' => $website,
            'searchKey' => $searchKey,
    ...
    public function navegation($uid)
    {
        ...
        return view('warehouse::plans.navegation')->with([
            'plan' => $plan,
        ]);
    ...
    public function create()
    {
        ...
        return view('warehouse::plans.create')->with([
    ...
    public function edit($uid)
    {
        ...
        return view('warehouse::plans.edit')->with([
            'plan' => $plan,
            'availables' => $availables,
        ]);
