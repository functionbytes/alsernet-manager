    ...
    <div class="container-fluid note-has-grid inventaries-content">
        ...
        <div class="tab-content">
            <div  class="note-has-grid row">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <a class="card-body text-center" href="{{ route('warehouse.warehouses.arrange', $warehouse->uid ) }}" >
...
{{--                <div class="col-md-6">--}}
{{--                    <div class="card">--}}
{{--                        <a class="card-body text-center" href="{{ route('warehouse.warehouses.close', $warehouse->uid ) }}" >--}}
