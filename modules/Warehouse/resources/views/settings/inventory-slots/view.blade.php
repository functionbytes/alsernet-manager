            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            <a href="{{ route('settings.warehouse.slots.edit', $slot->uid) }}" class="btn btn-sm btn-primary">
                                <i class="fa fa-pencil></i> Editar
                            </a>
                            <a href="{{ route('settings.warehouse.slots') }}" class="btn btn-sm btn-secondary">
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-bordered table-sm">
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('settings.warehouse.locations.view', $slot->stand->uid) }}">
                                ...
                                <tr>
                                    <th>Piso</th>
                                    <td>
                                        <a href="{{ route('settings.warehouse.floors.view', $slot->stand->floor->uid) }}">
