    ...
    <div class="row">
        <div class="col-lg-12 d-flex align-items-stretch">
            ...
            <div class="card w-100">
                ...
                <form id="formSlotsEdit" action="{{ route('settings.warehouse.slots.update') }}" method="POST" role="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="border-top pt-3 mt-4">
                                    ...
                                    <a href="{{ route('settings.warehouse.slots') }}" class="btn btn-secondary px-4 waves-effect waves-light mt-2">
