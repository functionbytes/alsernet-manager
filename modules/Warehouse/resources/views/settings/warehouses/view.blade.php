...
@section('content')
    ...
    @include('managers.components.card', ['title' => 'Detalles del Almacén'])
                    ...
                    <div class="card-body">
                        ...
                        <div class="border-top mt-4 pt-4">
                            <div class="d-flex gap-2">
                                <a href="{{ route('settings.warehouse.edit', $warehouse->uid) }}" class="btn btn-primary btn-sm">
            ...
            <div class="col-lg-4">
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body d-flex flex-column gap-2">
                        <a href="{{ route('settings.warehouse.dashboard.index', $warehouse->uid) }}" class="btn btn-outline-primary btn-sm">
                            <i class="fa-duotone fa-chart-line"></i> Dashboard
                        </a>
                        <a href="{{ route('settings.warehouse.map', $warehouse->uid) }}" class="btn btn-outline-success btn-sm">
                            <i class="fa-duotone fa-map-location-dot"></i> Mapa
                        </a>
                        <a href="{{ route('settings.warehouse.history', $warehouse->uid) }}" class="btn btn-outline-info btn-sm">
