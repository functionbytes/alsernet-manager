...
@section('content')
    ...
    @include('theme.components.card', ['title' => 'Detalles del Almacén'])
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-start">
                                    ...
                                    <span class="fw-semibold text-end"
                                          style="max-width: 60%;">{{ $warehouse->description ?? 'Sin descripción' }}</span>
                                </div>
                            </div>
                        ...
                        <div class="border-top mt-4 pt-4">
                            <div class="d-flex gap-2">
                                <a href="{{ route('settings.warehouse.edit', $warehouse->uid) }}"
            ...
            <div class="col-lg-4">
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="progress" style="height: 6px;">
                                        <div class="progress-bar" role="progressbar"
                                             ...
                                             aria-valuenow="{{ $summary['occupied_slots'] }}" aria-valuemin="0"
                                             aria-valuemax="{{ $summary['total_slots'] }}">
                                        </div>
                                    </div>
                                </div>
                            @endif
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body d-flex flex-column gap-2">
                        <a href="{{ route('settings.warehouse.dashboard.index', $warehouse->uid) }}"
                           class="btn btn-outline-primary btn-sm">
                            <i class="fa-duotone fa-chart-line"></i> Dashboard
                        </a>
                        <a href="{{ route('settings.warehouse.map', $warehouse->uid) }}"
                           class="btn btn-outline-success btn-sm">
                            <i class="fa-duotone fa-map-location-dot"></i> Mapa
                        </a>
                        <a href="{{ route('settings.warehouse.history', $warehouse->uid) }}"
