                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('settings.warehouse.section.edit', [$location->floor->warehouse->uid, $location->floor->uid, $location->uid, $section->uid]) }}"
                               class="btn btn-md btn-primary">
                                <i class="fa fa-pencilme-1"></i>
                            </a>
                            <a href="{{ route('settings.warehouse.sections', [$location->floor->warehouse->uid, $location->floor->uid, $location->uid]) }}"
                            ...
                            <div class="card border-0 shadow-sm h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="mb-0">
                                            <a href="{{ route('settings.warehouse.locations.view', [$location->floor->warehouse->uid, $location->floor->uid, $location->uid]) }}" class="text-primary">
                                                {{ $location->code }}
                                            </a>
                                        </p>
                                    </div>
                                                        ...
                                                        <tr class="align-middle">
                                                            ...
                                                            <td class="text-center">
                                                                <div class="btn-group btn-group-sm" role="group">
                                                                    <a href="{{ route('settings.warehouse.slots.view', $slot->uid) }}"
