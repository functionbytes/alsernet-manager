                            ...
                            <tr class="align-middle">
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('settings.warehouse.section.view', [
                                        ...
                                        <a href="{{ route('settings.warehouse.section.edit', [
                                            'warehouse_uid' => $warehouse->uid,
                                            'floor_uid' => $floor->uid,
                                            'location_uid' => $location->uid,
                                            'section_uid' => $section->uid
                                        ...
                                        <a href="{{ route('settings.warehouse.section.destroy', [
                                            'warehouse_uid' => $warehouse->uid,
                                            'floor_uid' => $floor->uid,
                                            'location_uid' => $location->uid,
                                            'section_uid' => $section->uid
...
<div class="modal fade" id="modalCreateSection" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('settings.warehouse.sections.store', [
                'warehouse_uid' => $warehouse->uid,
                'floor_uid' => $floor->uid,
                'location_uid' => $location->uid
            ]) }}">
