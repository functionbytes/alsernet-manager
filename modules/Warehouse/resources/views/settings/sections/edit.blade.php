        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('settings.warehouse.section.update', [
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="mb-0">
                            <a href="{{ route('settings.warehouse.locations.view', [$warehouse->uid, $floor->uid, $location->uid]) }}" class="text-primary">
                                {{ $location->code }}
                            </a>
                        </p>
                    </div>
                    <div class="mb-0">
                        ...
                        <p class="mb-0">
                            <a href="{{ route('settings.warehouse.floors.view', [$warehouse->uid, $floor->uid]) }}" class="text-primary">
                                {{ $floor->name }}
                            </a>
                        </p>
                    </div>
