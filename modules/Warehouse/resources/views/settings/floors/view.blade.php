                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ route('settings.warehouse.floors.edit',[$warehouse->uid, $floor->uid]) }}"
                               class="btn btn-md btn-primary me-2">
                                <i class="fa fa-pencil></i>
                            </a>
                            <a href="{{ route('settings.warehouse.floors',[$warehouse->uid]) }}"
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        @foreach($floor->locations as $stand)
                                            <tr>
                                                <td>
                                                    <a href="{{ route('settings.warehouse.locations.view',[$warehouse->uid, $floor->uid]) }}">
                                                        {{ $stand->code }}
                                                    </a>
                                                </td>
