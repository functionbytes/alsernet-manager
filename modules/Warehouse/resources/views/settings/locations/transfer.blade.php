...
<div class="row">
    <div class="col-lg-12 d-flex align-items-stretch">
        <div class="card w-100">
            <form id="formLocationTransfer" action="{{ route('settings.warehouse.locations.transfer.store', [$warehouse->uid, $floor->uid, $location->uid]) }}" method="POST" role="form">
                {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="border-top pt-3 mt-4">
                                ...
                                <a href="{{ route('settings.warehouse.locations', [$warehouse->uid, $floor->uid]) }}" class="btn btn-secondary px-4 waves-effect waves-light mt-2">
