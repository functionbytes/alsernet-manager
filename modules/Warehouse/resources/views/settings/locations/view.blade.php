                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ route('settings.warehouse.locations.edit', [$location->floor->warehouse->uid,$location->floor->uid, $location->uid]) }}" class="btn btn-md btn-primary me-2">
                                <i class="fa fa-pencil></i>
                            </a>
                            <a href="{{ route('settings.warehouse.locations',[$location->floor->warehouse->uid,$location->floor->uid]) }}" class="btn btn-md btn-secondary">
                            ...
                            <div class="card border-0 shadow-sm h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="mb-0">
                                            <a href="{{ route('settings.warehouse.floors.view',[$location->floor->warehouse->uid, $location->floor->uid]) }}" class="text-primary">
                                                {{ $location->floor->name }}
                                            </a>
                                        </p>
                                    </div>
                                                    ...
                                                    <td class="text-left">
                                                        <div class="dropdown dropstart">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('settings.warehouse.section.view', [$location->floor->warehouse->uid, $location->floor->uid, $location->uid, $section->uid]) }}" >
                                                                        Ver
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('settings.warehouse.section.edit', [$location->floor->warehouse->uid, $location->floor->uid, $location->uid, $section->uid]) }}">
                                                                        Editar
                                                                    </a>
                                                                </li>
                                                            </ul>
                                    ...
                                    <tbody>
                                        @forelse($location->slots as $slot)
                                            <tr class="align-middle">
                                                ...
                                                <td>
                                                    <a href="{{ route('settings.warehouse.slots.view', $slot->uid) }}" class="btn btn-sm btn-info">
                                                        <i class="fa fa-eye></i>
                                                    </a>
                                                </td>
                                            </tr>
