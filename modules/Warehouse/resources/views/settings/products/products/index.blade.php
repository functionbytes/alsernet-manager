                ...
                <table class="table search-table align-middle text-nowrap">
                    ...
                    @foreach ($products as $key => $product)
                        <tr class="search-items">
                            ...
                            <td>
                                <span class="badge {{ $product->available == 1 ? 'bg-light-secondary  text-primary' : 'bg-light-secondary  text-primary' }}  rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                            ...
                            <td>
                                <span class="usr-ph-no"
                                      data-phone="{{ date('Y-m-d', strtotime($product->updated_at)) }}">{{ date('Y-m-d', strtotime($product->updated_at)) }}</span>
                            </td>
                            <td class="text-left">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                               href="{{ route('manager.inventaries.locations', $product->uid) }}">
                                                Ubicacines
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                               href="{{ route('manager.inventaries.edit', $product->uid) }}">
                                                Editar
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3 confirm-delete"
                                               data-href="{{ route('manager.inventaries.destroy', $product->uid) }}">Eliminar</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
