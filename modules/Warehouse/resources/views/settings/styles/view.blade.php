            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            <a href="{{ route('settings.warehouse.styles.edit', $style->uid) }}" class="btn btn-sm btn-primary">
                                <i class="fa fa-pencil></i> Editar
                            </a>
                            <a href="{{ route('settings.warehouse.styles') }}" class="btn btn-sm btn-secondary">
                                    ...
                                    <table class="table table-sm table-hover">
                                        ...
                                        <tbody>
                                            @foreach($style->locations as $stand)
                                                <tr>
                                                    <td>
                                                        <a href="{{ route('settings.warehouse.locations.view', [$stand->floor->warehouse->uid, $stand->floor->uid, $stand->uid]) }}">
                                                            {{ $stand->code }}
                                                        </a>
                                                    </td>
