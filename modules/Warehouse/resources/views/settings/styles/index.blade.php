...
@section('content')
    ...
    @include('core::components.card', ['title' => 'Estilos de estanterías'])
                ...
                <div class="col-md-12 col-xl-12">
                    <form class="position-relative form-search" action="{{ request()->fullUrl() }}" method="GET">
                        <div class="row justify-content-between g-2 ">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('settings.warehouse.styles.create') }}" class="btn btn-primary">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $loop->index }}">
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                               href="{{ route('settings.warehouse.styles.view', $style->uid) }}">
                                                Ver
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                               href="{{ route('settings.warehouse.styles.edit', $style->uid) }}">
                                                Editar
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3 confirm-delete"
                                               data-href="{{ route('settings.warehouse.styles.destroy', $style->uid) }}">
                                                Eliminar
                                            </a>
                                        </li>
