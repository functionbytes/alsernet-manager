...
namespace Modules\MailsSettings\Http\Controllers\Managers\Settings;
...
class OutgoingEmailSettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('mails-settings::theme.settings.email.outgoing', compact('settings', 'pageTitle', 'breadcrumb'));
    }
    ...
    public function edit()
    {
        ...
        return view('mails-settings::theme.settings.email.outgoing-edit', compact('settings', 'rules', 'pageTitle', 'breadcrumb'));
    }
