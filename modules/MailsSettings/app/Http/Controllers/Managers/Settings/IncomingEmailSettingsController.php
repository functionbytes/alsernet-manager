...
class IncomingEmailSettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('mails-settings::theme.settings.email.incoming', compact('settings', 'pageTitle', 'breadcrumb'));
    }
    ...
    public function apiDocumentation()
    {
        ...
        return view('mails-settings::theme.settings.email.api-documentation', compact('pageTitle', 'breadcrumb'));
    }
