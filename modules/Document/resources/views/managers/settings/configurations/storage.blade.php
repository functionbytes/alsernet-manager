...
@section('content')
    ...
    @include('managers.components.card', ['title' => 'Configuración de Almacenamiento'])
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#test-connection-btn').on('click', function(e) {
                ...
                $.ajax({
                    url: '{{ route("manager.settings.documents.configurations.storage.test") }}',
                    method: 'POST',
                    dataType: 'json',
            ...
            function loadStorageStats(diskName) {
                ...
                $.ajax({
                    url: '{{ route("manager.settings.documents.configurations.storage.stats", ":disk") }}'.replace(':disk', diskName),
                    method: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        if (data.success) {
            ...
            function loadStorageHistory() {
                ...
                $.ajax({
                    url: '{{ route("manager.settings.documents.configurations.storage.history") }}',
                    method: 'GET',
                    dataType: 'json',
                    success: function(data) {
