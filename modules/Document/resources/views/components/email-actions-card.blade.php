...
@if($documentConfig['enable_missing_docs'] ?? true)
    @include('administratives.views.documents.modals.missing-docs')
@endif

@if($documentConfig['enable_initial_request'] ?? true)
    @include('administratives.views.documents.modals.initial-request')
@endif

@if($documentConfig['enable_reminder'] ?? true)
    @include('administratives.views.documents.modals.reminder')
@endif

@if($documentConfig['enable_upload_confirmation'] ?? true)
    @include('administratives.views.documents.modals.upload-confirmation')
@endif

@if($documentConfig['enable_approval'] ?? true)
    @include('administratives.views.documents.modals.approval')
@endif

@if($documentConfig['enable_rejection'] ?? true)
    @include('administratives.views.documents.modals.rejection')
@endif

@if($documentConfig['enable_custom_email'] ?? true)
    @include('administratives.views.documents.modals.custom-email')
@endif
