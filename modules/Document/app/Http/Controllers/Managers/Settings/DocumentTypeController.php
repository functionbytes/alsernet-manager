...
class DocumentTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('documents::theme.settings.types.index', [
    ...
    public function create()
    {
        ...
        return view('documents::theme.settings.types.create', compact('langs', 'validatorGroups', 'validationConditions'));
    }
    ...
    public function edit(string $documentType)
    {
        ...
        return view('documents::theme.settings.types.edit', [
            'documentType' => $type,
            'langs' => $langs,
