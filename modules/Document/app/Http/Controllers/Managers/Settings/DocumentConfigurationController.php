...
class DocumentConfigurationController extends Controller
{
    ...
    {
        return view('documents::theme.settings.index');
    }
    ...
    public function storageSettings()
    {
        ...
        return view('documents::theme.settings.configurations.storage', [
    ...
    public function globalSettings()
    {
        ...
        return view('documents::theme.settings.configurations.index', [
