...
class DocumentValidationConditionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('documents::theme.settings.conditions.index', [
    ...
    public function create()
    {
        ...
        return view('documents::theme.settings.conditions.create', [
    ...
    public function edit(string $condition)
    {
        ...
        return view('documents::theme.settings.conditions.edit', [
