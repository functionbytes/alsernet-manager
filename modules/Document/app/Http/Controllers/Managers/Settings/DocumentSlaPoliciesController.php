...
class DocumentSlaPoliciesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('documents::theme.settings.sla-policies.index', [
            'policies' => $policies,
            'stats' => $stats,
        ]);
    }
    ...
    {
        return view('documents::theme.settings.sla-policies.create');
    }
    ...
    {
        return view('documents::theme.settings.sla-policies.edit', compact('policy'));
    }
