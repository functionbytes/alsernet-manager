...
| Solo para acciones de datos. Las vistas GET están en settings.php
| Middleware, prefix y name base ya están definidos en RouteServiceProvider
|
*/

// Configurations API Routes
Route::middleware('can:view-document-settings')->prefix('configurations')->name('configurations.')->group(function () {
...
// Settings API Routes
Route::middleware('can:view-document-settings')->prefix('settings')->name('settings.')->group(function () {
