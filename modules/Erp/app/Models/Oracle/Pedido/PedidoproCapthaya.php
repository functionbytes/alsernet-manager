...
/**
 * Modelo para la tabla PEDIDOPRO_CAPTHAYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_PEDIDOPRO_CAPTHAYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDPEDIDOPRO
 *
 */
class PedidoproCapthaya extends Model
{
    protected $connection = 'oracle';
    protected $table = 'pedidopro_capthaya';
    ...
    /**
     * Relación: Pedidopro
     * ✅ Usa PK_PEDIDOPRO_CAPTHAYA (indexado)
     */
