...
/**
 * Modelo para la tabla LPEDIDOCLI_DDLEON
 *
 * ÍNDICES DISPONIBLES:
 * PK_LPEDIDOCLI_DDLEON (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDLPEDIDOCLI
 *
 */
class LpedidocliDdleon extends Model
{
    protected $connection = 'oracle';
    protected $table = 'lpedidocli_ddleon';
    ...
    /**
     * Relación: Lpedidocli
     * ✅ Usa PK_LPEDIDOCLI_DDLEON (indexado)
     */
