...
/**
 * Modelo para la tabla PEDIDOCLI_MONTE2
 *
 * ÍNDICES DISPONIBLES:
 * PK_PEDIDOCLI_MONTE2 (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDPEDIDOCLI
 *
 */
class PedidocliMonte2 extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'pedidocli_monte2';
    ...
    /**
     * Relación: Pedido
     * ✅ Usa PK_PEDIDOCLI_MONTE2 (indexado)
     */
