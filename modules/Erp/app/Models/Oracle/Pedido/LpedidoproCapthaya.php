...
/**
 * Modelo para la tabla LPEDIDOPRO_CAPTHAYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_LPEDIDOPRO_CAPTHAYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDLPEDIDOPRO
 *
 */
class LpedidoproCapthaya extends Model
{
    protected $connection = 'oracle';
    protected $table = 'lpedidopro_capthaya';
    ...
    /**
     * Relación: Lpedidopro
     * ✅ Usa PK_LPEDIDOPRO_CAPTHAYA (indexado)
     */
