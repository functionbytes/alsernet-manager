...
/**
 * Modelo para la tabla SERIEPEDIDOPRO_DDLEON
 *
 * ÍNDICES DISPONIBLES:
 * PK_SERIEPEDIDOPRO_DDLEON (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDSERIEPEDIDOPRO
 *
 */
class SeriepedidoproDdleon extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'seriepedidopro_ddleon';
     ...
     * ✅ Usa PK_SERIEPEDIDOPRO_DDLEON (indexado)
     */
