...
/**
 * Modelo para la tabla LPEDIDOCLI_MONTE2
 *
 * ÍNDICES DISPONIBLES:
 * PK_LPEDIDOCLI_MONTE2 (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDLPEDIDOCLI
 *
 */
class LpedidocliMonte2 extends Model
{
    protected $connection = 'oracle';
    protected $table = 'lpedidocli_monte2';
    ...
    /**
     * Relación: Lpedidocli
     * ✅ Usa PK_LPEDIDOCLI_MONTE2 (indexado)
     */
