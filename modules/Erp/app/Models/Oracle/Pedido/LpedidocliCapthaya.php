...
/**
 * Modelo para la tabla LPEDIDOCLI_CAPTHAYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_LPEDIDOCLI_CAPTHAYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDLPEDIDOCLI
 *
 */
class LpedidocliCapthaya extends Model
{
    protected $connection = 'oracle';
    protected $table = 'lpedidocli_capthaya';
    ...
    /**
     * Relación: Lpedidocli
     * ✅ Usa PK_LPEDIDOCLI_CAPTHAYA (indexado)
     */
