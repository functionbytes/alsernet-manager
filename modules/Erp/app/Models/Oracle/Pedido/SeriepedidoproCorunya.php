...
/**
 * Modelo para la tabla SERIEPEDIDOPRO_CORUNYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_SERIEPEDIDOPRO_CORUNYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDSERIEPEDIDOPRO
 *
 */
class SeriepedidoproCorunya extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'seriepedidopro_corunya';
     ...
     * ✅ Usa PK_SERIEPEDIDOPRO_CORUNYA (indexado)
     */
