...
/**
 * Modelo para la tabla PEDIDOPRO_DDLEON
 *
 * ÍNDICES DISPONIBLES:
 * PK_PEDIDOPRO_DDLEON (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDPEDIDOPRO
 *
 */
class PedidoproDdleon extends Model
{
    protected $connection = 'oracle';
    protected $table = 'pedidopro_ddleon';
    ...
    /**
     * Relación: Pedidopro
     * ✅ Usa PK_PEDIDOPRO_DDLEON (indexado)
     */
