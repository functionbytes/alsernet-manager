...
/**
 * Modelo para la tabla LPEDIDOPRO_CORUNYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_LPEDIDOPRO_CORUNYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDLPEDIDOPRO
 *
 */
class LpedidoproCorunya extends Model
{
    protected $connection = 'oracle';
    protected $table = 'lpedidopro_corunya';
    ...
    /**
     * Relación: Lpedidopro
     * ✅ Usa PK_LPEDIDOPRO_CORUNYA (indexado)
     */
