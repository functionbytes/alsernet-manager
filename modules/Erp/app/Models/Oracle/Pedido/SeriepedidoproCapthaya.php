...
/**
 * Modelo para la tabla SERIEPEDIDOPRO_CAPTHAYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_SERIEPEDIDOPRO_CAPTHAYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDSERIEPEDIDOPRO
 *
 */
class SeriepedidoproCapthaya extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'seriepedidopro_capthaya';
     ...
     * ✅ Usa PK_SERIEPEDIDOPRO_CAPTHAYA (indexado)
     */
