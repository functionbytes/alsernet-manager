...
/**
 * Modelo para la tabla SERIEPEDIDOPRO_MONTE2
 *
 * ÍNDICES DISPONIBLES:
 * PK_SERIEPEDIDOPRO_MONTE2 (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDSERIEPEDIDOPRO
 *
 */
class SeriepedidoproMonte2 extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'seriepedidopro_monte2';
     ...
     * ✅ Usa PK_SERIEPEDIDOPRO_MONTE2 (indexado)
     */
