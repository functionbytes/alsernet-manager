...
/**
 * Modelo para la tabla LALBARANCLI_DDLEON
 *
 * ÍNDICES DISPONIBLES:
 * PK_LALBARANCLI_DDLEON (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDLALBARANCLI
 *
 */
class LalbarancliDdleon extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'lalbarancli_ddleon';
     ...
     * ✅ Usa PK_LALBARANCLI_DDLEON (indexado)
     */
