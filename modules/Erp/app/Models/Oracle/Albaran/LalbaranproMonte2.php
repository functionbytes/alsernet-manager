...
/**
 * Modelo para la tabla LALBARANPRO_MONTE2
 *
 * ÍNDICES DISPONIBLES:
 * PK_LALBARANPRO_MONTE2 (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDLALBARANPRO
 *
 */
class LalbaranproMonte2 extends Model
{
    protected $connection = 'oracle';
    protected $table = 'lalbaranpro_monte2';
     ...
     * ✅ Usa PK_LALBARANPRO_MONTE2 (indexado)
     */
