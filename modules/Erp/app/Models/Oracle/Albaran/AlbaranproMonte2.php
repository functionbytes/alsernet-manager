...
/**
 * Modelo para la tabla ALBARANPRO_MONTE2
 *
 * ÍNDICES DISPONIBLES:
 * PK_ALBARANPRO_MONTE2 (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDALBARANPRO
 *
 */
class AlbaranproMonte2 extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'albaranpro_monte2';
    ...
    /**
     * Relación: Albaranpro
     * ✅ Usa PK_ALBARANPRO_MONTE2 (indexado)
     */
