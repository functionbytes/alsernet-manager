...
/**
 * Modelo para la tabla ALBARANPRO_CAPTHAYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_ALBARANPRO_CAPTHAYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDALBARANPRO
 *
 */
class AlbaranproCapthaya extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'albaranpro_capthaya';
    ...
    /**
     * Relación: Albaranpro
     * ✅ Usa PK_ALBARANPRO_CAPTHAYA (indexado)
     */
