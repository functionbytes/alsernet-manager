...
/**
 * Modelo para la tabla ALBARANPRO_CORUNYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_ALBARANPRO_CORUNYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDALBARANPRO
 *
 */
class AlbaranproCorunya extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'albaranpro_corunya';
    ...
    /**
     * Relación: Albaranpro
     * ✅ Usa PK_ALBARANPRO_CORUNYA (indexado)
     */
