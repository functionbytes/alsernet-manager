...
/**
 * Modelo para la tabla ALBARANCLI_DDLEON
 *
 * ÍNDICES DISPONIBLES:
 * ✅ INDX_ALBARANCLI_DDL_IDFACLI (NONUNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDFACTURACLI
 *
 * PK_ALBARANCLI_DDLEON (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDALBARANCLI
 *
 */
class AlbarancliDdleon extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'albarancli_ddleon';
    ...
    /**
     * Relación: Albarancli
     * ✅ Usa PK_ALBARANCLI_DDLEON (indexado)
     */
    ...
    /**
     * Relación: Facturacli
     * ✅ Usa INDX_ALBARANCLI_DDL_IDFACLI (indexado)
     */
