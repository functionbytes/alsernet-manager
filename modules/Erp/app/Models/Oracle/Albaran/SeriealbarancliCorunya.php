...
/**
 * Modelo para la tabla SERIEALBARANCLI_CORUNYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_SERIEALBARANCLI_CORUNYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDSERIEALBARANCLI
 *
 */
class SeriealbarancliCorunya extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'seriealbarancli_corunya';
     ...
     * ✅ Usa PK_SERIEALBARANCLI_CORUNYA (indexado)
     */
