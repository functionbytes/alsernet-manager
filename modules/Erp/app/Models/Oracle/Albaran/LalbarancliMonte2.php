...
/**
 * Modelo para la tabla LALBARANCLI_MONTE2
 *
 * ÍNDICES DISPONIBLES:
 * PK_LALBARANCLI_MONTE2 (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDLALBARANCLI
 *
 */
class LalbarancliMonte2 extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'lalbarancli_monte2';
     ...
     * ✅ Usa PK_LALBARANCLI_MONTE2 (indexado)
     */
