...
/**
 * Modelo para la tabla ALBARANCLI_MONTE2
 *
 * ÍNDICES DISPONIBLES:
 * ✅ INDX_ALBARANCLI_MON_IDFACLI (NONUNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDFACTURACLI
 *
 * PK_ALBARANCLI_MONTE2 (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDALBARANCLI
 *
 */
class AlbarancliMonte2 extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'albarancli_monte2';
    ...
    /**
     * Relación: Albarancli
     * ✅ Usa PK_ALBARANCLI_MONTE2 (indexado)
     */
    ...
    /**
     * Relación: Facturacli
     * ✅ Usa INDX_ALBARANCLI_MON_IDFACLI (indexado)
     */
