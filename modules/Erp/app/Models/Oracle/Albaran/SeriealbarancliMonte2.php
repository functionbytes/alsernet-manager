...
/**
 * Modelo para la tabla SERIEALBARANCLI_MONTE2
 *
 * ÍNDICES DISPONIBLES:
 * PK_SERIEALBARANCLI_MONTE2 (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDSERIEALBARANCLI
 *
 */
class SeriealbarancliMonte2 extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'seriealbarancli_monte2';
     ...
     * ✅ Usa PK_SERIEALBARANCLI_MONTE2 (indexado)
     */
