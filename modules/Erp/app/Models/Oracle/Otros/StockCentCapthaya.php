...
/**
 * Modelo para la tabla STOCK_CENT_CAPTHAYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_STOCK_CENT_CAPTHAYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDSTOCK
 *
 */
class StockCentCapthaya extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'stock_cent_capthaya';
    ...
    /**
     * Relación: Stock
     * ✅ Usa PK_STOCK_CENT_CAPTHAYA (indexado)
     */
