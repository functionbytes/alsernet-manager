...
/**
 * Modelo para la tabla TRASPASO_CAPTHAYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_TRASPASO_CAPTHAYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDTRASPASO
 *
 */
class TraspasoCapthaya extends Model
{
    protected $connection = 'oracle';
    protected $table = 'traspaso_capthaya';
    ...
    /**
     * Relación: Traspaso
     * ✅ Usa PK_TRASPASO_CAPTHAYA (indexado)
     */
