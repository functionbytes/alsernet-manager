...
/**
 * Modelo para la tabla LTRASPASO_DDLEON
 *
 * ÍNDICES DISPONIBLES:
 * PK_LTRASPASO_DDLEON (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDLTRASPASO
 *
 */
class LtraspasoDdleon extends Model
{
    protected $connection = 'oracle';
    protected $table = 'ltraspaso_ddleon';
    ...
    /**
     * Relación: Ltraspaso
     * ✅ Usa PK_LTRASPASO_DDLEON (indexado)
     */
