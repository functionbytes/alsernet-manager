...
/**
 * Modelo para la tabla STOCK_CENT_DDLEON
 *
 * ÍNDICES DISPONIBLES:
 * PK_STOCK_CENT_DDLEON (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDSTOCK
 *
 */
class StockCentDdleon extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'stock_cent_ddleon';
    ...
    /**
     * Relación: Stock
     * ✅ Usa PK_STOCK_CENT_DDLEON (indexado)
     */
