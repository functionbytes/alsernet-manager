...
/**
 * Modelo para la tabla STOCK_CENT_CORUNYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_STOCK_CENT_CORUNYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDSTOCK
 *
 */
class StockCentCorunya extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'stock_cent_corunya';
    ...
    /**
     * Relación: Stock
     * ✅ Usa PK_STOCK_CENT_CORUNYA (indexado)
     */
