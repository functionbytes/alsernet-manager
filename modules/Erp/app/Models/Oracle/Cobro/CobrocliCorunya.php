...
/**
 * Modelo para la tabla COBROCLI_CORUNYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_COBROCLI_CORUNYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDCOBROCLI
 *
 */
class CobrocliCorunya extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'cobrocli_corunya';
    ...
    /**
     * Relación: Cobrocli
     * ✅ Usa PK_COBROCLI_CORUNYA (indexado)
     */
