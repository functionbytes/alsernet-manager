...
/**
 * Modelo para la tabla FPPEDCLI_CAPTHAYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_FPPEDCLI_CAPTHAYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDFPPEDCLI
 *
 */
class FppedcliCapthaya extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'fppedcli_capthaya';
    ...
    /**
     * Relación: Fppedcli
     * ✅ Usa PK_FPPEDCLI_CAPTHAYA (indexado)
     */
