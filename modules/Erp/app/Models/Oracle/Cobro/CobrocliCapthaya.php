...
/**
 * Modelo para la tabla COBROCLI_CAPTHAYA
 *
 * ÍNDICES DISPONIBLES:
 * PK_COBROCLI_CAPTHAYA (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDCOBROCLI
 *
 */
class CobrocliCapthaya extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'cobrocli_capthaya';
    ...
    /**
     * Relación: Cobrocli
     * ✅ Usa PK_COBROCLI_CAPTHAYA (indexado)
     */
