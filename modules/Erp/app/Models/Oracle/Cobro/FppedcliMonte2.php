...
/**
 * Modelo para la tabla FPPEDCLI_MONTE2
 *
 * ÍNDICES DISPONIBLES:
 * PK_FPPEDCLI_MONTE2 (UNIQUE)
 *    - Tipo: NORMAL
 *    - Columnas: IDFPPEDCLI
 *
 */
class FppedcliMonte2 extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'fppedcli_monte2';
    ...
    /**
     * Relación: Fppedcli
     * ✅ Usa PK_FPPEDCLI_MONTE2 (indexado)
     */
