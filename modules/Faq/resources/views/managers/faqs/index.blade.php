...
@section('content')
  ...
  @include('managers.components.card', ['title' => 'Preguntas frecuentes'])
          ...
          <tbody>
              @foreach ($faqs as $key => $faq)
                <tr class="search-items">
                  ...
                  <td>
                      <span class="badge {{ $faq->available == 1 ? 'bg-light-secondary  text-primary' : 'bg-light-secondary  text-primary' }}  rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
