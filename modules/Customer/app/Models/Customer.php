...
class Customer extends Model
{
    ...
    public static function createFromErpData(array $data, array $orderClientData = []): self
    {
        ...
        return self::create([
            'erp_client_id' => $data['idcliente'] ?? $clientData['idcliente'],
            'fullname' => $data['nombre'].' '.$data['apellidos'] ?? $clientData['nombre'].' '.$clientData['apellidos'],
            'firstname' => $data['nombre'] ?? $clientData['nombre'],
            'lastname' => $data['apellidos'] ?? $clientData['apellidos'],
