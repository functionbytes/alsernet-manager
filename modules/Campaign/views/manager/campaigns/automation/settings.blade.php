...
<div class="mt-4 d-flex py-3">
    <div>
        ...
        <div class="mt-3">
            <a href="{{ route('Automation2Controller@delete', ['uids' => $automation->uid]) }}"
...
<script>
    ...
    var ListSegmentSelectBox = class {
        constructor() {
            this.url = '{{ route('Automation2Controller@segmentSelect', [
                'uid' => $automation->uid,
            ]) }}';
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        addMaskLoading(
                            ...
                            function() {
                                window.location = '{{ route('manager.automations') }}';
                            },
                            { wait: 2000 }
                        );
