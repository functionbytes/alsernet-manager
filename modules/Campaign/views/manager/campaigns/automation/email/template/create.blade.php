    ...
    <div class="row">
        <div class="col-md-10">
            ...
            <div class="row">
                <div class="col-md-10">
                    <ul class="hover-list">
                        <li class="template-start" data-url="{{ route('Automation2Controller@templateLayout', [
                                'uid' => $automation->uid,
                                'email_uid' => $email->uid,
                            ]) }}"
                        >
                        ...
                        <li class="template-start" data-url="{{ route('Automation2Controller@templateUpload', [
                                'uid' => $automation->uid,
                                'email_uid' => $email->uid,
                            ]) }}"
                        >
