...
<a href="javascript:;" onclick="popup.load('{{ route('Automation2Controller@operationEdit', [
    'uid' => $automation->uid,
    'operation' =>  $operation . '_contact',
    'id' => request()->id,
]) }}')" class="btn btn-secondary me-1">{{ trans('messages.automation.edit_operation') }}</a>

<a href="javascript:;" onclick="popup.load('{{ route('Automation2Controller@operationSelect', [
    'uid' => $automation->uid,
    'id' => request()->id,
