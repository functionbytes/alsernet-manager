...
class CampaignsController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.index', [
            'campaigns' => $campaigns,
        ]);
    }
    ...
    public function listing(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns._list', [
            'campaigns' => $campaigns,
        ]);
    }
    ...
    public function recipients(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.recipients', [
            'campaign' => $campaign,
            'rules' => $rules,
    ...
    public function setup(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.setup', [
            'campaign' => $campaign,
            'rules' => $campaign->rules(),
        ]);
    }
    ...
    public function template(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.template.index', [
            'campaign' => $campaign,
    ...
    public function templateCreate(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.template.create', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function templateLayout(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.template.layout', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function templateLayoutList(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.template.layoutList', [
            'campaign' => $campaign,
            'templates' => $templates,
        ]);
    }
    ...
    public function templateBuilderSelect(Request $request, $uid)
    {
        ...
        return view('theme.views.campaigns.campaigns.template.templateBuilderSelect', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function templateEdit(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.template.edit', [
            'campaign' => $campaign,
    ...
    public function templateContent(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.template.content', [
    ...
    public function templateUpload(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.template.upload', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function plain(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.plain', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function templateIframe(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.preview', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function schedule(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.schedule', [
            'campaign' => $campaign,
            'rules' => $rules,
        ...
        if ($request->isMethod('post') && $campaign->step() >= 5) {
            ...
            if (get_tmp_quota($customer, 'unsubscribe_url_required') == 'yes' && Setting::isYes('campaign.enforce_unsubscribe_url_check')) {
                if (strpos($campaign->getTemplateContent(), '{UNSUBSCRIBE_URL}') === false) {
                    ...
                    return view('theme.views.campaigns.campaigns.confirm', [
                        'campaign' => $campaign,
                        'score' => $score,
                    ]);
                }
    ...
    public function overview(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.overview', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function links(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.links', [
            'campaign' => $campaign,
            'links' => $links,
        ]);
    }
    ...
    public function quickView(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns._quick_view', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function trackingLog(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.tracking_log', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function trackingLogListing(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.tracking_logs_list', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function trackingLogDownload(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.download_tracking_log', [
            'campaign' => $campaign,
            'job' => $monitor,
        ]);
    }
    ...
    public function bounceLog(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.bounce_log', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function bounceLogListing(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.bounce_logs_list', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function feedbackLog(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.feedback_log', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function feedbackLogListing(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.feedback_logs_list', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function openLog(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.open_log', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function openLogListing(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.open_log_list', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function clickLog(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.click_log', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function clickLogListing(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.click_log_list', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function unsubscribeLog(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.unsubscribe_log', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function unsubscribeLogListing(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.unsubscribe_logs_list', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function openMap(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.open_map', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function deleteConfirm(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.delete_confirm', [
            'lists' => $lists,
        ]);
    }
    ...
    public function subscribers(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.subscribers', [
    ...
    public function subscribersListing(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns._subscribers_list', [
            'subscribers' => $subscribers,
            'list' => $campaign->defaultMailList,
            'campaign' => $campaign,
            'fields' => $fields,
    ...
    public function templateBuild(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.template_build', [
            'campaign' => $campaign,
            'elements' => $elements,
            'list' => $campaign->defaultMailList,
        ]);
    ...
    public function templateRebuild(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.template_rebuild', [
            'campaign' => $campaign,
            'list' => $campaign->defaultMailList,
        ]);
    }
    ...
    public function copy(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.copy', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function sendTestEmail(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.sendTestEmail', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function listSegmentForm(Request $request)
    {
        ...
        return view('theme.partials.campaigns.lists', [
            'campaign' => $campaign,
            'lists_segment_group' => [
                'list' => null,
                'is_default' => false,
    ...
    public function webView(Request $request)
    {
        ...
        try {
            ...
            return view('theme.views.campaigns.campaigns.web_view', [
                'campaign' => $campaign,
                'subscriber' => $subscriber,
                'message_id' => $message_id,
            ]);
    ...
    public function selectType(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.type', [
            'types' => $types,
        ]);
    }
    ...
    public function templateReview(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.template_review', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function templateReviewIframe(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.template_review_iframe', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function resend(Request $request, $uid)
    {
        ...
        return view('theme.views.campaigns.campaigns.resend', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function spamScore(Request $request, $uid)
    {
        ...
        return view('theme.views.campaigns.campaigns.spam_score', [
            'score' => $score,
        ]);
    }
    ...
    public function builderClassic(Request $request, $uid)
    {
        ...
        return view('theme.views.campaigns.campaigns.builderClassic', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function builderPlainEdit(Request $request, $uid)
    {
        ...
        return view('theme.views.campaigns.campaigns.builderPlainEdit', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function previewAs(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.previewAs', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function previewAsList(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.previewAsList', [
            'subscribers' => $subscribers,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function webhooks(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.webhooks', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function webhooksList(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.webhooksList', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function webhooksAdd(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.webhooksAdd', [
            'campaign' => $campaign,
            'webhook' => $webhook,
        ]);
    }
    ...
    public function webhooksLinkSelect(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.webhooksLinkSelect', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function webhooksEdit(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.webhooksEdit', [
            'webhook' => $webhook,
        ]);
    }
    ...
    public function webhooksSampleRequest(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.webhooksSampleRequest', [
            'webhook' => $webhook,
        ]);
    }
    ...
    public function webhooksTest(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.webhooksTest', [
            'webhook' => $webhook,
            'result' => $result,
        ]);
    }
    ...
    public function webhooksTestMessage(Request $request, $webhook_uid, $message_id)
    {
        ...
        return view('theme.views.campaigns.campaigns.webhooksTestMessage', [
            'webhook' => $webhook,
            'result' => $result,
        ]);
    }
    ...
    public function clickLogExecute(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.clickLogExecute', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function openLogExecute(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.openLogExecute', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function preheader(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.preheader', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function preheaderAdd(Request $request)
    {
        ...
        return view('theme.views.campaigns.campaigns.preheaderAdd', [
            'campaign' => $campaign,
        ]);
    }
