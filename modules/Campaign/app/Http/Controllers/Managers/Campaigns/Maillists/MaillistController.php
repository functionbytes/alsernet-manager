...
class MaillistController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('theme.views.maillists.maillists.index', [
            'maillists' => $maillists,
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('theme.views.maillists.maillists.create', [
            'list' => $list,
    ...
    public function edit(Request $request, $uid)
    {
        ...
        return view('theme.views.maillists.maillists.edit', [
            'list' => $list,
            'allowedSingleOptin' => $allowedSingleOptin,
        ]);
    }
    ...
    public function deleteConfirm(Request $request)
    {
        ...
        return view('theme.views.maillists.maillists.delete_confirm', [
            'lists' => $lists,
        ]);
    }
    ...
    public function overview(Request $request)
    {
        ...
        return view('theme.views.maillists.maillists.overview', [
            'list' => $list,
        ]);
    }
    ...
    public function quickView(Request $request)
    {
        ...
        return view('theme.views.maillists.maillists._quick_view', [
            'list' => $list,
        ]);
    }
    ...
    public function copy(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('theme.views.maillists.maillists.copy', [
                    'list' => $list,
        ...
        return view('theme.views.maillists.maillists.copy', [
            'list' => $list,
        ]);
    }
    ...
    public function embeddedForm(Request $request)
    {
        ...
        return view('theme.views.maillists.maillists.embedded_form', [
            'list' => $list,
        ]);
    }
    ...
    public function embeddedFormFrame(Request $request)
    {
        ...
        return view('theme.views.maillists.maillists.embedded_form_frame', [
            'list' => $list,
        ]);
    }
    ...
    public function embeddedFormCaptcha(Request $request)
    {
        ...
        return view('theme.views.maillists.maillists.embedded_form_captcha', [
            'list' => $list,
        ]);
    }
    ...
    public function embeddedFormSubscribe(Request $request)
    {
        ...
        if (! $success) {
            ...
            return view('theme.views.maillists.maillists.embedded_form_captcha_invalid', [
                'errors' => collect($errs),
                'list' => $list,
                'back_link' => $url,
            ]);
        ...
        try {
            // Create subscriber
            [$validator, $subscriber] = $list->subscribe($request, CampaignMaillist::SOURCE_EMBEDDED_FORM);
        } catch (\Exception $ex) {
        ...
        if ($validator->fails()) {
            ...
            return view('theme.views.maillists.maillists.embedded_form_errors', [
                'errors' => collect($errs),
                'list' => $list,
                'back_link' => $url,
            ]);
    ...
    public function verification(Request $request)
    {
        ...
        if ($currentJob) {
            return view('theme.views.maillists.maillists.email_verification', [
                'list' => $list,
    ...
    public function selectList(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('theme.views.maillists.maillists.selectList', [
                    'errors' => $validator->errors(),
                ], 400);
            }
        ...
        return view('theme.views.maillists.maillists.selectList');
    }
