...
class SegmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('theme.views.maillists.segments.index', [
            'list' => $list,
        ]);
    }
    ...
    public function listing(Request $request)
    {
        ...
        return view('theme.views.maillists.segments._list', [
            'segments' => $segments,
            'list' => $list,
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('theme.views.maillists.segments.create', [
            'list' => $list,
            'segment' => $segment,
        ]);
    }
    ...
    public function subscribers(Request $request)
    {
        ...
        return view('theme.views.maillists.segments.subscribers', [
    ...
    public function edit(Request $request)
    {
        ...
        return view('theme.views.maillists.segments.edit', [
            'list' => $list,
            'segment' => $segment,
        ]);
    }
    ...
    public function sample_condition(Request $request)
    {
        ...
        return view('theme.views.maillists.segments._sample_condition', [
            'list' => $list,
        ]);
    }
    ...
    public function selectBox(Request $request)
    {
        ...
        return view('theme.views.maillists.segments._select_box', [
    ...
    public function conditionValueControl(Request $request)
    {
        ...
        // legacy code
        return view('theme.views.maillists.segments._condition_value_control', [
    ...
    {
        return view('theme.views.maillists.segments.noList');
    }
}
