...
class SubscriberController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('theme.views.maillists.subscribers.index', [
            'list' => $list,
    ...
    public function listing(Request $request)
    {
        ...
        return view('theme.views.maillists.subscribers._list', [
            'subscribers' => $subscribers,
            'total' => $total,
            'list' => $list,
            'fields' => $fields,
    ...
    public function create(Request $request)
    {
        ...
        return view('theme.views.maillists.subscribers.create', [
            'list' => $list,
    ...
    public function edit(Request $request)
    {
        ...
        return view('theme.views.maillists.subscribers.edit', [
            'list' => $list,
            'subscriber' => $subscriber,
            'values' => $values,
        ]);
    ...
    public function import(Request $request)
    {
        ...
        if ($currentJob) {
            return view('theme.views.maillists.subscribers.import', [
                'list' => $list,
    ...
    public function lists(Request $request)
    {
        ...
        if ($currentJob) {
            return view('theme.views.maillists.subscribers.importlists', [
                'list' => $list,
    ...
    public function export(Request $request)
    {
        ...
        if ($currentJob) {
            return view('theme.views.maillists.subscribers.export', [
                'list' => $list,
                'currentJobUid' => $currentJob->uid,
    ...
    public function copyMoveForm(Request $request)
    {
        ...
        return view('theme.views.maillists.subscribers.copy_move_form', [
            'subscribers' => $subscribers,
            'from_list' => $from_list,
        ]);
    }
    ...
    public function startVerification(Request $request)
    {
        ...
        try {
            ...
            return view('theme.views.maillists.somethingWentWrong', ['message' => sprintf('Something went wrong while verifying %s (%s). Error message: %s', $subscriber->email, $subscriber->id, $e->getMessage())]);
        }
    }
    ...
    public function resetVerification(Request $request)
    {
        ...
        try {
            ...
            return view('theme.views.maillists.somethingWentWrong', ['message' => sprintf('Something went wrong while cleaning up verification data for %s (%s). Error message: %s', $subscriber->email, $subscriber->id, $e->getMessage())]);
        }
    }
    ...
    public function updateTags(Request $request, $list_uid, $uid)
    {
        ...
        return view('theme.views.maillists.subscribers.updateTags', [
            'list' => $list,
            'subscriber' => $subscriber,
        ]);
    }
    ...
    public function bulkDelete(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('theme.views.maillists.subscribers.bulkDelete', [
                    'list' => $list,
            ...
            //
            return view('theme.views.maillists.subscribers.bulkDeleteConfirm', [
                'list' => $list,
                'emails' => $emails,
                'subscribers' => $subscribers,
            ]);
        ...
        return view('theme.views.maillists.subscribers.bulkDelete', [
            'list' => $list,
        ]);
    }
    ...
    public function import2Wizard(Request $request)
    {
        ...
        return view('theme.views.maillists.subscribers.import2.upload', [
            'list' => $list,
        ]);
    }
    ...
    public function import2(Request $request)
    {
        ...
        return view('theme.views.maillists.subscribers.import2', [
            'list' => $list,
    ...
    public function import2Mapping(Request $request)
    {
        ...
        try {
            [$headers, $total, $results] = $list->readCsv($filepath);
        } catch (\Throwable $e) {
            return response()->json([
        ...
        return view('theme.views.maillists.subscribers.import2.mapping', [
            'list' => $list,
            'headers' => $headers,
            'filepath' => $filepath,
        ]);
    ...
    public function import2Progress(Request $request)
    {
        ...
        return view('theme.views.maillists.subscribers.import2.progress', [
            'list' => $list,
    ...
    public function import2ProgressContent(Request $request)
    {
        ...
        return view('theme.views.maillists.subscribers.import2.progressContent', [
            'list' => $list,
            'currentJob' => $currentJob,
            'progress' => $progress,
        ]);
    ...
    public function assignValues(Request $request, $list_uid)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('theme.views.maillists.subscribers.assignValues', [
                    'list' => $list,
                    'subscribers' => $subscribers,
                    'errors' => $validator->errors(),
                ], 400);
        ...
        return view('theme.views.maillists.subscribers.assignValues', [
            'list' => $list,
            'subscribers' => $subscribers,
        ]);
    }
    ...
    {
        return view('theme.views.maillists.subscribers.noList');
    }
}
