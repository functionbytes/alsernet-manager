...
class LocationsController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('theme.views.plans.index')->with([
            'plans' => $plans,
            'available' => $available,
            'website' => $website,
            'searchKey' => $searchKey,
    ...
    public function navegation($uid)
    {
        ...
        return view('theme.views.plans.navegation')->with([
            'plan' => $plan,
        ]);
    ...
    public function create()
    {
        ...
        return view('theme.views.plans.create')->with([
    ...
    public function edit($uid)
    {
        ...
        return view('theme.views.plans.edit')->with([
            'plan' => $plan,
            'availables' => $availables,
        ]);
