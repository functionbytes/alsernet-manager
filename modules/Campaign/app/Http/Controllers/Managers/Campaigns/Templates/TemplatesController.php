...
class TemplatesController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('theme.views.templates.templates.index')->with([
            'templates' => $templates,
        ]);
    ...
    public function uploadTemplate(Request $request)
    {
        ...
        return view('theme.views.templates.templates.upload');
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('theme.views.templates.templates.create', [
            'template' => $template,
        ]);
    }
    ...
    public function edit(Request $request, $uid)
    {
        ...
        return view('theme.views.templates.templates.edit', [
            'template' => $template,
        ]);
    }
    ...
    public function preview(Request $request, $id)
    {
        ...
        return view('theme.views.templates.templates.preview', [
            'template' => $template,
        ]);
    }
    ...
    public function categories(Request $request, $uid)
    {
        ...
        return view('theme.views.templates.templates.categories', [
            'template' => $template,
        ]);
    }
    ...
    public function changeName(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($validator->fails()) {
                return response()->view('theme.views.templates.templates.change', [
                    'template' => $template,
        ...
        return view('theme.views.templates.templates.change', [
            'template' => $template,
        ]);
    }
    ...
    public function copy(Request $request)
    {
        ...
        return view('theme.views.templates.templates.copy', [
            'template' => $template,
        ]);
    }
    ...
    {
        return view('theme.views.templates.templates.chat');
    }
    ...
    public function updateThumbUrl(Request $request, $uid)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($validator->fails()) {
                return response()->view('theme.views.templates.templates.thumburl', [
                    'template' => $template,
                    'errors' => $validator->errors(),
                ], 400);
            }
        ...
        return view('theme.views.templates.templates.thumburl', [
            'template' => $template,
        ]);
    }
    ...
    public function updateThumb(Request $request, $uid)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($validator->fails()) {
                return response()->view('theme.views.templates.templates.thumb', [
                    'template' => $template,
                    'errors' => $validator->errors(),
                ], 400);
            }
        ...
        return view('theme.views.templates.templates.thumb', [
            'template' => $template,
        ]);
    }
    ...
    public function builderEditContent(Request $request, $uid)
    {
        ...
        return view('theme.views.templates.builder.content', [
    ...
    public function builderEdit(Request $request, $uid)
    {
        ...
        return view('theme.views.templates.builder.edit', [
            'template' => $template,
    ...
    public function builderTemplates(Request $request)
    {
        ...
        return view('theme.views.templates.templates.builder.templates', [
            'templates' => $templates,
        ]);
    }
    ...
    public function builderCreate(Request $request)
    {
        ...
        return view('theme.views.templates.builder.create', [
            'template' => $template,
            'templates' => $templates,
