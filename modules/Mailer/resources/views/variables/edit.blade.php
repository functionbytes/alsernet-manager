...
@section('content')
    ...
    @include('theme.components.card', ['title' => 'Editar Variable de Email'])

    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('settings.mailers.variables.update', $variable) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="card-footer border-top">
                            ...
                            <a href="{{ route('settings.mailers.variables.index') }}" class="btn btn-light w-100">
                                Cancelar
                            </a>
                    </div>
                </form>
