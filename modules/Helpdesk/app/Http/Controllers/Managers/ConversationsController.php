...
class ConversationsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('theme.views.helpdesk.conversations.index', [
    ...
    public function create(Request $request)
    {
        ...
        return view('theme.views.helpdesk.conversations.create', [
            'customer' => $customer,
            'statuses' => $statuses,
        ]);
    }
    ...
    public function show(Conversation $conversation, Request $request)
    {
        ...
        return view('theme.views.helpdesk.conversations.show', [
    ...
    public function edit(Conversation $conversation)
    {
        ...
        return view('theme.views.helpdesk.conversations.edit', [
            'conversation' => $conversation,
            'statuses' => $statuses,
        ]);
    }
