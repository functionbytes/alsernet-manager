...
class TagsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('theme.views.backups.helpdesk.tags.index', [
            'tags' => $tags,
            'stats' => $stats,
        ]);
    }
    ...
    {
        return view('theme.views.backups.helpdesk.tags.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manager.helpdesk.backups.tickets.tags.index')
    ...
    {
        return view('theme.views.backups.helpdesk.tags.edit', compact('tag'));
    }
