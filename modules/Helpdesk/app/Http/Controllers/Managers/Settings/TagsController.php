...
class TagsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('theme.views.settings.helpdesk.tags.index', [
            'tags' => $tags,
            'stats' => $stats,
        ]);
    }
    ...
    {
        return view('theme.views.settings.helpdesk.tags.create');
    }
    ...
    {
        return view('theme.views.settings.helpdesk.tags.edit', compact('tag'));
    }
