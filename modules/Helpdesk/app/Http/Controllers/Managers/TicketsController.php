...
class TicketsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('theme.views.helpdesk.tickets.index', [
            'tickets' => $tickets,
            'statuses' => $statuses,
    ...
    public function create(Request $request)
    {
        ...
        return view('theme.views.helpdesk.tickets.create', [
            'customer' => $customer,
            'customers' => $customers,
            'categories' => $categories,
            'statuses' => $statuses,
    ...
    public function show(Request $request, Ticket $ticket)
    {
        ...
        return view('theme.views.helpdesk.tickets.show', [
            'ticket' => $ticket,
            'tickets' => $tickets,
            'statuses' => $statuses,
            'categories' => $categories,
    ...
    public function edit(Ticket $ticket)
    {
        ...
        return view('theme.views.helpdesk.tickets.edit', [
            'ticket' => $ticket,
            'categories' => $categories,
            'statuses' => $statuses,
