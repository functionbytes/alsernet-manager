...
class CustomersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('theme.views.helpdesk.customers.index', [
            'customers' => $customers,
            'stats' => $stats,
            'tabs' => [
                'all' => $stats['total'],
    ...
    public function create()
    {
        ...
        return view('theme.views.helpdesk.customers.create');
    }
    ...
    public function show(Customer $customer)
    {
        ...
        return view('theme.views.helpdesk.customers.show', [
            'customer' => $customer,
        ]);
    }
    ...
    public function edit(Customer $customer)
    {
        ...
        return view('theme.views.helpdesk.customers.edit', [
            'customer' => $customer,
        ]);
    }
