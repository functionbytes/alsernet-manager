...
class AiAgentFlowsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('theme.views.helpdesk.ai-agent.flows.index', [
            'flows' => $flows,
            'agent' => $agent,
            'triggers' => $triggers,
            'statuses' => $statuses,
    ...
    public function create()
    {
        ...
        return view('theme.views.helpdesk.ai-agent.flows.create', [
            'agent' => $agent,
            'triggers' => $triggers,
        ]);
    }
    ...
    public function edit(AiAgentFlow $flow)
    {
        ...
        return view('theme.views.helpdesk.ai-agent.flows.edit', [
            'flow' => $flow,
            'agent' => $flow->agent,
            'nodeTypes' => $nodeTypes,
        ]);
