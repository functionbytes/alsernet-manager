...
class CampaignsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('theme.views.helpdesk.campaigns.index', [
            'campaigns' => $campaigns,
    ...
    public function create()
    {
        ...
        return view('theme.views.helpdesk.campaigns.create', [
            'templates' => $templates,
        ]);
    }
    ...
    public function show(Campaign $campaign)
    {
        ...
        return view('theme.views.helpdesk.campaigns.show', [
            'campaign' => $campaign,
            'stats' => $stats,
        ]);
    }
    ...
    public function edit(Campaign $campaign)
    {
        ...
        return view('theme.views.helpdesk.campaigns.edit', [
            'campaign' => $campaign,
            'templates' => $templates,
        ]);
    }
    ...
    public function templates()
    {
        ...
        return view('theme.views.helpdesk.campaigns.templates', [
            'templates' => $templates,
        ]);
    }
}
