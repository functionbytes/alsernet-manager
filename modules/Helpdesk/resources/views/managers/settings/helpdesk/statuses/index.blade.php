...
@section('title', 'Estados de Conversación')
            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="small mb-0 text-muted">Define y organiza los estados del flujo de conversaciones</p>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between">
                                    <div>
                                        ...
                                        <small class="text-muted">Estados habilitados</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between">
                                    <div>
                                        ...
                                        <small class="text-muted">Estados deshabilitados</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            @foreach($statuses as $status)
                                <tr data-id="{{ $status->id }}" class="sortable-row">
                                    ...
                                    <td class="text-center">
                                        <form method="POST" action="{{ route('manager.helpdesk.backups.tickets.statuses.toggle', $status->id) }}" class="toggle-form">
                                            @csrf
                                            @method('PATCH')
                    ...
                    <div class="text-center py-5">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <p class="text-muted mb-3">
                                ...
                                @else
                                    Crea tu primer estado para organizar el flujo de conversaciones
                                @endif
                            </p>
                            @if(!request('search'))
