...
@section('content')
    ...
    <div class="card w-100">
        ...
        <form id="formStatus" method="POST" action="{{ route('manager.helpdesk.backups.tickets.statuses.update', $status->id) }}">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="border-bottom pb-3 mb-3">
                            <div class="form-check form-switch">
                                ...
                                <input type="checkbox" name="active" class="form-check-input" id="activeCheck" value="1" {{ old('active', $status->active) ? 'checked' : '' }}>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="border-bottom pb-3 mb-3">
                            <div class="form-check form-switch">
                                ...
                                <input type="checkbox" name="is_default" class="form-check-input" id="defaultCheck" value="1" {{ old('is_default', $status->is_default) ? 'checked' : '' }} {{ $status->is_system ? 'disabled' : '' }}>
