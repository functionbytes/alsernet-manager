...
@section('content')
    ...
    <div class="card w-100">
        ...
        <form id="formTag" method="POST" action="{{ route('manager.helpdesk.backups.tickets.tags.store') }}">

            {{ csrf_field() }}

            <div class="card-body">
                <div class="d-flex no-block align-items-center">
                    <h5 class="mb-0">Crear nuevo tag</h5>
                </div>
                <p class="card-subtitle mb-3 mt-1">
                    Define un nuevo tag para organizar y categorizar las conversaciones. Los tags te ayudan a clasificar y filtrar conversaciones según temas o características específicas.
                </p>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <p class="text-muted small mb-3">Define el nombre y las características básicas del tag. El nombre será visible para los usuarios.</p>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name') }}" required placeholder="Ej: Urgente">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="slug" class="form-control" value="{{ old('slug') }}" placeholder="Se generará automáticamente">
                            <small class="form-text text-muted">Opcional: Solo letras minúsculas, números y guiones. Si se deja vacío, se genera automáticamente.</small>
                            @error('slug')
                                <span class="field-validation-error"><i class="fa fa-circle-exclamation"></i> {{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" rows="2" placeholder="Descripción opcional del tag">{{ old('description') }}</textarea>
                    ...
                    <div class="col-12">
                        ...
                        <p class="text-muted small mb-3">El color ayuda a identificar visualmente el tag en la interfaz. Selecciona un color distintivo para facilitar su reconocimiento.</p>
                    </div>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('manager.helpdesk.backups.tickets.tags.index') }}" class="btn btn-secondary px-4 waves-effect waves-light mt-2 w-100">
                    Cancelar
                </a>
            </div>
