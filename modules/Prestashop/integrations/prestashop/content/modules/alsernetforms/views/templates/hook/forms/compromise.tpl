                      ...
                      <form class="form"  method="post" id="alsernet-compromise" enctype="multipart/form-data" autocomplete="false" onsubmit="return false" novalidate="novalidate">
                        <input type="hidden" name="_alsernetforms_language" value="{$language.iso_code}">
                        <input type="hidden" name="_alsernetforms_action" value="compromise">
                        ...
                        <p class="card-text">{l s='Description  alert fitting' mod='alsernetforms'}</p>ç
                        <div class="mb-3">
                        ...
                        {l s='Alert compromise' mod='alsernetforms'}
                        </button>
                      </form>
