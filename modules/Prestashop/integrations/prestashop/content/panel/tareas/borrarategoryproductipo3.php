        ...
        if ($idprodps != '') {
            ...
            foreach ($catimport as $catim) {
                ...
                if ($existe != '') {
                    ...
                    addsql('REPLACE INTO aalv_category_product(id_category, id_product, position) VALUES ('.$idcatps.','.$idprodps.',0);');
                        ...
                        if ($principal) {
                            ...
                            if (escomunrec($idcatps)) {
                                ...
                                if ($cat->sport == 5) {
                                    ...
                                    addsql('UPDATE aalv_product SET id_category_default='.$idcatps.' WHERE id_product='.$idprodps.';');
                                    addsql('UPDATE aalv_product_shop SET id_category_default='.$idcatps.' WHERE id_product='.$idprodps.';');
...
foreach ($rows as $row) {
    ...
    ProcesarPerfilesNav($row['data'], $row['fila'], $row['tipo']);
}
echo 'acaba';
