...
$contentitem = peticionget('http://127.0.0.1:59000/integracion/TransaccionPendiente/?destino=2&transaccion=5.26.1084540&limit=5000');
...
foreach ($objitem['results'] as $valoresitem) {
    ...
    if ($valoresitem['fila'] == 102598226) {
        ProcesarTarifaCabecera($valoresitem['data'], $valoresitem['fila'], $valoresitem['tipo']);
    }
