...
function addlog($message)
{
    ...
    $stdout = fopen(dirname(__FILE__).'/imageattrasign.txt', 'a');
...
$rows = getdatarows($dbh, 'SELECT id_producto, orden, path_imagen FROM producto_imagen where estado=1 order by 1,2');
foreach ($rows as $row) {
