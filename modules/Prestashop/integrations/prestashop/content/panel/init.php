...
try {
    ...
    if (file_exists(_PS_langs_DIR_.$iso.'/errors.php')) {
        include _PS_langs_DIR_.$iso.'/errors.php';
    }
    if (file_exists(_PS_langs_DIR_.$iso.'/fields.php')) {
        include _PS_langs_DIR_.$iso.'/fields.php';
    }
    if (file_exists(_PS_langs_DIR_.$iso.'/admin.php')) {
        include _PS_langs_DIR_.$iso.'/admin.php';
    }
