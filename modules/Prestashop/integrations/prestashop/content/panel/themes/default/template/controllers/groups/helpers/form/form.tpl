	...
	<div {if !$form_id}class="hide"{/if}>
		...
		<div id="group_discount_category_fancybox" class="bootstrap" style="display:none" >
			<div class="panel">
				...
				<div class="alert alert-warning">{l s='Only inventaries that have this category as the default category will be affected.' d='Admin.Shopparameters.Notification'}</div>
