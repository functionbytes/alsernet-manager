						...
						<div id="anchor{$module->name|ucfirst}" title="{$module->displayName|escape:'html':'UTF-8'}">
							...
							<div class="module_name">
								...
								{elseif isset($module->type) && $module->type == 'addonsPartner'}
									- <span class="module-badge-partner help-tooltip text-warning" data-title="{l s="Official, PrestaShop certified module. Free, secure and components updates!"}"><i class="icon-pushpin"></i> <small>{l s="Official"}</small></span>
