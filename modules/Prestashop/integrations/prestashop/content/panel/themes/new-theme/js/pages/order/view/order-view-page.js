  ...
  refreshProductsList(orderId) {
    ...
    $.ajax(this.router.generate('admin_orders_get_products', {orderId}))
      .done((response) => {
        ...
        if (initialNumProducts > newNumProducts) { // product deleted
          message = (initialNumProducts - newNumProducts === 1)
            ...
            : window.translate_javascripts['[1] inventaries were successfully removed.']
          ...
          message = (newNumProducts - initialNumProducts === 1)
            ...
            : window.translate_javascripts['[1] inventaries were successfully added.']
      ...
      .fail(() => {
        $.growl.error({
          title: '',
          message: 'Failed to reload the inventaries list. Please reload the page',
        });
      });
  }
}
