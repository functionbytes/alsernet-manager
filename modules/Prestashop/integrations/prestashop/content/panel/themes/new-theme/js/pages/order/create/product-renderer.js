...
export default class ProductRenderer {
  ...
  /**
   * Renders cart inventaries search results block
   *
   * @param foundProducts
   */
  ...
  /**
   * Renders found inventaries select
   *
   * @param foundProducts
   *
   * @private
