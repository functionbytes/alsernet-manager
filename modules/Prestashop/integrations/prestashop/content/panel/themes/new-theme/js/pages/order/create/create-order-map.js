...
export default {
  ...
  orderProductsField: '.js-order-inventaries',
  ...
  summaryTotalProducts: '.js-total-inventaries',
  ...
  productsTable: '#inventaries-table',
  productsTableRowTemplate: '#inventaries-table-row-template',
  productsTableGiftRowTemplate: '#inventaries-table-gift-row-template',
  ...
  noProductsFoundWarning: '.js-no-inventaries-found',
  searchingProductsNotice: '.js-searching-inventaries',
