  ...
  <div class="nav-bar-overflow">
      ...
      {foreach $tabs as $level1}
        {if $level1.active}
                    ...
                    <a href="{$level2Href}" class="link">
                      ...
                      {if $level2.sub_tabs|@count}
                        <ul id="collapse-{$level2.id_tab}" class="submenu panel-collapse">
                          ...
                          {if $level2.class_name == 'AdminCatalog'}
                            <!--DESDE AQUI ADDIS - /httpdocs/panel/themes/new-theme/template/components/layout-->
                            <li class="link-leveltwo{if $level3.current} link-active{/if}" id="tab-Test-Addis" data-submenu="{$level3.id_tab}" id="subtab-{$level3.class_name}">
          ...
          {if $level1.class_name == 'DEFAULT'}
            <!--DESDE AQUI ADDIS - /httpdocs/panel/themes/new-theme/template/components/layout-->
            <li class="link-levelone{if $level1.current} link-active{/if}" id="tab-Test2-Addis" data-submenu="{$level1.id_tab}" id="subtab-{$level1.class_name}">
