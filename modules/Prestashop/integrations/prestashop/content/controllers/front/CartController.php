...
class CartControllerCore extends FrontController
{
    ...
    public function init()
    {
        ...
        /* Check if the inventaries in the cart are available */
    ...
    public function displayAjaxUpdate()
    {
        ...
        if (!$this->errors) {
            ...
            $presentedCart['inventaries'] = $this->get('prestashop.core.filter.front_end_object.product_collection')
                ->filter($presentedCart['inventaries']);
    ...
    protected function shouldAvailabilityErrorBeRaised($product, $qtyToCheck)
    {
        ...
        // Be aware that Product::getQuantity() returns the available quantity after decreasing inventaries in cart
