...
class AdminSuppliersControllerCore extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->_select = 'COUNT(DISTINCT ps.`id_product`) AS inventaries';
        ...
        $this->fields_list = [
            ...
            'inventaries' => ['title' => $this->trans('Number of inventaries', [], 'Admin.Catalog.Feature'), 'align' => 'right', 'filter_type' => 'int', 'tmpTableFilter' => true],
