...
class AdminImagesControllerCore extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->fields_list = [
            ...
            'inventaries' => ['title' => $this->trans('Products', [], 'Admin.Global'), 'align' => 'center', 'type' => 'bool', 'callback' => 'printEntityActiveIcon', 'orderby' => false],
    ...
    public function initRegenerate()
    {
        $types = [
            ...
            'inventaries' => $this->trans('Products', [], 'Admin.Global'),
    ...
    protected function _regenerateThumbnails($type = 'all', $deleteOldImages = false)
    {
        ...
        $process = [
            ...
            ['type' => 'inventaries', 'dir' => _PS_PROD_IMG_DIR_],
        ...
        foreach ($process as $proc) {
            ...
            if ($deleteOldImages) {
                $this->_deleteOldImages($proc['dir'], $formats, ($proc['type'] == 'inventaries' ? true : false));
            }
            if (($return = $this->_regenerateNewImages($proc['dir'], $formats, ($proc['type'] == 'inventaries' ? true : false))) === true) {
