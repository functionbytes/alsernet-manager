...
{block name='page_title'}
  <h1 class="h1">{l s='Return details' d='Shop.Customer.Orders'}</h1>
{/block}
...
{block name='page_content'}
    ...
    <div id="order-return-infos" class="card">
      <div class="card-block">
        <p>
          <strong>{l
            s='%number% on %date%'
            d='Shop.Customer.Orders'
            sprintf=['%number%' => $return.return_number, '%date%' => $return.return_date]}
          </strong>
        </p>
        <p>{l s='We have logged your return request.' d='Shop.Customer.Orders'}</p>
        <p>{l
        ...
        <p>{l s='List of items to be returned:' d='Shop.Customer.Orders'}</p>
  ...
  {if $return.state == 2}
    <section class="card">
      <div class="card-block">
        <h3 class="card-title h3">{l s='Reminder' d='Shop.Customer.Orders'}</h3>
        <p class="card-text">
          {l
