...
<h1 class="titleblog">{l s='Blog Álvarez' mod='ybc_blog'}.<span>{l s='Escoge tu deporte' mod='ybc_blog'}</span></h1>

<div class="row box-cateh2 banner-home ApRow  " style="">
    <!-- @file modules\appagebuilder\views\templates\hook\ApColumn -->
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-sp-12  ApColumn ">
        <!-- @file modules\appagebuilder\views\templates\hook\ApImage -->
        <div id="image-form_2977409492" class="block ApImage">
            <a href="/blog/golf">
                <h4 class="title_block">GOLF</h4>
                <img src="/themes/alvarez/assets/img/modules/appagebuilder/images/Golf.jpg" class="" title="GOLF" alt=""
    ...
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-sp-12  ApColumn ">
        <!-- @file modules\appagebuilder\views\templates\hook\ApImage -->
        <div id="image-form_2847260549" class="block ApImage">
            <a href="/blog/caza">
                <h4 class="title_block">CAZA</h4>
                <img src="/themes/alvarez/assets/img/modules/appagebuilder/images/Caza.jpg" class="" title="CAZA"
    ...
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-sp-12  ApColumn ">
        <!-- @file modules\appagebuilder\views\templates\hook\ApImage -->
        <div id="image-form_2468585980" class="block ApImage">
            <a href="/blog/pesca">
                <h4 class="title_block">PESCA</h4>
                <img src="/themes/alvarez/assets/img/modules/appagebuilder/images/Pesca.jpg" class=""
                     title="PESCA" alt="" style=" width:100%; height:auto" loading="lazy">
            </a>
        </div>
    </div><!-- @file modules\appagebuilder\views\templates\hook\ApColumn -->
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-sp-12  ApColumn ">
        <!-- @file modules\appagebuilder\views\templates\hook\ApImage -->
        <div id="image-form_2719556331" class="block ApImage">
            <a href="/blog/hipica">
                <h4 class="title_block">HÍPICA</h4>
                <img src="/themes/alvarez/assets/img/modules/appagebuilder/images/Hipica.jpg" class=""
                     title="HÍPICA" alt="" style=" width:100%; height:auto" loading="lazy">
            </a>
        </div>
    </div><!-- @file modules\appagebuilder\views\templates\hook\ApColumn -->
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-sp-12  ApColumn ">
        <!-- @file modules\appagebuilder\views\templates\hook\ApImage -->
        <div id="image-form_3653999543" class="block ApImage">
            <a href="/blog/buceo">
                <h4 class="title_block">BUCEO</h4>
                <img src="/themes/alvarez/assets/img/modules/appagebuilder/images/Buceo.jpg" class=""
                     title="BUCEO" alt="" style=" width:100%; height:auto" loading="lazy">
            </a>
        </div>
    </div><!-- @file modules\appagebuilder\views\templates\hook\ApColumn -->
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-sp-12  ApColumn ">
        <!-- @file modules\appagebuilder\views\templates\hook\ApImage -->
        <div id="image-form_3703105433" class="block ApImage">
            <a href="/blog/nautica">
                <h4 class="title_block">NÁUTICA</h4>
                <img src="/themes/alvarez/assets/img/modules/appagebuilder/images/Nautica.jpg" class=""
                     title="NÁUTICA" alt="" style=" width:100%; height:auto" loading="lazy">
            </a>
        </div>
    </div><!-- @file modules\appagebuilder\views\templates\hook\ApColumn -->
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-sp-12  ApColumn ">
        <!-- @file modules\appagebuilder\views\templates\hook\ApImage -->
        <div id="image-form_3324267886" class="block ApImage">
            <a href="/blog/esqui">
                <h4 class="title_block">ESQUÍ</h4>
                <img src="/themes/alvarez/assets/img/modules/appagebuilder/images/Esqui.jpg" class=""
                     title="ESQUÍ" alt="" style=" width:100%; height:auto" loading="lazy">
            </a>
        </div>
    </div><!-- @file modules\appagebuilder\views\templates\hook\ApColumn -->
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-sp-12  ApColumn ">
        <!-- @file modules\appagebuilder\views\templates\hook\ApImage -->
        <div id="image-form_3599786446" class="block ApImage">
            <a href="/blog/padel">
                <h4 class="title_block">PÁDEL</h4>
                <img src="/themes/alvarez/assets/img/modules/appagebuilder/images/Padel.jpg" class=""
                     title="PÁDEL" alt="" style=" width:100%; height:auto" loading="lazy">
            </a>
        </div>
    </div><!-- @file modules\appagebuilder\views\templates\hook\ApColumn -->
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-sp-12  ApColumn ">
        <!-- @file modules\appagebuilder\views\templates\hook\ApImage -->
        <div id="image-form_2797282600" class="block ApImage">
            <a href="/blog/aventura">
                <h4 class="title_block">AVENTURA</h4>
                <img src="/themes/alvarez/assets/img/modules/appagebuilder/images/Aventura.jpg" class=""
                     title="AVENTURA" alt="" style=" width:100%; height:auto" loading="lazy">
            </a>
        </div>
    </div><!-- @file modules\appagebuilder\views\templates\hook\ApColumn -->
    {else}
    ...
    <div class="row">
        ...
        <div id="content-wrapper"
             class="{if isset($blog_config.YBC_BLOG_SIDEBAR_POSITION) && $blog_config.YBC_BLOG_SIDEBAR_POSITION=='left'}left-column col-xs-12 col-sm-12 col-md-9{elseif isset($blog_config.YBC_BLOG_SIDEBAR_POSITION) && $blog_config.YBC_BLOG_SIDEBAR_POSITION=='right'}right-column col-xs-12 col-sm-8 col-md-9{/if}">
            <div class="ybc_blog_layout_{$blog_layout|escape:'html':'UTF-8'} ybc-blog-wrapper ybc-blog-wrapper-blog-list{if isset($blog_config.YBC_BLOG_AUTO_LOAD) &&$blog_config.YBC_BLOG_AUTO_LOAD} loadmore{/if} {if $blog_latest}ybc-page-latest{elseif $blog_category}ybc-page-category{elseif $blog_tag}ybc-page-tag{elseif $blog_search}ybc-page-search{elseif $author}ybc-page-author{else}ybc-page-home{/if}">
                ...
                {/if}
                {if $blog_category || $categoria_404}
                    ...
                    {else}
                        <div id="pagenotfound">
                            <div class="page-not-found">
                                ...
                                <a class="btn" href="{$blog_url}">{l s='Back to Blog' d='Shop.Theme.Global'}</a>
                            </div>
                        </div>
                ...
                {if !($blog_category && (!isset($blog_category.enabled) || isset($blog_category.enabled) && !$blog_category.enabled)) && ($blog_category || $blog_tag || $blog_search || $author || $is_main_page || $blog_latest || $blog_featured || $blog_popular || $month || $year) && (!$author || ($author && !isset($author.disabled)))}
                    {if isset($blog_posts) && $blog_posts}
                                            ...
                                            <div class="ybc-blog-wrapper-content-main">
                                                    ...
                                                    <div class="ybc-blog-sidear-post-meta">
                                                        ...
                                                        {if $show_categories && $post.categories}
                                                            <div class="ybc-blog-categories">
                                                                ...
                                                                {foreach from=$post.categories item='cat'}
                                                                    {if $cat.id_category==$post.id_category_default}
                                                                        <a href="{$cat.link|escape:'html':'UTF-8'}">{ucfirst($cat.title)|escape:'html':'UTF-8'}</a>
                                                                    {/if}
                                                                {/foreach}
                                                ...
                                                <div class="blog_description">
                                                    {if $post.short_description}
                                                        <p>{$post.short_description|strip_tags:'UTF-8'|truncate:500:'...'|escape:'html':'UTF-8' nofilter}</p>
                                                    {elseif $post.description}
                                                        <p>{$post.description|strip_tags:'UTF-8'|truncate:500:'...'|escape:'html':'UTF-8' nofilter}</p>
                                                    {/if}
                                                </div>
                                                <a class="read_more"
                        ...
                        {if $blog_paggination}
                            <div class="blog-paggination pagination">
