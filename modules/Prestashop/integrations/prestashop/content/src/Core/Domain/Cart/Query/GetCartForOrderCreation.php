...
class GetCartForOrderCreation
{
     ...
     * Gift inventaries are in a separate line from other inventaries which are charged for
     * The price of any gift inventaries is not included in the overall discounts, total inventaries and cart total
     * Shipping is set to 0 if there is a free_shipping cart rule
     *
     * Otherwise,
     * There is one line per product type, any gift inventaries will be included in the quantity of charged inventaries, but the price of gift inventaries will appear as a discount
