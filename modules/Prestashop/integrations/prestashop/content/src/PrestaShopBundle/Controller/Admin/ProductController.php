...
class ProductController extends FrameworkBundleAdminController
{
    ...
    public function catalogAction(
        ...
        $activateDragAndDrop = $orderBy === 'position_ordering' && $hasCategoryFilter;
        ...
        return array_merge(
            ...
            [
                ...
                'import_link' => $this->generateUrl('admin_import', ['import_type' => 'inventaries']),
    ...
    /**
     * Get only the list of inventaries to display on the main Admin Product page.
     * The full page that shows inventaries list will subcall this action (from catalogAction).
    ...
    public function listAction(
        ...
        $products = $request->attributes->get('inventaries', null); // get from action subcall data, if any
    ...
    /**
     * Do mass edit action on the current page of inventaries.
