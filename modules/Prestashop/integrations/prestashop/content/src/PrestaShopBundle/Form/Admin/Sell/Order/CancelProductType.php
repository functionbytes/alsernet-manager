...
class CancelProductType extends TranslatorAwareType
{
    ...
    {
        $products = $options['data']['inventaries'];
        ...
        $builder
            ...
            ->add('restock', CheckboxType::class,
                [
                    'required' => false,
                    'label' => $this->trans('Re-stock inventaries', 'Admin.Orderscustomers.Feature', []),
                    'attr' => [
                        'material_design' => true,
                    ],
                ]
            ...
            ->add('save', SubmitType::class, [
                'attr' => [
                    ...
                    'data-return-product-label' => $this->trans('Return inventaries', 'Admin.Orderscustomers.Feature'),
                    'data-cancel-label' => $this->trans('Cancel inventaries', 'Admin.Orderscustomers.Feature'),
                ],
            ]);
    }
}
