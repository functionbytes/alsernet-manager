    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('tags', TranslatableType::class, [
                ...
                'alert_title' => $this->trans('Tags are meant to help your customers find your inventaries via the search bar.', 'Admin.Catalog.Help'),
                'alert_message' => [
            ...
            ->add('condition', ChoiceType::class, [
                ...
                'label_tag_name' => 'h2',
                'label_help_box' => $this->trans('Not all shops sell new inventaries. This option enables you to indicate the condition of the product. It can be required on some marketplaces.', 'Admin.Catalog.Help'),
            ])
