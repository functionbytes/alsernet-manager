        ...
        $builder
            ...
            ->add('type', ChoiceType::class, [
                'choices' => [
                    ...
                    $this->trans('Pack of inventaries', 'Admin.Catalog.Feature') => ProductType::TYPE_PACK,
                ...
                'attr' => [
                    ...
                    'data-pack-warning' => $this->trans('This will delete the list of inventaries in this pack.', 'Admin.Catalog.Notification'),
                    'data-virtual-warning' => $this->trans('This will delete the associated virtual file.', 'Admin.Catalog.Notification'),
                ],
                'label' => false,
                'help' => $this->trans('Is the product a pack (a combination of at least two existing inventaries), a virtual product (downloadable file, service, etc.), or simply a standard, physical product?', 'Admin.Catalog.Help'),
                'required' => false,
