...
class StockApi extends AbstractApi
{
    ...
    public function getTranslations()
    {
        return [
            ...
            'filter_low_stock' => $this->translator->trans('Display inventaries below low stock level first', [], 'Admin.Catalog.Feature'),
            ...
            'product_search' => $this->translator->trans('Search inventaries (search by name, reference, supplier)', [], 'Admin.Catalog.Feature'),
