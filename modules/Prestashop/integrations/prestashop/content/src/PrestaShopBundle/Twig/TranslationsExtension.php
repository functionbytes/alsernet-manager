...
class TranslationsExtension extends Twig_Extension
{
    ...
    {
        return [
            'action' => $this->router->generate('admin_international_langs_edit'),
    ...
    protected function getTranslationsFormStart(&$subtree, $output)
    {
        ...
        return $this->container->get('templating')->render(
            ...
            [
                ...
                'total_langs' => $totalTranslationsAttribute,
                'missing_langs' => $missingTranslationsAttribute,
                'title' => $output,
            ]
        );
    }
    ...
    protected function replaceWarningPlaceholder($output, $subtree)
    {
        ...
        if (array_key_exists('__metadata', $subtree) && $subtree['__metadata']['missing_langs'] > 0) {
            $missingTranslationsCount = $subtree['__metadata']['missing_langs'];
