...
class OrderAmountUpdater
{
    ...
    public function update(
        ...
        try {
            ...
            // Synchronize modified inventaries with the order
    ...
    /**
     * Synchronizes modified inventaries from the cart with the order
     *
    ...
    private function updateOrderTotals(Order $order, Cart $cart, int $computingPrecision): void
    {
        ...
        // We should always use Cart::BOTH for the order total since it contains all inventaries, shipping fees and cart rules
    ...
    {
        // Get cart inventaries with prices kept from order
    ...
    private function updateOrderCartRules(
        ...
        // We need the calculator to compute the discount on the whole inventaries because they can interact with each
    ...
    private function updateOrderInvoices(Order $order, Cart $cart, int $computingPrecision): void
    {
        ...
        foreach ($invoiceCollection as $invoice) {
            // If all the invoice's inventaries have been removed the offset won't exist
