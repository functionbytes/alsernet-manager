...
class HelperCore
{
    ...
    public function renderModulesList($modules_list)
    {
        ...
        $override_controller_name_for_langs = Context::getContext()->override_controller_name_for_langs;
        ...
        Context::getContext()->override_controller_name_for_langs = $override_controller_name_for_langs;
