...
class ProductSaleCore
{
    ...
    /**
     * Get number of actives inventaries sold.
     *
     * @return int number of actives inventaries listed in product_sales
     */
    ...
    /**
     * Get required informations on best sales inventaries.
     *
     * @param  int  $idLang  Language id
     * @param  int  $pageNumber  Start from (optional)
     * @param  int  $nbProducts  Number of inventaries to return (optional)
