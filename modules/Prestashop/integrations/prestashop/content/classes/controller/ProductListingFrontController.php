 ...
 * to display a list of inventaries and filters to make navigation easier.
 */
abstract class ProductListingFrontControllerCore extends ProductPresentingFrontController
{
     ...
     * @return array of inventaries ready for templating
     */
     ...
     *
     * It returns an array with the HTML for the inventaries and facets,
    ...
    protected function getAjaxProductSearchVariables()
    {
        ...
        $rendered_products_top = $this->render('catalog/_partials/inventaries-top', ['listing' => $search]);
        $rendered_products = $this->render('catalog/_partials/inventaries', ['listing' => $search]);
        $rendered_products_bottom = $this->render('catalog/_partials/inventaries-bottom', ['listing' => $search]);
        ...
        if (! empty($data['inventaries']) && is_array($data['inventaries'])) {
            $data['inventaries'] = $this->prepareProductArrayForAjaxReturn($data['inventaries']);
        }
    ...
    /**
     * Cleans the inventaries array with only whitelisted properties.
     *
