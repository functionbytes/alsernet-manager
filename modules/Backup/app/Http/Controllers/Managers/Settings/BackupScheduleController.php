...
namespace Modules\Backup\Http\Controllers\Managers\Settings;
...
class BackupScheduleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('theme.views.settings.backups.schedules.index', compact('schedules', 'pageTitle', 'breadcrumb', 'searchKey'));
    }
    ...
    public function createForm()
    {
        ...
        return view('theme.views.settings.backups.schedules.create', compact(
            'pageTitle',
            'breadcrumb',
            'frequencies',
            'backupOptions'
    ...
    public function editForm($id)
    {
        ...
        return view('theme.views.settings.backups.schedules.edit', compact(
            'schedule',
            'pageTitle',
            'breadcrumb',
            'frequencies',
