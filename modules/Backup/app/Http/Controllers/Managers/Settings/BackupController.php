...
class BackupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('theme.views.settings.backups.index', compact('backups', 'pageTitle', 'breadcrumb'));
    }
    ...
    public function createForm()
    {
        ...
        return view('theme.views.settings.backups.create', compact('pageTitle', 'breadcrumb'));
    }
