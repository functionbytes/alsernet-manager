...
class PulseServiceProvider extends ServiceProvider
{
    ...
    protected string $nameLower = 'pulse';
    ...
    {
        // Pulse dashboard routes (monitoring)
    ...
    /**
     * Registrar gates para autorización de Pulse
     */
    ...
    /**
     * Registrar menús del módulo Pulse
     */
    protected function registerMenus(): void
    {
        // Mini-nav item para Pulse
        NavService::registerMiniItem('pulse', [
            'icon' => 'fa-heartbeat',
            'tooltip' => 'Monitoreo',
            'sidebar_id' => 'pulse',
            'order' => 90,
        ...
        NavService::registerSidebar('pulse', [
            'title' => 'Monitoreo del sistema',
            'items' => [
                ['label' => 'Dashboard de Pulse', 'route' => 'pulse.dashboard'],
            ],
        ]);
    }
