...
@section('content')
    ...
    @include('theme.components.card', ['title' => 'Roles'])
                ...
                <div class="col-md-12 col-xl-12">
                    <form class="position-relative form-search" action="{{ request()->fullUrl() }}" method="GET">
                        <div class="row justify-content-between g-2 ">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('roles.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Crear nuevo rol">
                                ...
                                @if(!in_array($role->name, ['super-admins', 'admins', 'customer']))
                                    <div class="dropdown dropstart">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="{{ route('roles.edit', $role->id) }}" class="dropdown-item edit-role"
                                            ...
                                            <li>
                                                <a href="{{ route('roles.show.permissions', $role->id) }}" class="dropdown-item manage-permissions"
                                                   data-role-id="{{ $role->id }}"
                                                   data-role-name="{{ $role->name }}">
