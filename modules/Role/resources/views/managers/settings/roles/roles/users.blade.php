...
@section('content')
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card card-body border">
            ...
            <div class="row mb-4 pb-3 border-bottom">
                <div class="col-12">
                    <div class="d-flex flex-wrap gap-2">
                        @if($search)
                            <a href="{{ route('manager.roles.show.users', $role->id) }}" class="btn btn-outline-secondary btn-sm">
                                <i class="fas fa-times me-2"></i>Limpiar filtros
                            </a>
                        @endif
                        <a href="{{ route('manager.roles.show', $role->id) }}" class="btn btn-outline-primary btn-sm">
            ...
            <div class="row mb-4 pb-3 border-bottom">
                <div class="col-12">
                    <form class="position-relative form-search" action="{{ route('manager.roles.show.users', $role->id) }}" method="GET">
                        <div class="row g-2">
            ...
            @elseif($search)
                ...
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('manager.roles.show.users', $role->id) }}" class="btn btn-outline-primary btn-sm">
    ...
    <div class="modal fade" id="assignUsersModal" tabindex="-1" aria-labelledby="assignUsersModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="assignUsersForm" method="POST" action="{{ route('manager.roles.assign.users') }}">
                    @csrf
        ...
        $(function() {
            ...
            $(document).on('click', '.remove-user-btn', function(e) {
                ...
                if (confirm('¿Estás seguro de que deseas remover a ' + userName + ' de este rol?')) {
                    $.ajax({
                        url: '{{ route("manager.roles.remove.user") }}',
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            user_id: userId,
