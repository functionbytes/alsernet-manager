...
class RoleController extends BaseManagerController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('theme.views.settings.roles.roles.index', compact('roles', 'searchKey'));
    }
    ...
    public function create()
    {
        ...
        return view('theme.views.settings.roles.roles.create', compact('permissions'));
    }
    ...
    public function show(Role $role)
    {
        ...
        return view('theme.views.settings.roles.roles.show', compact('role'));
    }
    ...
    public function edit(Role $role)
    {
        ...
        return view('theme.views.settings.roles.roles.edit', compact('role', 'permissions', 'rolePermissions'));
    }
    ...
    public function showPermissions(Role $role)
    {
        ...
        return view('theme.views.settings.roles.roles.permissions', compact('role', 'permissions', 'rolePermissions'));
    }
    ...
    public function showUsers(Role $role, Request $request)
    {
        ...
        return view('theme.views.settings.roles.roles.users', compact('role', 'users', 'search'));
    }
}
