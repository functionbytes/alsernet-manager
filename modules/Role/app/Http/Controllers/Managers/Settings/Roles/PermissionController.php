...
class PermissionController extends BaseManagerController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('theme.views.settings.roles.permissions.index', compact('permissions', 'search'));
    }
    ...
    {
        return view('theme.views.settings.roles.permissions.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('theme.views.settings.roles.permissions.edit', compact('permission'));
    }
