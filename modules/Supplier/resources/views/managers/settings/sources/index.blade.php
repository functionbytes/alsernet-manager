    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        @if(request('search') || request('source_type') || request('is_active'))
                            <a href="{{ route('manager.settings.suppliers.sources.index', $supplier->uid) }}" class="btn btn-secondary">
                                Limpiar búsqueda
                            </a>
                        @endif
                        <a href="{{ route('manager.settings.suppliers.sources.create', $supplier->uid) }}" class="btn btn-primary">
                            Nueva fuente
                        </a>
                    </div>
                </div>
            ...
            <div class="card-body border-bottom">
                <form method="GET" action="{{ route('manager.settings.suppliers.sources.index', $supplier->uid) }}">
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('manager.settings.suppliers.sources.edit', [$supplier->uid, $source->uid]) }}">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item confirm-delete" data-href="{{ route('manager.settings.suppliers.sources.destroy', [$supplier->uid, $source->uid]) }}">
                                                            Eliminar
                                                        </a>
                                                    </li>
                                                </ul>
                ...
                @else
                    <div class="text-center py-5">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            @if(!request('search'))
                                <a href="{{ route('manager.settings.suppliers.sources.create', $supplier->uid) }}" class="btn btn-sm btn-primary">
...
$(document).ready(function() {
    ...
    $('.test-source').on('click', function() {
        ...
        $.ajax({
            url: '{{ route("manager.settings.suppliers.sources.test", [$supplier->uid, ":uid"]) }}'.replace(':uid', uid),
            method: 'POST',
            data: {
                _token: '{{ csrf_token() }}'
            },
