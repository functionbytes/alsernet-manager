...
@section('content')
    ...
    <div class="card w-100">
        ...
        <form id="formWorkflow" method="POST" action="{{ route('manager.settings.suppliers.automation.workflows.update', $workflow->uid) }}">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h5 class="mb-0">Editar workflow de automatización</h5>
                        <p class="card-subtitle mb-0 mt-2">
                            Modifique la configuración del workflow <strong>{{ $workflow->name }}</strong>.
                        </p>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card bg-light-success">
                            <div class="card-body">
                                ...
                                <h5 class="mb-0 fw-bold text-success">{{ $workflow->successful_executions ?? 0 }}</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card bg-light-danger">
                            <div class="card-body">
                                ...
                                <h5 class="mb-0 fw-bold text-danger">{{ $workflow->failed_executions ?? 0 }}</h5>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-between align-items-center">
                    <button type="button" class="btn btn-danger" id="deleteWorkflowBtn">
                        <i class="fas fa-trash me-2"></i>Eliminar workflow
                    </button>
...
$(document).ready(function() {
    ...
    $('#deleteWorkflowBtn').on('click', function() {
        Swal.fire({
            title: '¿Estás seguro?',
            text: "Se eliminará el workflow '{{ $workflow->name }}' y todas sus ejecuciones relacionadas.",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                const form = $('<form>', {
                    method: 'POST',
                    action: '{{ route("manager.settings.suppliers.automation.workflows.destroy", $workflow->uid) }}'
                });
