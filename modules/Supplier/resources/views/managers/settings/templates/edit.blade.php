...
@section('content')
    ...
    <div class="card w-100">
        ...
        <form id="formTemplate" method="POST" action="{{ route('manager.settings.suppliers.templates.update', $template->uid) }}">
            ...
            <div class="card-footer">
                    ...
                    <a href="{{ route('manager.settings.suppliers.templates.index') }}" class="btn btn-secondary w-100">
                        Cancelar
                    </a>
            </div>
