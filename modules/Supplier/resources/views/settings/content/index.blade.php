...
@section('content')
    ...
    @include('theme.components.card', ['title' => 'Revisión de Contenido'])
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        @if(request('search') || request('status') || request('supplier_id'))
                            <a href="{{ route('settings.suppliers.content.index') }}" class="btn btn-secondary">
                                Limpiar filtros
                            </a>
                        @endif
                    </div>
            ...
            <div class="card-body border-bottom">
                <form method="GET" action="{{ route('settings.suppliers.content.index') }}">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                @if($content->status === 'approved')
                                                    <li>
                                                        <form method="POST" action="{{ route('settings.suppliers.content.publish', $content->uid) }}" class="publish-form">
                                                            @csrf
                                                ...
                                                <li>
                                                    <form method="POST" action="{{ route('settings.suppliers.content.action', $content->uid) }}" class="regenerate-form">
                                                        @csrf
