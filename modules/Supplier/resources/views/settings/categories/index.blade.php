            ...
            <div class="card w-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('settings.suppliers.index') }}" class="btn btn-light">
                    ...
                    @if($availableCategories->count() > 0)
                        <div class="card border mb-4">
                            <div class="card-body">
                                ...
                                <form action="{{ route('settings.suppliers.categories.store', $supplier->uid) }}" method="POST">
                                    @csrf
                                ...
                                <tbody>
                                    @foreach($assignedCategories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('settings.suppliers.categories.update', [$supplier->uid, $category->id]) }}"
                                            ...
                                            <td class="text-center">
                                                <form action="{{ route('settings.suppliers.categories.toggle', [$supplier->uid, $category->id]) }}"
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('settings.suppliers.prompts.create') }}?supplier_id={{ $supplier->id }}&category_id={{ $category->id }}&scope=supplier_category">
                                                        ...
                                                        <li>
                                                            <button type="button"
                                                                    ...
                                                                    data-url="{{ route('settings.suppliers.categories.destroy', [$supplier->uid, $category->id]) }}"
