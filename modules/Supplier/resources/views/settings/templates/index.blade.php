            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card border mb-4">
                        <div class="card-body">
                            <form method="GET" action="{{ route('settings.suppliers.templates.index') }}" class="row align-items-end g-3">
                                <div class="col-md-5">
                                    ...
                                    <div class="card border h-100">
                                        ...
                                        <div class="card-footer bg-white">
                                            <div class="d-flex gap-2 mb-2">
                                                <a href="{{ route('settings.suppliers.templates.edit', $template->uid) }}"
                    ...
                    @else
                        <div class="text-center py-5">
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <a href="{{ route('settings.suppliers.templates.index') }}" class="btn btn-primary">
