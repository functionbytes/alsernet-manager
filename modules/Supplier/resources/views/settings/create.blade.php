        ...
        <form id="formSupplier" enctype="multipart/form-data" role="form" onSubmit="return false">
            ...
            <div class="card-body">
                ...
                <p class="card-subtitle mb-3 mt-3">
                    Define un nuevo proveedor que gestionará fuentes de productos. Los proveedores activos se sincronizarán automáticamente con el sistema.
                </p>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('settings.suppliers.index') }}" class="btn btn-secondary px-4 waves-effect waves-light mt-2 w-100">
                    Volver
                </a>
            </div>
    ...
    $(document).ready(function() {
      ...
      $("#formSupplier").validate({
        ...
        submitHandler: function(form) {
          ...
          $.ajax({
            url: "{{ route('settings.suppliers.store') }}",
            headers: {
