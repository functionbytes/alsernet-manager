 ...
 * @property string|null $last_verification_at
 * @property string|null $last_verification_by
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber deliverableOrNotVerified()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber filter($request)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber query()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber risky()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber search($keyword)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber searchByEmail($email)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber simpleSearch($keyword)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber subscribed()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber undeliverable()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber unknown()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber unsubscribed()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber unverified()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber verified()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber whereImportBatchId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber whereLastVerificationAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber whereLastVerificationBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber whereLastVerificationResult($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber whereMaillistId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber whereSubscriberId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber whereTags($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber whereUid($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CampaignMaillistsSubscriber whereVerificationStatus($value)
 *
 * @mixin \Eloquent
 */
class CampaignMaillistsSubscriber extends Model
{
    ...
    {
        [$status, $response] = $verifier->verify($this->email);
