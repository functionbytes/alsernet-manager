...
class Campaign extends BaseCampaign implements CampaignInterface, HasTemplateInterface
{
    ...
    public function sendTestEmail($email)
    {
        ...
        try {
            ...
            [$message, $msgId] = $this->prepareEmail($subscriber, $server);
            // print_r($message);
            // die;
            // actually send
    ...
    public function score()
    {
        ...
        $score = $score['score'];
        [$current, $threshold] = preg_split('/\//', $score);
    ...
    public function getDeliveryReport()
    {
         ...
         *
         * Assumption
         *     + subscribers 1:1 mail_verification
    ...
    public static function newDefault()
    {
        ...
        $campaign->title = trans('messages.untitled');
    ...
    public function makeSampleData($params = [])
    {
        ...
        foreach ($this->trackingLogs()->whereIn('id', $openLogs)->get() as $r) {
            $log = new \App\Models\OpenLog;
            $log->message_id = $r->message_id;
            $location = \App\Models\IpLocation::add(StringHelper::getRandomUSIpAddresses());
        ...
        foreach ($this->trackingLogs()->whereIn('id', $unsubscribeLogs)->get() as $r) {
            // Unsubscribe log
            $log = new \App\Models\UnsubscribeLog;
            $log->message_id = $r->message_id;
