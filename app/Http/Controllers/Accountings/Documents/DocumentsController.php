...
class DocumentsController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('accountings.views.documents.index')->with([
            'documents' => $documents,
            'searchKey' => $search,
            'statusId' => $statusId,
            'loadId' => $loadId,
    ...
    public function pending(Request $request)
    {
        ...
        return view('accountings.views.documents.pending')->with([
            'documents' => $documents,
            'searchKey' => $search,
            'loadId' => $loadId,
            'dateFrom' => $dateFrom,
    ...
    {
        return view('accountings.views.documents.import.index');
    }
    ...
    {
        return view('accountings.views.documents.import.api');
    }
    ...
    {
        return view('accountings.views.documents.import.erp');
    }
    ...
    public function show($uid)
    {
        ...
        return view('accountings.views.documents.show')->with([
            'document' => $document,
            'products' => $products,
        ]);
    }
    ...
    public function refreshDocumentsSection($uid)
    {
        try {
            ...
            $html = view('accountings.views.documents.partials.upload-section', [
                'document' => $document,
    ...
    public function refreshActionHistory($uid)
    {
        try {
            ...
            $html = view('accountings.views.documents.includes.action-history', [
                'document' => $document,
            ])->render();
    ...
    public function emailHistory($uid)
    {
        ...
        return view('accountings.views.documents.emails.index', compact('document', 'mails'));
    }
    ...
    public function emailPreview($mailUid)
    {
        ...
        return view('accountings.views.documents.emails.preview', compact('mail', 'document'));
    }
}
