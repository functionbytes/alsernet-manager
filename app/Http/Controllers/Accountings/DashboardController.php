...
class DashboardController extends Controller
{
    ...
    {
        return view('accountings.views.dashboard.index')->with($this->getDashboardData());
    }

    public function dashboardV1()
    {
        return view('accountings.views.dashboard.v1')->with($this->getDashboardData());
    }

    public function dashboardV2()
    {
        return view('accountings.views.dashboard.v2')->with($this->getDashboardData());
    }

    public function dashboardV3()
    {
        return view('accountings.views.dashboard.v3')->with($this->getDashboardData());
    }
    ...
    public function dashboardV4()
    {
        ...
        return view('accountings.views.dashboard.v4')->with($data);
    }
}
