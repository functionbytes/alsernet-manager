...
class DocumentValidationConditionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('managers.views.settings.documents.conditions.index', [
    ...
    {
        $validSaleTypes = DocumentProductBlockade::VALID_TYPES;

        return view('managers.views.settings.documents.conditions.create', [
    ...
    public function edit(string $condition)
    {
        ...
        return view('managers.views.settings.documents.conditions.edit', [
