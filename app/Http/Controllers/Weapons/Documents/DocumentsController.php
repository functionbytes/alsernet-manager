...
namespace App\Http\Controllers\Weapons\Documents;
...
class DocumentsController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('weapons.views.documents.index')->with([
            'documents' => $documents,
            'searchKey' => $search,
            'statusId' => $statusId,
            'loadId' => $loadId,
    ...
    public function pending(Request $request)
    {
        ...
        return view('weapons.views.documents.pending')->with([
            'documents' => $documents,
            'searchKey' => $search,
            'loadId' => $loadId,
            'dateFrom' => $dateFrom,
    ...
    {
        return view('weapons.views.documents.import.index');
    }
    ...
    {
        return view('weapons.views.documents.import.api');
    }
    ...
    {
        return view('weapons.views.documents.import.erp');
    }
    ...
    public function show($uid)
    {
        ...
        return view('weapons.views.documents.show')->with([
            'document' => $document,
            'products' => $products,
        ]);
    }
    ...
    public function manage($uid)
    {
        ...
        return view('weapons.views.documents.manage')->with([
            'document' => $document,
            'products' => $products,
            'sources' => $sources,
            'statuses' => $statuses,
    ...
    public function refreshDocumentsSection($uid)
    {
        try {
            ...
            $html = view('weapons.views.documents.partials.upload-section', [
                'document' => $document,
    ...
    public function refreshActionHistory($uid)
    {
        try {
            ...
            $html = view('weapons.views.documents.includes.action-history', [
                'document' => $document,
            ])->render();
    ...
    public function emailHistory($uid)
    {
        ...
        return view('weapons.views.documents.emails.index', compact('document', 'mails'));
    }
    ...
    public function emailPreview($mailUid)
    {
        ...
        return view('weapons.views.documents.emails.preview', compact('mail', 'document'));
    }
}
