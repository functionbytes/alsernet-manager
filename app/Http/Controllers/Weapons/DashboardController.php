...
class DashboardController extends Controller
{
    ...
    {
        return view('weapons.views.dashboard.index')->with($this->getDashboardData());
    }

    public function dashboardV1()
    {
        return view('weapons.views.dashboard.v1')->with($this->getDashboardData());
    }

    public function dashboardV2()
    {
        return view('weapons.views.dashboard.v2')->with($this->getDashboardData());
    }

    public function dashboardV3()
    {
        return view('weapons.views.dashboard.v3')->with($this->getDashboardData());
    }
    ...
    public function dashboardV4()
    {
        ...
        return view('weapons.views.dashboard.v4')->with($data);
    }
}
