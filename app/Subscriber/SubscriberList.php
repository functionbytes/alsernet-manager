...
class SubscriberList extends Model
{
    ...
    {
        return $this->belongsToMany('App\Subscriber\SubscriberList', 'subscriber_list_categories', 'categorie_id', 'list_id');
    }
    ...
    {
        return $this->hasMany('App\Subscriber\SubscriberListCategorie', 'list_id', 'id');
    }
