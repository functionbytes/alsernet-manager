...
use App\Models\Subscriber\SubscriberHistory;
use App\Models\Subscriber\SubscriberJob;
...
class Subscriber extends Model
{
    ...
    {
        return $this->hasMany('App\Subscriber\SubscriberCategorie');
    }

    public function lists(): HasMany
    {
        return $this->hasMany('App\Subscriber\SubscriberListUser');
    }

    public function records(): HasMany
    {
        return $this->hasMany('App\Subscriber\SubscriberLog');
    }
    ...
    {
        return $this->hasMany('App\Subscriber\SubscriberLog', 'subject_id')->latest();
    }
