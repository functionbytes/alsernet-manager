...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'webadmin_mysql' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_WEBADMIN', 'localhost'),
            'port' => env('DB_PORT_WEBADMIN', '3306'),
            'database' => env('DB_DATABASE_WEBADMIN', 'webadmin'),
            'username' => env('DB_USERNAME_WEBADMIN', 'webadmin'),
        ...
        'legacy' => [
            ...
            'database' => env('LEGACY_DB_DATABASE', 'webadminprueba'),
    ...
    */
    ...
    | such as Memcached. You may define your connection backups here.
    |
    */
