...
return new class extends Migration
{
    ...
    {
        Schema::connection('helpdesk')->create('helpdesk_conversation_items', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('helpdesk')->dropIfExists('helpdesk_conversation_items');
    }
};
