...
return new class extends Migration
{
    ...
    {
        Schema::connection('helpdesk')->create('helpdesk_ticket_sla_policies', function (Blueprint $table) {
            $table->id();
            $table->string('name');
    ...
    {
        Schema::connection('helpdesk')->dropIfExists('helpdesk_ticket_sla_policies');
    }
};
