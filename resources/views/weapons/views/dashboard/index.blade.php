                                ...
                                <tbody>
                                    @forelse($recentDocuments as $document)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('weapons.documents.show', $document->uid) }}" class="btn btn-sm btn-outline-secondary" title="Ver">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="{{ route('weapons.documents.manage', $document->uid) }}" class="btn btn-sm btn-outline-primary" title="Gestionar">
