...
<div class="container-fluid">
    ...
    @include('weapons.includes.card', ['title' => 'Dashboard v3 - Minimal Style'])
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-transparent border-0 d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('weapons.documents') }}" class="btn btn-sm btn-primary">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('weapons.documents.manage', $doc->uid) }}" class="btn btn-sm btn-outline-primary">
