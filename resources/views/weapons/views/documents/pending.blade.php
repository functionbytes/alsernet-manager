...
@section('content')
    ...
    @include('weapons.includes.card', ['title' => 'Documentos'])

    <div class="widget-content searchable-container list">
        <div class="card card-body">
            <div class="row">
                <div class="col-md-12 col-xl-12">
                    <form class="form-search" action="{{ route('weapons.documents') }}" method="GET">
                        <div class="row justify-content-between g-2 ">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('weapons.documents') }}" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Limpiar filtros">
                                    <i class="fa-duotone fa-xmark"></i>
                                </a>
                            </div>
                            <div class="col-auto">
                                <a href="{{ route('weapons.documents.import') }}" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Importar órdenes específicas">
                            ...
                            <td class="text-left">
                                <div class="dropdown dropstart">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('weapons.documents.show', $document->uid) }}">
                                                Ver
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('weapons.documents.manage', $document->uid) }}">
                                                Gestionar
                                            </a>
                                        </li>
                                        @if($document->mails()->count() > 0)
                                            ...
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('weapons.documents.emails', $document->uid) }}">
                                                    Ver emails
                                                </a>
                                            </li>
                                        @endif
