        ...
        <div class="row">
            @if($document->confirmed_at!=null && $document->media->count()>0)
                <div class="col-md-12 mb-3">
                    <a href="{{ route('weapons.documents.summary', $document->uid) }}" target="_blank" class="card item-status h-100">
        ...
        $(document).ready(function() {
            ...
            $("#formDocuments").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "{{ route('weapons.documents.update') }}",
                        headers: {
                        ...
                        success: function(response) {
                            ...
                            if(response.success == true){
                                ...
                                toastr.success(message, "Operación exitosa", {
                                    ...
                                    timeOut: 1000,
                                    onHidden: function () {
                                        window.location = "{{ route('weapons.documents') }}";
                                    }
                                });
