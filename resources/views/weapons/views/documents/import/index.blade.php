...
@section('content')
    ...
    @include('weapons.includes.card', ['title' => 'Importar Documentos'])
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-footer border-top">
                    <a href="{{ route('weapons.documents.import.api') }}" class="btn btn-primary w-100">
        ...
        <div class="col-md-6">
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-footer border-top">
                    <a href="{{ route('weapons.documents.import.erp') }}" class="btn btn-primary w-100">
        ...
        <div class="card-body">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-end">
                    <a href="{{ route('weapons.documents') }}" class="btn btn-secondary">
