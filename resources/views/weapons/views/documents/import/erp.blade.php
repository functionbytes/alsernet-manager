...
@section('content')
    ...
    @include('weapons.includes.card', ['title' => 'Importar desde gestión'])
                ...
                <div class="col-md-12">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            ...
                            <a href="{{ route('weapons.documents.import') }}" class="btn btn-secondary w-100">
                               Volver
                            </a>
                        </div>
                    </div>
    ...
    <div id="results-container" style="display: none; margin-top: 30px;">
        <div class="card card-body">
            ...
            <div class="mt-4">
                <a href="{{ route('weapons.documents') }}" class="btn btn-primary w-100">
                    Ver documentos
                </a>
            </div>
        </div>
        ...
        $(document).ready(function() {
            ...
            function importOrders(orders) {
                ...
                const importNext = (index) => {
                    ...
                    $.ajax({
                        url: '{{ route("weapons.documents.sync.from-erp") }}',
                        method: 'POST',
                        headers: {
