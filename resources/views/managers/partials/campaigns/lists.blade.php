...
<div class="condition-line" rel="{{ $index }}">
    <div class="row list-segment-container">
        <div class="col-md-1 d-flex justify-content-center align-items-center ">
            <div class="form-group">
                <div>
                    ...
                    @include('Modules.Campaign.views.helpers.form_control', [
        ...
        <div class="col-md-5 list_select_box" target-box="segments-select-box"
             segments-url="{{ route('manager.segments.selectBox') }}">
            @include('Modules.Campaign.views.helpers.form_control', [
        ...
        <div class="col-md-1 d-flex justify-content-center align-items-center">
            <a onclick="$(this).parents('.condition-line').remove()" href="#delete" class="btn btn-light"><span
                        class="material-symbols-rounded">delete_outline</span></a>
        </div>
    </div>
    <hr class="mt-10">
</div>
