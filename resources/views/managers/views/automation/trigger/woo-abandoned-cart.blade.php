    ...
    @if (isset($shopinfo['name']) && !request()->options)
            ...
            <div class="settings">
                <div class="d-flex my-2 py-1">
                    ...
                    <div class="setting-content">
                        ...
                        <div>
                            <a href="{{ route('Automation2Controller@cartWait', $automation->uid) }}"
                ...
                <div class="d-flex my-2 py-1">
                    @if ($trigger->getOption('list_uid'))
                        ...
                        <div class="setting-content">
                            ...
                            <div>
                                <a href="{{ route('Automation2Controller@cartChangeList', $automation->uid) }}"
        ...
        <div class="wp-shop-info mb-4 mt-4" style="display:none">
            <div class="d-flex align-items-center">
                ...
                <div class="ml-auto">
                    <a href="{{ route('Automation2Controller@cartChangeStore', $automation->uid) }}"
