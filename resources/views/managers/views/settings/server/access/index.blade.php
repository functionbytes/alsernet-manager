...
@section('content')
    ...
    @include('managers.components.card', ['title' => 'Registros de Acceso'])
                ...
                <div class="row g-3 align-items-end">
                    <div class="col-md-6">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <a href="{{ route('manager.settings.system.access.stats') }}"
                               class="btn btn-outline-primary d-flex align-items-center gap-2">
                                <i class="fa fa-bar-chart"></i> Estadísticas
                            </a>
                            <a href="{{ route('manager.settings.system.access.download') }}"
                               class="btn btn-outline-primary d-flex align-items-center gap-2">
