    ...
    <div class="row g-3">
            ...
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body pb-0">
                    <p class="text-muted mb-3">
                        Configure el servidor SMTP para <strong>enviar correos electrónicos salientes</strong> desde la
                        aplicación (notificaciones, alertas, respuestas automáticas, etc.).
                    </p>
                    ...
                    <ul class="list-unstyled ms-3 mb-4">
                        <li class="mb-2">
                            ...
                            <br>
                            <small class="text-muted">Configurar host, puerto, encriptación y credenciales del servidor
                                de correo saliente.</small>
                        </li>
                        <li class="mb-2">
                            <strong>Remitente predeterminado</strong>
                            <br>
                            <small class="text-muted">Definir la dirección de email y nombre que aparecerán como
                                remitente en todos los correos.</small>
                        </li>
                        <li class="mb-2">
                            <strong>Pruebas de conexión</strong>
                            <br>
                            <small class="text-muted">Verificar que la configuración funcione correctamente enviando
                                emails de prueba.</small>
                        </li>
                    </ul>
                    ...
                    @if(isset($outgoingSettings['mail_host']))
                        <div class="bg-light-secondary p-3 rounded mb-3">
                            <small class="text-muted">
                                ...
                                Servidor: {{ $outgoingSettings['mail_host'] ?? 'N/A' }}
                                :{{ $outgoingSettings['mail_port'] ?? 'N/A' }}<br>
        ...
        <div class="col-md-6">
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body pb-0">
                    <p class="text-muted mb-3">
                        Configure los <strong>manejadores de correo entrante</strong> para convertir emails recibidos en
                        tickets y respuestas automáticamente.
                    </p>
                    ...
                    <ul class="list-unstyled ms-3 mb-4">
                        <li class="mb-2">
                            <strong>IMAP</strong>
                            <br>
                            <small class="text-muted">Conectar cuentas de correo existentes usando el protocolo
                                IMAP.</small>
                        </li>
                        <li class="mb-2">
                            <strong>Pipe Script</strong>
                            <br>
                            <small class="text-muted">Recibir correos desde cPanel o paneles de control de
                                hosting.</small>
                        </li>
                        <li class="mb-2">
                        ...
                        <li class="mb-2">
                            ...
                            <br>
                            <small class="text-muted">Conectar directamente con servicios de correo
                                especializados.</small>
                        </li>
                    </ul>
