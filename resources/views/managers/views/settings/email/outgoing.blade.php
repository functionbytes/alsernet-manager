...
@section('content')
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-3">
                            <button type="button" class="btn btn-outline-primary w-100" data-bs-toggle="modal"
                                    data-bs-target="#sendTestEmailModal">
                                Enviar prueba
                            </button>
                        </div>
                        <div class="col-md-3">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-muted small mb-3">Configure la información del remitente para todos los correos
                        electrónicos salientes de la aplicación.</p>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="card card-body h-100 bg-light-secondary">
                                ...
                                <small class="text-muted">Todos los correos salientes se enviarán desde esta
                                    dirección</small>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-muted small mb-3">Configure qué método se debe utilizar para enviar correos
                        electrónicos salientes de la aplicación.</p>
    ...
    <div class="modal fade" id="sendTestEmailModal" tabindex="-1" aria-labelledby="sendTestEmailModalLabel"
         aria-hidden="true">
                    ...
                    <form id="testEmailForm">
                        ...
                        <div class="alert alert-info border-0 bg-info-subtle text-info mb-3">
                            <div class="d-flex align-items-start gap-2">
                                ...
                                <div>
                                    <strong>Importante:</strong> Asegúrese de tener la configuración SMTP actualizada
                                    antes de enviar el correo de prueba.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Ingrese la dirección de correo donde desea recibir el email de
                                prueba</small>
                        </div>
                        ...
                        <div class="bg-light-secondary p-3 rounded">
                            ...
                            <small class="text-muted">
                                ...
                                <strong>De:</strong> {{ $settings['mail_from_name'] }}
