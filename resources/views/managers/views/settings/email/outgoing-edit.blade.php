    ...
    <div class="card">
        ...
        <form id="formEmail" method="POST" action="{{ route('manager.settings.email.update') }}">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <p class="card-subtitle mb-3 ">
                        Este espacio está diseñado para que configures los parámetros de tu servidor SMTP. Estos datos
                        serán utilizados para enviar correos electrónicos desde la aplicación.
                    </p>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-control select2 @error('mail_mailer') is-invalid @enderror "
                                    id="mailMailer" name="mail_mailer" required>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('mail_host') is-invalid @enderror"
                                   id="mailHost" name="mail_host" value="{{ old('mail_host', $settings['mail_host']) }}"
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('mail_port') is-invalid @enderror"
                                   id="mailPort" name="mail_port" value="{{ old('mail_port', $settings['mail_port']) }}"
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('mail_encryption') is-invalid @enderror"
                                    id="mailEncryption" name="mail_encryption" required>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('manager.settings.email.index') }}"
