...
@section('content')
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info border-0 bg-info-subtle text-info mb-4">
                    <div class="d-flex align-items-start gap-2">
                        ...
                        <div>
                            ...
                            <p class="mb-0">Configure diferentes manejadores para convertir los correos electrónicos
                                entrantes en tickets y respuestas. Puede habilitar múltiples manejadores al mismo
                                tiempo.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="collapse show" id="imapCollapse">
                        <div class="card-body">
                            <p class="text-muted mb-3">Conecte sus cuentas de correo electrónico existentes a Alsernet
                                usando IMAP.</p>
                            <button class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#addImapConnectionModal">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-sm btn-danger"
                                                                onclick="deleteImapConnection('{{ $connection['id'] }}')">
                ...
                <div class="card mb-3">
                    ...
                    <div class="collapse" id="pipeCollapse">
                        <div class="card-body">
                            <p class="text-muted mb-3">Reciba correos electrónicos en Alsernet desde cPanel u otro panel
                                de control utilizado por su proveedor de alojamiento.</p>
                            ...
                            <form method="POST" action="{{ route('manager.settings.email.incoming.pipe.update') }}">
                                ...
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" id="pipeEnabled" name="pipe_enabled"
                                           value="1" {{ $settings['pipe']['enabled'] ? 'checked' : '' }}>
                                    <label class="form-check-label fw-semibold" for="pipeEnabled">Habilitar Pipe
                                        Handler</label>
                                </div>

                                <div class="mb-3">
                                    <label for="pipeEmailAddress" class="form-label fw-semibold">Dirección de
                                        email</label>
                                    <input type="email" class="form-control" id="pipeEmailAddress"
                                           name="pipe_email_address" value="{{ $settings['pipe']['email_address'] }}"
                                           placeholder="support@Alsernet.com">
                                ...
                                <div class="alert alert-info mb-3">
                                    ...
                                    <p class="mb-0 mt-2 small">Configure esta ruta en su panel de control de email
                                        (cPanel, Plesk, etc.)</p>
                                </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="collapse" id="apiCollapse">
                        <div class="card-body">
                            <p class="text-muted mb-3">Envíe correos electrónicos a Alsernet desde una aplicación de
                                terceros o un sitio web diferente usando la API REST.</p>
                            ...
                            <form method="POST" action="{{ route('manager.settings.email.incoming.api.update') }}">
                                ...
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" id="apiEnabled" name="api_enabled"
                                           value="1" {{ $settings['api']['enabled'] ? 'checked' : '' }}>
                                    <label class="form-check-label fw-semibold" for="apiEnabled">Habilitar REST API
                                        Handler</label>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control font-monospace" id="apiKey"
                                               name="api_key" value="{{ $settings['api']['api_key'] }}" readonly>
                                    ...
                                    <small class="text-muted">Esta clave se usa para autenticar peticiones a la
                                        API</small>
                                </div>
                                ...
                                <a href="{{ route('manager.settings.email.incoming.api.documentation') }}"
                ...
                <div class="card mb-3">
                    ...
                    <div class="collapse" id="gmailCollapse">
                        <div class="card-body">
                            <p class="text-muted mb-3">Conecte cuentas de Gmail directamente usando la API de Gmail con
                                OAuth2.</p>
                            ...
                            <form method="POST" action="{{ route('manager.settings.email.incoming.gmail.update') }}">
                                ...
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" id="gmailEnabled"
                                           name="gmail_enabled"
                                           value="1" {{ $settings['gmail']['enabled'] ? 'checked' : '' }}>
                                    <label class="form-check-label fw-semibold" for="gmailEnabled">Habilitar Gmail
                                        Handler</label>
                                </div>

                                <div class="alert alert-info mb-3">
                                    <i class="fa fa-info-circle"></i> <strong>Configuración OAuth2</strong>
                                    <p class="mb-0 mt-2 small">Necesita crear credenciales OAuth2 en <a
                                                href="https://console.cloud.google.com/apis/credentials"
                                                target="_blank">Google Cloud Console</a> y configurar el Redirect URI
                                        autorizado:</p>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control font-monospace" id="gmailClientId"
                                               name="gmail_client_id" value="{{ $settings['gmail']['client_id'] }}"
                                               placeholder="xxx.apps.googleusercontent.com">
                                        <small class="text-muted">Client ID de Google Cloud Console</small>
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label for="gmailClientSecret" class="form-label fw-semibold">Client
                                            Secret</label>
                                        <input type="password" class="form-control font-monospace"
                                               id="gmailClientSecret" name="gmail_client_secret"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        @foreach($settings['gmail']['connections'] as $connection)
                                            <tr>
                                                <td>
                                                    <i class="fa-brands fa-google text-danger"></i> {{ $connection['email'] }}
                                                </td>
                                                <td><small class="text-muted">{{ $connection['created_at'] }}</small>
                                                </td>
                                                <td>
                                                    <button class="btn btn-sm btn-danger"
                                                            onclick="deleteGmailConnection('{{ $connection['id'] }}')">
                            ...
                            <a href="{{ route('manager.settings.email.incoming.gmail.authorize') }}"
                               class="btn btn-success btn-sm" {{ empty($settings['gmail']['client_id']) || empty($settings['gmail']['client_secret']) ? 'disabled' : '' }}>
                                <i class="fa-brands fa-google"></i> Conectar cuenta Gmail
                            </a>
                            @if(empty($settings['gmail']['client_id']) || empty($settings['gmail']['client_secret']))
                                <small class="text-danger d-block mt-2">Configure primero Client ID y Client
                                    Secret</small>
                            @endif
                        </div>
                    </div>
                ...
                <div class="card mb-3">
                    <div class="card-header bg-light-secondary">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-sm btn-outline-primary" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#mailgunCollapse">
                                <i class="fa fa-chevron-down"></i>
                            </button>
                        </div>
                    </div>
                    <div class="collapse" id="mailgunCollapse">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('manager.settings.email.incoming.mailgun.update') }}">
                                ...
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" id="mailgunEnabled"
                                           name="mailgun_enabled"
                                           value="1" {{ $settings['mailgun']['enabled'] ? 'checked' : '' }}>
                                    <label class="form-check-label fw-semibold" for="mailgunEnabled">Habilitar Mailgun
                                        Handler</label>
                                </div>

                                <div class="mb-3">
                                    <label for="mailgunApiKey" class="form-label fw-semibold">Mailgun API Key</label>
                                    <input type="password" class="form-control font-monospace" id="mailgunApiKey"
                                           name="mailgun_api_key" value="{{ $settings['mailgun']['api_key'] }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="mailgunDomain" name="mailgun_domain"
                                           value="{{ $settings['mailgun']['domain'] }}" placeholder="mg.Alsernet.com">
                                ...
                                <div class="alert alert-info mb-3">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-primary mt-2"
                                            onclick="copyToClipboard('mailgunWebhookUrl')">
                                        <i class="fa fa-copy"></i> Copiar URL
                                    </button>
                                    <input type="hidden" id="mailgunWebhookUrl"
                                           value="{{ $settings['mailgun']['webhook_url'] }}">
                                    <p class="mb-0 mt-2 small">Configure esta URL en Mailgun Dashboard → Sending →
                                        Webhooks</p>
                                </div>
                ...
                <div class="card mb-3">
                    <div class="card-header bg-light-secondary">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-sm btn-outline-primary" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#phplistCollapse">
                                <i class="fa fa-chevron-down"></i>
                            </button>
                        </div>
                    </div>
                    <div class="collapse" id="phplistCollapse">
                        <div class="card-body">
                            <p class="text-muted mb-3">Conecte con su instalación de phpList para gestionar listas de
                                correo y suscripciones.</p>
                            ...
                            <form method="POST" action="{{ route('manager.settings.email.incoming.phplist.update') }}">
                                ...
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" id="phplistEnabled"
                                           name="phplist_enabled"
                                           value="1" {{ $settings['phplist']['enabled'] ? 'checked' : '' }}>
                                    <label class="form-check-label fw-semibold" for="phplistEnabled">Habilitar phpList
                                        Handler</label>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="password" class="form-control font-monospace" id="phplistApiKey"
                                               name="phplist_api_key" value="{{ $settings['phplist']['api_key'] }}">
                                        <small class="text-muted">API Key de phpList</small>
                                    </div>
                                </div>

                                <div class="mb-3">
                                    <label for="phplistDefaultList" class="form-label fw-semibold">Lista por defecto
                                        (ID)</label>
                                    <input type="number" class="form-control" id="phplistDefaultList"
                                           name="phplist_default_list"
                                           value="{{ $settings['phplist']['default_list'] }}" placeholder="1">
                                    <small class="text-muted">ID de la lista predeterminada para nuevas
                                        suscripciones</small>
                                </div>
    ...
    <div class="modal fade" id="addImapConnectionModal" tabindex="-1" aria-labelledby="addImapConnectionModalLabel"
         aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="imapName" name="name" required
                                       placeholder="Ej: Soporte Alsernet">
                            </div>
                            <div class="col-md-8 mb-3">
                                <label for="imapHost" class="form-label fw-semibold">
                                    Servidor IMAP <span class="text-danger">*</span>
                                </label>
                                <input type="text" class="form-control" id="imapHost" name="host" required
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="imapPort" name="port" required
                                       value="993">
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="imapUsername" name="username" required
                                       placeholder="soporte@Alsernet.com">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" id="createTickets"
                                           name="create_tickets" value="1" checked>
                                    <label class="form-check-label" for="createTickets">
                                        Crear tickets desde correos nuevos
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="createReplies"
                                           name="create_replies" value="1" checked>
