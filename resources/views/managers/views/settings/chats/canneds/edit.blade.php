            ...
            <div class="card w-100">
                ...
                <form id="formCanned" enctype="multipart/form-data" role="form" onSubmit="return false">
                    ...
                    <textarea style="display: none" id="description"
                              name="description">{!! $canned->messages !!}</textarea>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                           placeholder="Ingresa titulo" value=" {{ $canned->title  }}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                ...
                <div class="card-body">
                    ...
                    <table class="table mt-3 table-borderless v-middle">
                        ...
                        <tr>
                            ...
                            <td class="ps-0 text-end"><strong>El nombre del cliente que ha abierto el ticket.</strong>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="ps-0 text-end"><strong>El nombre del empleado que responde al ticket.</strong>
                            </td>
                        </tr>
                        <tr>
