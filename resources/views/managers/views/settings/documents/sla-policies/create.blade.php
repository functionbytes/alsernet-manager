        ...
        <form id="formSlaPolicy" method="POST" action="{{ route('manager.settings.documents.sla-policies.store') }}">
            ...
            <div class="card-body">
                ...
                <p class="card-subtitle mb-3 mt-1">
                    Define un acuerdo de nivel de servicio para gestionar los tiempos de revisión, aprobación y completación de documentos. Las políticas SLA ayudan a garantizar la calidad y velocidad del procesamiento.
                </p>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name') }}" required placeholder="Ej: SLA Estándar">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="upload_request_time" class="form-control" value="{{ old('upload_request_time') }}" required min="1" placeholder="Ej: 120">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="review_time" class="form-control" value="{{ old('review_time') }}" min="1" placeholder="Ej: 480">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="approval_time" class="form-control" value="{{ old('approval_time') }}" required min="1" placeholder="Ej: 1440">
