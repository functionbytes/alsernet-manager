...
@section('content')
    ...
    @include('managers.includes.card', ['title' => 'Políticas SLA de Documentos'])
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('manager.settings.documents.sla-policies.create') }}" class="btn btn-primary">
                            <i class="fas fa-plus"></i> Nueva política SLA
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tr>
                                ...
                                <th width="15%">Tiempo Revisión</th>
                                <th width="15%">Tiempo Aprobación</th>
