                            ...
                            @foreach($groups as $group)
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            $modeLabels = [
                                                ...
                                                'round_robin' => ['label' => 'R. Robin', 'color' => 'info'],
                                                'load_balanced' => ['label' => 'Balance', 'color' => 'success']
                                            ];
                                    ...
                                    <td class="text-center">
                                        <form method="POST" action="{{ route('manager.settings.documents.groups.toggle', $group->id) }}" class="toggle-form">
                                            @csrf
                                            @method('PATCH')
