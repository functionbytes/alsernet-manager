          ...
          <tbody>
              @foreach ($departments as $key => $department)
                <tr class="search-items">
                  ...
                  <td>
                      <span class="badge {{ $department->available == 1 ? 'bg-light-secondary  text-primary' : 'bg-light-secondary  text-primary' }}  rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
