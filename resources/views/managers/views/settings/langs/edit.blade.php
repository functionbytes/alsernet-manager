                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                           placeholder="Ingresa titulo" value=" {{ $lang->title  }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="iso_code" name="iso_code"
                                           placeholder="Ingresa iso code" value=" {{ $lang->iso_code  }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="lenguage_code" name="lenguage_code"
                                           placeholder="Ingresa lenguage codigo" value="{{ $lang->lenguage_code  }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="locate" name="locate"
                                           placeholder="Ingresa locacion" value=" {{ $lang->locate  }}">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    <label class="control-label col-form-label">Formato fecha</label>
                                    <input type="text" class="form-control" id="date_format_full"
                                           name="date_format_full" placeholder="Ingresa formato fecha"
                                           value=" {{ $lang->date_format_full  }}">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    <label class="control-label col-form-label">Formato fecha lite</label>
                                    <input type="text" class="form-control" id="date_format_lite"
                                           name="date_format_lite" placeholder="Ingresa formato fecha lite"
                                           value=" {{ $lang->date_format_lite  }}">
                                </div>
                            </div>
