...
@section('content')
    ...
    <div class="card w-100">
        ...
        <form id="formTemplate" method="POST" action="{{ route('manager.settings.suppliers.templates.store') }}">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h5 class="mb-0">Crear nueva plantilla de prompt</h5>
                        <p class="card-subtitle mb-0 mt-2">
                            Las plantillas son reutilizables y pueden clonarse para crear prompts específicos.
                        </p>
                    </div>
                    <a href="{{ route('manager.settings.suppliers.templates.index') }}" class="btn btn-light">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="label" class="form-control @error('label') is-invalid @enderror"
                                   value="{{ old('label') }}" required placeholder="Ej: Template: Descripción Producto E-commerce">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="template_category" class="form-control @error('template_category') is-invalid @enderror"
                                   value="{{ old('template_category') }}" placeholder="Ej: ecommerce, seo, marketing">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="content_type" class="form-select @error('content_type') is-invalid @enderror" required>
                                ...
                                <option value="description" {{ old('content_type') == 'description' ? 'selected' : '' }}>📝 Descripción completa</option>
                                <option value="short_description" {{ old('content_type') == 'short_description' ? 'selected' : '' }}>📄 Descripción corta</option>
                                <option value="title" {{ old('content_type') == 'title' ? 'selected' : '' }}>🏷️ Título del producto</option>
                                <option value="seo_title" {{ old('content_type') == 'seo_title' ? 'selected' : '' }}>🔍 Título SEO</option>
                                <option value="seo_description" {{ old('content_type') == 'seo_description' ? 'selected' : '' }}>📊 Meta Description SEO</option>
                                <option value="seo_keywords" {{ old('content_type') == 'seo_keywords' ? 'selected' : '' }}>🔑 Keywords SEO</option>
                                <option value="features" {{ old('content_type') == 'features' ? 'selected' : '' }}>⭐ Características</option>
                                <option value="specifications" {{ old('content_type') == 'specifications' ? 'selected' : '' }}>📋 Especificaciones técnicas</option>
                                <option value="benefits" {{ old('content_type') == 'benefits' ? 'selected' : '' }}>✅ Beneficios</option>
                                <option value="metadata" {{ old('content_type') == 'metadata' ? 'selected' : '' }}>📎 Metadatos</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="output_language" class="form-select @error('output_language') is-invalid @enderror" required>
                                ...
                                <option value="en" {{ old('output_language') == 'en' ? 'selected' : '' }}>🇬🇧 English</option>
                                <option value="fr" {{ old('output_language') == 'fr' ? 'selected' : '' }}>🇫🇷 Français</option>
                                <option value="de" {{ old('output_language') == 'de' ? 'selected' : '' }}>🇩🇪 Deutsch</option>
                            </select>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="prompt_template" class="form-control @error('prompt_template') is-invalid @enderror"
                                      rows="12" required
                                      placeholder="Escribe aquí el prompt. Puedes usar variables como @{{ product_name }}, @{{ category }}, @{{ price }}, etc.">{{ old('prompt_template') }}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select name="tone" class="form-select @error('tone') is-invalid @enderror" required>
                                ...
                                <option value="enthusiastic" {{ old('tone') == 'enthusiastic' ? 'selected' : '' }}>Entusiasta</option>
                                ...
                                <option value="persuasive" {{ old('tone') == 'persuasive' ? 'selected' : '' }}>Persuasivo</option>
                                <option value="technical" {{ old('tone') == 'technical' ? 'selected' : '' }}>Técnico</option>
                                <option value="elegant" {{ old('tone') == 'elegant' ? 'selected' : '' }}>Elegante</option>
                            </select>
                            @error('tone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select name="seo_focus" class="form-select @error('seo_focus') is-invalid @enderror">
                                <option value="0" {{ old('seo_focus') == '0' ? 'selected' : '' }}>No</option>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="notes" class="form-control @error('notes') is-invalid @enderror"
                                      rows="3" placeholder="Notas internas sobre esta plantilla (opcional)">{{ old('notes') }}</textarea>
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{ route('manager.settings.suppliers.templates.index') }}" class="btn btn-secondary">
                        Cancelar
                    </a>
                </div>
            </div>
