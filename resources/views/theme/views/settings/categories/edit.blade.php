                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                           placeholder="Ingresa titulo" value=" {{ $categorie->title  }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2" id="available" name="available">
                                        <option value="1" {{ $categorie->available == 1 ? 'selected' : '' }}>Público
                                        </option>
                                        <option value="0" {{ $categorie->available == 0 ? 'selected' : '' }}>Oculto
                                        </option>
                                    </select>
                                </div>
                            </div>
