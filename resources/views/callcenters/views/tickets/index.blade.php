            ...
            <div class="col-sm-6 col-lg-3 d-flex align-items-stretch">
                <div class="card w-100">
                    <div class="card-body">
                        ...
                        <h4 class="mb-1 fw-semibold d-flex align-content-center">$16.5k<i class="fa fa-arrow-up-right fs-5 text-success"></i></h4>
            ...
            <div class="col-sm-6 col-lg-3 d-flex align-items-stretch">
                <div class="card w-100">
                    <div class="card-body">
                        ...
                        <h4 class="mb-1 fw-semibold d-flex align-content-center">24%<i class="fa fa-arrow-up-right fs-5 text-success"></i></h4>
                                    ...
                                    <td>
                                        <div class="dropdown dropstart">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <li>
                                                    <a class="dropdown-item d-flex align-items-center gap-3" href="{{route('callcenter.tickets.view', $ticket->uid)}}"><i class="fs-4 fa fa-plus"></i>Visualizar</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item d-flex align-items-center gap-3" href="#"><i class="fs-4 fa fa-pen-to-square"></i>Edit</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item d-flex align-items-center gap-3" href="#"><i class="fs-4 fa fa-trash"></i>Delete</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
