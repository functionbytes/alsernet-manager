            ...
            <div class="col-lg-8">
                    <div class="card rounded-2 overflow-hidden">
                        ...
                        <div class="card-body p-4">
                            <span class="badge text-bg-light-secondary fs-2 rounded-4 py-1 px-2 lh-sm  mt-3">
                ...
                <div class="card w-100">
                    <div class="card-body">
                        ...
                        <div class="mt-4 pb-3 border-bottom">
                            ...
                            <div class="hstack gap-3 mt-3">
                                <a href="#" class="fs-3 text-bodycolor d-flex align-items-center text-decoration-none">
                                    <i class="fa fa-clipboard fs-6 text-primary me-2 d-flex"></i> 2 Tasks </a>
                                <a href="#" class="fs-3 text-bodycolor d-flex align-items-center text-decoration-none">
                                    <i class="fa fa-message fs-6 text-primary me-2 d-flex"></i> 13 Commets </a>
                            </div>
                        </div>
                        <div class="py-3 border-bottom">
                            ...
                            <div class="hstack gap-3 mt-3">
                                <a href="#" class="fs-3 text-bodycolor d-flex align-items-center text-decoration-none">
                                    <i class="fa fa-clipboard fs-6 text-primary me-2 d-flex"></i> 4 Tasks </a>
                                <a href="#" class="fs-3 text-bodycolor d-flex align-items-center text-decoration-none">
                                    <i class="fa fa-message fs-6 text-primary me-2 d-flex"></i> 50 Commets </a>
                            </div>
                        </div>
                        <div class="pt-3">
                            <div class="d-flex align-items-center">
                            ...
                            <div class="hstack gap-3 mt-3">
                                <a href="#" class="fs-3 text-bodycolor d-flex align-items-center text-decoration-none">
                                    <i class="fa fa-clipboard fs-6 text-primary me-2 d-flex"></i> 1 Task </a>
                                <a href="#" class="fs-3 text-bodycolor d-flex align-items-center text-decoration-none">
                                    <i class="fa fa-message fs-6 text-primary me-2 d-flex"></i> 12 Commets </a>
                            </div>
                        </div>
                    </div>
                </div>
