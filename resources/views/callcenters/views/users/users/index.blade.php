                ...
                <table class="table search-table align-middle text-nowrap">
                    ...
                    @foreach ($users as $key => $user)
                        <tr class="search-items">
                            ...
                            <td>
                               <span class="badge {{ $user->role == 'manager' ? 'bg-light-secondary  text-primary' : 'bg-light-secondary  text-primary' }}  rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
