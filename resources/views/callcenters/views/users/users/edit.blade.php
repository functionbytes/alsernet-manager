        ...
        <ul class="nav nav-pills user-profile-tab" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-2" id="pills-information-tab" data-bs-toggle="pill" data-bs-target="#pills-information" type="button" role="tab" aria-controls="pills-information" aria-selected="false">
                    <i class="fa fa-bell me-2 fs-6"></i>
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-2" id="pills-bills-tab" data-bs-toggle="pill" data-bs-target="#pills-bills" type="button" role="tab" aria-controls="pills-bills" aria-selected="false">
                    <i class="fa fa-newspaper me-2 fs-6"></i>
                                        ...
                                        <div class="">
                                            <div class="d-flex align-items-center justify-content-between mb-4">
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="bg-light-secondary rounded-1 p-6 d-flex align-items-center justify-content-center">
                                                        <i class="fa fa-newspaper text-dark d-block fs-7" width="22" height="22"></i>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-4">
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="bg-light-secondary rounded-1 p-6 d-flex align-items-center justify-content-center">
                                                        <i class="fa fa-square-check text-dark d-block fs-7" width="22" height="22"></i>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-4">
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="bg-light-secondary rounded-1 p-6 d-flex align-items-center justify-content-center">
                                                        <i class="fa fa-clock text-dark d-block fs-7" width="22" height="22"></i>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="bg-light-secondary rounded-1 p-6 d-flex align-items-center justify-content-center">
                                                        <i class="fa fa-envelopetext-dark d-block fs-7" width="22" height="22"></i>
                                                    </div>
                                                    <div>
                                ...
                                <div class="mb-3 mt-3">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-7">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="bg-light-secondary rounded-1 p-6 d-flex align-items-center justify-content-center">
                                                    <i class="fa fa-pause text-dark d-block fs-7" width="22" height="22"></i>
                                                </div>
                                                <div>
                            ...
                            <div class="card">
                                <div class="card-body p-4">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-7">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="bg-light-secondary rounded-1 p-6 d-flex align-items-center justify-content-center">
                                                <i class="fa fa-credit-card text-dark d-block fs-7" width="22" height="22"></i>
                                            </div>
                                            <div>
                ...
                <div class="tab-pane fade" id="pills-security" role="tabpanel" aria-labelledby="pills-security-tab" tabindex="0">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body p-4">
                                    <div class="bg-light-secondary rounded-1 p-6 d-inline-flex align-items-center justify-content-center mb-3">
                                        <i class="fa fa-laptop text-primary d-block fs-7" width="22" height="22"></i>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between py-3 border-bottom">
                                        <div class="d-flex align-items-center gap-3">
                                            <i class="fa fa-mobile text-dark d-block fs-7" width="26" height="26"></i>
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between py-3">
                                        <div class="d-flex align-items-center gap-3">
                                            <i class="fa fa-laptop text-dark d-block fs-7" width="26" height="26"></i>
                                            <div>
