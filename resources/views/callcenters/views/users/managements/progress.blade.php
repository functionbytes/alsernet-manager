                                ...
                                <table class="table align-middle text-nowrap mb-0">
                                    ...
                                    @foreach ($chapter as $key => $class)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                 <span class="badge {{ $validate  ? 'bg-light-secondary  text-primary' : 'bg-light-secondary  text-primary' }}  rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
