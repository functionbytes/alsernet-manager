...
<div class="container-fluid">
    ...
    @include('accountings.includes.card', ['title' => 'Dashboard v1 - Cards Compactas'])
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('accounting.documents') }}" class="btn btn-sm btn-outline-primary">Ver todos</a>
                    </div>
                </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('accounting.documents.manage', $doc->uid) }}" class="btn btn-sm btn-light">
