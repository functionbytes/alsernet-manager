...
<div class="container-fluid">
    ...
    @include('accountings.includes.card', ['title' => 'Dashboard v2 - Modernize Style'])
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-grid">
                                        <a href="{{ route('accounting.documents') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <a href="{{ route('accounting.documents.pending') }}" class="badge bg-dark bg-opacity-25 text-dark text-decoration-none">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <div class="btn-group">
                                        <a href="{{ route('accounting.documents.show', $doc->uid) }}" class="btn btn-sm btn-light" title="Ver">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('accounting.documents.manage', $doc->uid) }}" class="btn btn-sm btn-primary" title="Gestionar">
