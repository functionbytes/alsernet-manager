...
<div class="container-fluid">
    ...
    @include('accountings.includes.card', ['title' => 'Dashboard'])
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <a href="{{ route('accounting.documents.pending') }}" class="badge bg-warning-subtle text-warning text-decoration-none">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex flex-column gap-3">
                                ...
                                <div class="p-3 bg-primary-subtle rounded">
                                    ...
                                    <a href="{{ route('accounting.documents.pending') }}" class="small text-primary">Ver pendientes <i class="fas fa-arrow-right"></i></a>
                                </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('accounting.documents') }}" class="btn btn-outline-primary w-100">Ver todos los documentos</a>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-transparent d-flex align-items-center justify-content-between py-3">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('accounting.documents.import') }}" class="btn btn-outline-primary btn-sm">
                            <i class="fas fa-file-import me-1"></i> Importar
                        </a>
                        <a href="{{ route('accounting.documents') }}" class="btn btn-primary btn-sm">
                                ...
                                <td class="text-end pe-4">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="{{ route('accounting.documents.show', $doc->uid) }}">
                                                    <i class="fas fa-eye me-2"></i>Ver documento
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="{{ route('accounting.documents.manage', $doc->uid) }}">
                                            ...
                                            <li>
                                                <a class="dropdown-item text-success" href="{{ route('accounting.documents.manage', $doc->uid) }}">
                                                    <i class="fas fa-check me-2"></i>Aprobar
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item text-danger" href="{{ route('accounting.documents.manage', $doc->uid) }}">
    ...
    <div class="row g-3">
        <div class="col-md-4">
            <a href="{{ route('accounting.documents.pending') }}" class="card border-0 shadow-sm text-decoration-none h-100 card-hover">
        ...
        <div class="col-md-4">
            <a href="{{ route('accounting.documents.import') }}" class="card border-0 shadow-sm text-decoration-none h-100 card-hover">
                <div class="card-body d-flex align-items-center gap-3">
        ...
        <div class="col-md-4">
            <a href="{{ route('accounting.documents') }}" class="card border-0 shadow-sm text-decoration-none h-100 card-hover">
                <div class="card-body d-flex align-items-center gap-3">
