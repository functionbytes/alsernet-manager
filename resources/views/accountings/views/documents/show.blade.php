...
@section('content')
    ...
    @include('accountings.includes.card', ['title' => 'Ver Documento'])
    ...
    <div class="row">
                    ...
                    <div class="card-body p-0">
                        ...
                        @if($document->media->count() > 1)
                            <div class="border-top p-3">
                                <a href="{{ route('accounting.documents.summary', $document->uid) }}" target="_blank" class="btn btn-primary w-100">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <a href="{{ route('accounting.documents.manage', $document->uid) }}" class="btn btn-primary w-100 mb-2">
                        Gestionar
                    </a>
                    @if($document->mails()->count() > 0)
                    <a href="{{ route('accounting.documents.emails', $document->uid) }}" class="btn btn-outline-info w-100 mb-2">
                       Ver emails enviados
                       <span class="badge bg-black ms-1">{{ $document->mails()->count() }}</span>
                    </a>
                    @endif
                    <a href="{{ route('accounting.documents') }}" class="btn btn-secondary w-100">
