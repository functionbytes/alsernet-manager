...
@section('content')
    ...
    @include('accountings.includes.card', ['title' => 'Documentos pendientes'])
                ...
                <div class="col-md-12 col-xl-12">
                    <form class="position-relative form-search" action="{{ request()->fullUrl() }}" method="GET">
                        <div class="row justify-content-between g-2 ">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('accounting.documents.import') }}" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Importar órdenes específicas">
                            ...
                            <td class="text-left">
                                <div class="dropdown dropstart">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('accounting.documents.edit', $document->uid) }}">Editar</a>
                                        </li>
                                        <li class="{{ $document->media->count()>0 ? '' : 'd-none'}}">
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('accounting.documents.summary', $document->uid) }}">Documentos</a>
                                        </li>
