...
<div class="container-fluid">
    ...
    @include('accountings.includes.card', [
        ...
        'breadcrumbs' => [
            ['label' => 'Dashboard', 'url' => route('accounting.dashboard')],
            ['label' => 'Documentos', 'url' => route('accounting.documents')],
            ['label' => 'Documento #' . $document->order_id, 'url' => route('accounting.documents.manage', $document->uid)],
        ...
        <div class="card">
            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('accounting.documents.manage', $document->uid) }}" class="btn btn-secondary">
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('accounting.documents.emails.preview', $mail->uid) }}" target="_blank">
                                                        Vista previa
                                                    </a>
                                                </li>
            ...
            <div class="card-body">
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('accounting.documents.manage', $document->uid) }}" class="btn btn-primary">
