...
<script>
    $(document).ready(function() {
        ...
        function saveNoteHandler(e) {
            ...
            $.ajax({
                url: `/accounting/documents/manage/${documentUid}/update-note/${noteId}`,
                method: 'PUT',
                headers: {
        ...
        function deleteNoteHandler(e) {
            ...
            if (confirm('¿Estás seguro de que deseas eliminar esta nota?')) {
                ...
                $.ajax({
                    url: `/accounting/documents/manage/${documentUid}/delete-note/${noteId}`,
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': $('[name="_token"]').val()
                    },
        ...
        $('#addNoteForm').on('submit', function(e) {
            ...
            $.ajax({
                url: `/accounting/documents/manage/${documentUid}/add-note`,
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': $('[name="_token"]').val()
                },
